...
{{< katex display=true >}}\oint \vec{E} \cdot d\vec{l} = -\frac{d\Phi_B}{dt} \tag{5.1}{{< /katex >}}

where {{< katex >}}\Phi_{\mathrm{B}}{{< /katex >}} is the magnetic flux and {{< katex >}}\frac{d}{dt}{{< /katex >}} is the total derivative with respect to time. Equation (5.1) means that the electric field {{< katex >}}\vec{E}{{< /katex >}} is induced along a closed loop by the changing magnetic flux {{< katex >}}\Phi_{\mathrm{B}}{{< /katex >}} in the region encircled by the loop.
...
{{< katex display=true >}}\oint \vec{B} \cdot d\vec{l} = -\frac{d}{dt}\Phi_E = -\frac{d}{dt}\oint \vec{E} \cdot d\vec{A} \tag{5.2}{{< /katex >}}

where {{< katex >}}\Phi_{\mathrm{E}}{{< /katex >}} is the electric flux. This is known as Maxwell's law of induction which explains that the magnetic field {{< katex >}}\vec{B}{{< /katex >}} is induced along a closed loop by the changing electric flux {{< katex >}}\Phi_{\mathrm{E}}{{< /katex >}} in the region encircled by that loop. This symmetry between electric and magnetic fields explains the existence of electromagnetic waves such as radio waves, gamma rays, infrared rays etc.
...
Let a time‑dependent current {{< katex >}}i_c{{< /katex >}} called conduction current be passed through the wire to charge the capacitor.
...
To calculate the magnetic field at a point {{< katex >}}P{{< /katex >}} near the wire and outside the capacitor, let us draw a circular Amperian loop which encloses the circular surface {{< katex >}}S_1{{< /katex >}}. Using Ampere's circuital law for this loop, we get

{{< katex display=true >}}\oint_{\text{enclosing } S_1} \vec{B} \cdot d\vec{l} = \mu_0 i_c \tag{5.3}{{< /katex >}}

where {{< katex >}}\mu_0{{< /katex >}} is the permeability of free space.

![Applying Ampere's circuital law – loop enclosing surface {{< katex >}}S_2{{< /katex >}}](image-placeholder)

Now, the same loop is enclosed by balloon shaped surface {{< katex >}}S_2{{< /katex >}} such that boundaries of two surfaces {{< katex >}}S_1{{< /katex >}} and {{< katex >}}S_2{{< /katex >}} are same but the shape of the surfaces is different. As Ampere's law applied for a given closed loop does not depend on the shape of the enclosing surface, the integrals should give the same answer. But by applying Ampere's circuital law for the surface {{< katex >}}S_2{{< /katex >}}, we get

{{< katex display=true >}}\oint_{\text{enclosing } S_2} \vec{B} \cdot d\vec{l} = 0 \tag{5.4}{{< /katex >}}

The right hand side of equation is zero because the surface {{< katex >}}S_2{{< /katex >}} nowhere touches the wire carrying conduction current and further, there is no current flowing between the plates of the capacitor (gap between the plates). So the magnetic field at a point {{< katex >}}P{{< /katex >}} is zero. Hence there is an inconsistency between equations (5.3) and (5.4).
...
{{< katex display=true >}}\Phi_E = \oint \vec{E} \cdot d\vec{A} = EA = \frac{q}{\epsilon_0}{{< /katex >}}

where {{< katex >}}A{{< /katex >}} is the area of the plates of capacitor. The change in electric flux is given by

{{< katex display=true >}}\frac{d\Phi_E}{dt} = \frac{1}{\epsilon_0}\frac{dq}{dt} \quad \text{or} \quad \frac{dq}{dt} = \epsilon_0 \frac{d\Phi_E}{dt}{{< /katex >}}

{{< katex display=true >}}i_d = \epsilon_0 \frac{d\Phi_E}{dt}{{< /katex >}}

where {{< katex >}}\frac{dq}{dt} = i_d{{< /katex >}} is known as displacement current or Maxwell's displacement current.
...
{{< katex display=true >}}\oint \vec{B} \cdot d\vec{l} = \mu_0 i = \mu_0 [i_c + i_d] = \mu_0 i_c + \mu_0 \epsilon_0 \frac{d\Phi_E}{dt} \tag{5.6}{{< /katex >}}

where the total current enclosed by the surface becomes the sum of conduction current and displacement current. Therefore, {{< katex >}}i = i_c + i_d{{< /katex >}}. The equation (5.6) is known as Ampere‑Maxwell law. When the current in the circuit is constant, the displacement current is zero.
...
Maxwell's correction term {{< katex >}}\left(\mu_0 \epsilon_0 \frac{d\Phi_E}{dt}\right){{< /katex >}} in Ampere's law ensures that time‑varying electric field or displacement current can also produce a magnetic field. Though conduction current is zero in an empty space, displacement current does exist. So, the equation (5.6) becomes

{{< katex display=true >}}\oint \vec{B} \cdot d\vec{l} = \mu_0 \epsilon_0 \frac{d\Phi_E}{dt}{{< /katex >}}
...
**EXAMPLE 5.1**  
Consider a parallel plate capacitor which is connected to an {{< katex >}}230\ \mathrm{V}{{< /katex >}} RMS value and {{< katex >}}50\ \mathrm{Hz}{{< /katex >}} frequency. If the separation distance between the plates of the capacitor and area of the plates are {{< katex >}}1\ \mathrm{mm}{{< /katex >}} and {{< katex >}}20\ \mathrm{cm^2}{{< /katex >}} respectively. Calculate the displacement current at {{< katex >}}t = 1{{< /katex >}} s.

**Solution**  
Potential difference between the plates of the capacitor,

{{< katex display=true >}}V = V_{\mathrm{max}} \sin 2\pi ft = 230\sqrt{2} \sin (2\pi \times 50t) = 325 \sin 100\pi t{{< /katex >}}

{{< katex >}}d = 1\ \mathrm{mm} = 1\times 10^{-3}\ \mathrm{m},\quad A = 20\ \mathrm{cm^2} = 20\times 10^{-4}\ \mathrm{m^2}{{< /katex >}}

Displacement current,

{{< katex display=true >}}i_d = \epsilon_0 \frac{d\Phi_E}{dt} = \epsilon_0 \frac{d(EA)}{dt} = \frac{\epsilon_0 A}{d} \left|\frac{dV}{dt}\right| \quad (\because E = V/d){{< /katex >}}

{{< katex display=true >}}= \frac{\epsilon_0 A}{d} (325)(100\pi) \cos 100\pi t{{< /katex >}}

{{< katex display=true >}}= \frac{8.85\times 10^{-12} \times 20\times 10^{-4} \times 325 \times 100 \times 3.14 \times \cos(100\pi \times 1)}{1\times 10^{-3}}{{< /katex >}}

{{< katex display=true >}}= 1.81\times 10^{-6}\ \mathrm{A} = 1.81\ \mu\mathrm{A} \quad (\because \cos 100\pi = 1){{< /katex >}}
...
{{< katex display=true >}}\oint \vec{E} \cdot d\vec{A} = \frac{Q_{\text{enclosed}}}{\epsilon_0} \tag{5.7}{{< /katex >}}

where {{< katex >}}\vec{E}{{< /katex >}} is the electric field and {{< katex >}}Q_{\text{enclosed}}{{< /katex >}} is the net charge enclosed by the surface {{< katex >}}S{{< /katex >}}. This equation is true for both discrete and continuous distribution of charges.
...
{{< katex display=true >}}\oint \vec{B} \cdot d\vec{A} = 0 \qquad \text{(Gauss's law for magnetism)} \tag{5.8}{{< /katex >}}

where {{< katex >}}\vec{B}{{< /katex >}} is the magnetic field.
...
{{< katex display=true >}}\oint \vec{E} \cdot d\vec{l} = -\frac{d\Phi_B}{dt} \qquad \text{(Faraday's law)} \tag{5.9}{{< /katex >}}
...
{{< katex display=true >}}\oint \vec{B} \cdot d\vec{l} = \mu_0 i_c + \mu_0 \epsilon_0 \frac{d}{dt} \oint \vec{E} \cdot d\vec{A} \tag{5.10}{{< /katex >}}

where {{< katex >}}\vec{B}{{< /katex >}} is the magnetic field. This equation shows that both conduction current and displacement current produce magnetic field.
...
If the receiver is rotated by {{< katex >}}90^\circ{{< /katex >}}, then no spark is observed by the receiver. This confirms that electromagnetic waves are transverse waves as predicted by Maxwell. Hertz detected radio waves and also computed the speed of radio waves which is equal to the speed of light {{< katex >}}(3\times 10^{8}\ \mathrm{ms^{-1}}){{< /katex >}}.
...
4. Electromagnetic waves travel with speed which is equal to the speed of light in vacuum or free space, {{< katex >}}c = \frac{1}{\sqrt{\epsilon_0 \mu_0}} = 3\times 10^8\ \mathrm{ms^{-1}}{{< /katex >}}, where {{< katex >}}\epsilon_0{{< /katex >}} is the permittivity of free space or vacuum and {{< katex >}}\mu_0{{< /katex >}} is the permeability of free space or vacuum (refer Unit 1 for permittivity and Unit 3 for permeability).

5. In a medium with permittivity {{< katex >}}\epsilon{{< /katex >}} and permeability {{< katex >}}\mu{{< /katex >}}, the speed of electromagnetic wave {{< katex >}}v{{< /katex >}} is less than that in free space or vacuum {{< katex >}}(v < c){{< /katex >}}. In a medium of refractive index,

{{< katex display=true >}}n = \frac{c}{v} = \frac{\sqrt{\epsilon_0 \mu_0}}{\sqrt{\epsilon \mu}} \quad \therefore n = \sqrt{\epsilon_r \mu_r}{{< /katex >}}

where {{< katex >}}\epsilon_r{{< /katex >}} is the relative permittivity of the medium (also known as dielectric constant) and {{< katex >}}\mu_r{{< /katex >}} is the relative permeability of the medium.
...
9. If the electromagnetic wave incident on a material surface is completely absorbed, then the energy delivered is {{< katex >}}U{{< /katex >}} and momentum imparted on the surface is {{< katex >}}p = \frac{U}{c}{{< /katex >}}.

10. If the incident electromagnetic wave of energy {{< katex >}}U{{< /katex >}} is totally reflected from the surface, then the momentum delivered to the surface is {{< katex >}}\Delta p = \frac{U}{c} - \left(-\frac{U}{c}\right) = 2\frac{U}{c}{{< /katex >}}.
...
**Solution**  
Dielectric constant (relative permittivity of the medium), {{< katex >}}\epsilon_r = 2.25{{< /katex >}}  
Magnetic permeability, {{< katex >}}\mu_r = 2.5{{< /katex >}}  
Refractive index of the medium,

{{< katex display=true >}}n = \sqrt{\epsilon_r \mu_r} = \sqrt{2.25 \times 2.5} = 2.37{{< /katex >}}
...
Suppose the electromagnetic field in free space propagates along {{< katex >}}z{{< /katex >}}-direction and if the electric field vector points along {{< katex >}}x{{< /katex >}}-axis, then the magnetic field vector will be mutually perpendicular to both electric field and the direction of wave propagation. Thus

{{< katex display=true >}}E_x = E_0 \sin(kz - \omega t),\qquad B_y = B_0 \sin(kz - \omega t){{< /katex >}}

where {{< katex >}}E_0{{< /katex >}} and {{< katex >}}B_0{{< /katex >}} are amplitudes of oscillating electric and magnetic field, {{< katex >}}k{{< /katex >}} is a wave number, {{< katex >}}\omega{{< /katex >}} is the angular frequency of the wave and {{< katex >}}\hat{k}{{< /katex >}} (unit vector, here it is called propagation vector) denotes the direction of propagation of electromagnetic wave.

Note that both electric field and magnetic field oscillate with a frequency (frequency of electromagnetic wave) which is equal to the frequency of the source (here, oscillating charge is the source for the production of electromagnetic waves). In free space or in vacuum, the ratio between {{< katex >}}E_0{{< /katex >}} and {{< katex >}}B_0{{< /katex >}} is equal to the speed of electromagnetic wave and is equal to speed of light {{< katex >}}c{{< /katex >}}.

{{< katex display=true >}}c = \frac{E_0}{B_0}{{< /katex >}}

In any medium, the ratio of {{< katex >}}E_0{{< /katex >}} and {{< katex >}}B_0{{< /katex >}} is equal to the speed of electromagnetic wave in that medium. Thus

{{< katex display=true >}}v = \frac{E_0}{B_0} < c{{< /katex >}}
...
**EXAMPLE 5.3**  
Compute the speed of the electromagnetic wave in a medium if the amplitude of electric and magnetic fields are {{< katex >}}3\times 10^{4}\ \mathrm{N\ C^{-1}}{{< /katex >}} and {{< katex >}}2\times 10^{-4}\ \mathrm{T}{{< /katex >}} respectively.

**Solution**  
The amplitude of the electric field, {{< katex >}}E_0 = 3\times 10^{4}\ \mathrm{N\ C^{-1}}{{< /katex >}}  
The amplitude of the magnetic field, {{< katex >}}B_0 = 2\times 10^{-4}\ \mathrm{T}{{< /katex >}}  
Therefore, speed of the electromagnetic wave in that medium is

{{< katex display=true >}}v = \frac{E_0}{B_0} = \frac{3\times 10^{4}}{2\times 10^{-4}} = 1.5\times 10^{8}\ \mathrm{m\ s^{-1}}{{< /katex >}}
...
- Maxwell modified Ampere's law as {{< katex >}}\oint \vec{B} \cdot d\vec{l} = \mu_0 i = \mu_0 (i_c + i_d){{< /katex >}}.
...
- The instantaneous magnitude of the electric and magnetic field vectors in electromagnetic wave are related by {{< katex >}}c = E/B{{< /katex >}}.
...
1. The dimension of {{< katex >}}\frac{1}{\mu_0 \epsilon_0}{{< /katex >}} is  
   (a) {{< katex >}}[L T^{-1}]{{< /katex >}} (b) {{< katex >}}[L^2 T^{-2}]{{< /katex >}} (c) {{< katex >}}[L^{-1} T]{{< /katex >}} (d) {{< katex >}}[L^{-2} T^{-2}]{{< /katex >}}

2. If the amplitude of the magnetic field is {{< katex >}}3\times 10^{-6}\ \mathrm{T}{{< /katex >}}, then amplitude of the electric field for an electromagnetic wave is  
   (a) {{< katex >}}100\ \mathrm{Vm^{-1}}{{< /katex >}} (b) {{< katex >}}300\ \mathrm{Vm^{-1}}{{< /katex >}} (c) {{< katex >}}600\ \mathrm{Vm^{-1}}{{< /katex >}} (d) {{< katex >}}900\ \mathrm{Vm^{-1}}{{< /katex >}}
...
5. Consider an oscillator which has a charged particle oscillating about its mean position with a frequency of {{< katex >}}300\ \mathrm{MHz}{{< /katex >}}. The wavelength of electromagnetic waves produced by this oscillator is  
   (a) {{< katex >}}1\ \mathrm{m}{{< /katex >}} (b) {{< katex >}}10\ \mathrm{m}{{< /katex >}} (c) {{< katex >}}100\ \mathrm{m}{{< /katex >}} (d) {{< katex >}}1000\ \mathrm{m}{{< /katex >}}
...
6. The electric and the magnetic fields, associated with an electromagnetic wave, propagating along negative X axis can be represented by  
   (a) {{< katex >}}\vec{E} = E_i \hat{i}{{< /katex >}} and {{< katex >}}\vec{B} = B_i \hat{k}{{< /katex >}}  
   (b) {{< katex >}}\vec{E} = E_i \hat{k}{{< /katex >}} and {{< katex >}}\vec{B} = B_i \hat{j}{{< /katex >}}  
   (c) {{< katex >}}\vec{E} = E_i \hat{i}{{< /katex >}} and {{< katex >}}\vec{B} = B_i \hat{j}{{< /katex >}}  
   (d) {{< katex >}}\vec{E} = E_i \hat{j}{{< /katex >}} and {{< katex >}}\vec{B} = B_i \hat{i}{{< /katex >}}

7. In an electromagnetic wave travelling in free space the rms value of the electric field is {{< katex >}}3\ \mathrm{Vm^{-1}}{{< /katex >}}. The peak value of the magnetic field is  
   (a) {{< katex >}}1.414\times 10^{-8}\ \mathrm{T}{{< /katex >}} (b) {{< katex >}}1.0\times 10^{-8}\ \mathrm{T}{{< /katex >}} (c) {{< katex >}}2.828\times 10^{-8}\ \mathrm{T}{{< /katex >}} (d) {{< katex >}}2.0\times 10^{-8}\ \mathrm{T}{{< /katex >}}

8. An e.m. wave is propagating in a medium with a velocity {{< katex >}}\vec{v} = v\hat{i}{{< /katex >}}. The instantaneous oscillating electric field of this e.m. wave is along {{< katex >}}+y{{< /katex >}}-axis, then the direction of oscillating magnetic field of the e.m. wave will be along:  
   (a) {{< katex >}}-y{{< /katex >}} direction (b) {{< katex >}}-x{{< /katex >}} direction (c) {{< katex >}}+z{{< /katex >}} direction (d) {{< katex >}}-z{{< /katex >}} direction

9. If the magnetic monopole exists, then which of the Maxwell's equation to be modified?  
   (a) {{< katex >}}\oint \vec{E} \cdot d\vec{A} = \frac{Q_{\text{enclosed}}}{\epsilon_0}{{< /katex >}}  
   (b) {{< katex >}}\oint \vec{B} \cdot d\vec{A} = 0{{< /katex >}}  
   (c) {{< katex >}}\oint \vec{B} \cdot d\vec{l} = \mu_0 i_c + \mu_0 \epsilon_0 \frac{d}{dt} \oint \vec{E} \cdot d\vec{A}{{< /katex >}}  
   (d) {{< katex >}}\oint \vec{E} \cdot d\vec{l} = -\frac{d\Phi_B}{dt}{{< /katex >}}
...
11. Which of the following is an electromagnetic wave?  
    (a) {{< katex >}}\alpha{{< /katex >}}-rays (b) {{< katex >}}\beta{{< /katex >}}-rays (c) {{< katex >}}\gamma{{< /katex >}}-rays (d) all of them
...
13. If {{< katex >}}E = E_0 \sin[10^6 x - \omega t]{{< /katex >}} be the electric field of a plane electromagnetic wave, the value of {{< katex >}}\omega{{< /katex >}} is  
    (a) {{< katex >}}0.3\times 10^{-14}\ \mathrm{rad\ s^{-1}}{{< /katex >}} (b) {{< katex >}}3\times 10^{-14}\ \mathrm{rad\ s^{-1}}{{< /katex >}} (c) {{< katex >}}0.3\times 10^{14}\ \mathrm{rad\ s^{-1}}{{< /katex >}} (d) {{< katex >}}3\times 10^{14}\ \mathrm{rad\ s^{-1}}{{< /katex >}}
...
1. Consider a parallel plate capacitor whose plates are closely spaced. Let {{< katex >}}R{{< /katex >}} be the radius of the plates and the current in the wire connected to the plates is 5 A, calculate the displacement current through the surface passing between the plates by directly calculating the rate of change of flux of electric field through the surface.  
   **Answer:** {{< katex >}}I_d = I_c = 5\ \mathrm{A}{{< /katex >}}

2. A transmitter consists of LC circuit with an inductance of {{< katex >}}1\ \mu\mathrm{H}{{< /katex >}} and a capacitance of {{< katex >}}1\ \mu\mathrm{F}{{< /katex >}}. What is the wavelength of the electromagnetic waves it emits?  
   **Answer:** {{< katex >}}18.84\times 10^{2}\ \mathrm{m}{{< /katex >}}

3. A pulse of light of duration {{< katex >}}10^{-6}{{< /katex >}} s is absorbed completely by a small object initially at rest. If the power of the pulse is {{< katex >}}60\times 10^{-3}\ \mathrm{W}{{< /katex >}}, calculate the final momentum of the object.  
   **Answer:** {{< katex >}}20\times 10^{-17}\ \mathrm{kg\ m\ s^{-1}}{{< /katex >}}

4. Let an electromagnetic wave propagate along the {{< katex >}}x{{< /katex >}}-direction, the magnetic field oscillates at a frequency of {{< katex >}}10^{10}\ \mathrm{Hz}{{< /katex >}} and has an amplitude of {{< katex >}}10^{-5}\ \mathrm{T}{{< /katex >}}, acting along the {{< katex >}}y{{< /katex >}}-direction. Then, compute the wavelength of the wave. Also write down the expression for electric field in this case.  
   **Answer:** {{< katex >}}\lambda = 3\times 10^{-2}\ \mathrm{m}{{< /katex >}} and {{< katex >}}\vec{E}(x,t) = 3\times 10^{3} \sin(2.09\times 10^{2}x - 6.28\times 10^{10}t)(-\hat{k})\ \mathrm{N\ C^{-1}}{{< /katex >}}
...
5. If the relative permeability and relative permittivity of a medium are 1.0 and 2.25 respectively, find the speed of the electromagnetic wave in this medium.  
   **Answer:** {{< katex >}}v = 2\times 10^{8}\ \mathrm{m\ s^{-1}}{{< /katex >}}
