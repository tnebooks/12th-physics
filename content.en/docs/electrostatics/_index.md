...
For example in Figure 1.8, the resultant electric field due to three point charges \( q_1, q_2, q_3, \ldots, q_n \)  , at point P is shown.
...
\[
\vec{P} = \chi_e \vec{E}_{ext} \tag{1.80}
\]
