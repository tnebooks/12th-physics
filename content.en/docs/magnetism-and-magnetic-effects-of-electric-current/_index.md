...
Magnetism exists everywhere from tiny particles like electrons to the entire universe. Historically the word 'magnetism' was derived from iron ore magnetite {{< katex >}}\mathrm{(Fe_3O_4)}{{< /katex >}}. In olden days, magnets were used as magnetic compass for navigation, magnetic therapy for treatment and also used in magic shows.
...
(a) magnetic declination {{< katex >}}(D){{< /katex >}}
(b) magnetic dip or inclination {{< katex >}}(I){{< /katex >}}
(c) the horizontal component of the Earth's magnetic field {{< katex >}}(B_{H}){{< /katex >}}
...
When a magnetic needle is freely suspended, the alignment of the magnet does not exactly lie along the geographic meridian. The angle between magnetic meridian at a point and geographical meridian is called the declination or magnetic declination {{< katex >}}(D){{< /katex >}}. At higher latitudes, the declination is greater whereas near the equator, the declination is smaller. In India, declination angle is very small and for Chennai, magnetic declination angle is {{< katex >}}-1^{\circ}16^{\prime}{{< /katex >}} (which is negative (west)).

The angle subtended by the Earth's total magnetic field {{< katex >}}\bar{B}{{< /katex >}} with the horizontal direction in the magnetic meridian is called dip or magnetic inclination {{< katex >}}(I){{< /katex >}} at that point. For Chennai, inclination angle is {{< katex >}}14^{\circ}28^{\prime}{{< /katex >}}. The component of Earth's magnetic field along the horizontal direction in the magnetic meridian is called horizontal component of Earth's magnetic field, denoted by {{< katex >}}B_{H}{{< /katex >}}.

Let {{< katex >}}B_{E}{{< /katex >}} be the net Earth's magnetic field at any point on the surface of the Earth. {{< katex >}}B_{E}{{< /katex >}} can be resolved into two perpendicular components.
...
The Earth's magnetic field is parallel to the surface of the Earth (i.e., horizontal) which implies that the needle of magnetic compass rests horizontally at an angle of dip, {{< katex >}}I = 0^{\circ}{{< /katex >}}.

{{< katex >}}B_{H} = B_{E}{{< /katex >}}
{{< katex >}}B_{V} = 0{{< /katex >}}
...
The Earth's magnetic field is perpendicular to the surface of the Earth (i.e., vertical) which implies that the needle of magnetic compass rests vertically at an angle of dip, {{< katex >}}I = 90^{\circ}{{< /katex >}}. Hence,

{{< katex >}}B_{H} = 0{{< /katex >}}
{{< katex >}}B_{V} = B_{E}{{< /katex >}}

This implies that the vertical component is maximum at poles and horizontal component is zero at poles.

**EXAMPLE 3.1**

The horizontal component and vertical component of Earth's magnetic field at a place are 0.15 G and 0.26 G respectively. Calculate the angle of dip and resultant magnetic field. (G- gauss, cgs unit for magnetic field {{< katex >}}1\mathrm{G} = 10^{-4}\mathrm{T}{{< /katex >}})

**Solution:**

{{< katex >}}B_{H} = 0.15\mathrm{G} \text{ and } B_{V} = 0.26\mathrm{G}{{< /katex >}}
...
Consider a bar magnet. Let {{< katex >}}q_{m}{{< /katex >}} be the pole strength of the magnetic pole and let {{< katex >}}l{{< /katex >}} be the distance between the geometrical centre of bar magnet O and one end of the pole. The magnetic dipole moment is defined as the product of its pole strength and magnetic length. It is a vector quantity, denoted by {{< katex >}}\vec{p}_{m}{{< /katex >}}.

{{< katex display=true >}}\vec{p}_{m} = q_{m}\vec{d} \quad (3.4){{< /katex >}}

where {{< katex >}}\vec{d}{{< /katex >}} is the vector drawn from south pole to north pole and its magnitude {{< katex >}}|\vec{d}| = 2l{{< /katex >}}.

The magnitude of magnetic dipole moment is {{< katex >}}p_{m} = 2q_{m}l{{< /katex >}}

The SI unit of magnetic moment is A m². The direction of magnetic moment is from south pole to north pole.

#### (b) Magnetic field

Magnetic field is the region or space around every magnet within which its influence will be felt by keeping another magnet in that region. The magnetic field {{< katex >}}\vec{B}{{< /katex >}} at a point is defined as a force experienced by the bar magnet of unit pole strength.

{{< katex display=true >}}\overline{B} = \frac{1}{q_m}\overline{F} \quad (3.5){{< /katex >}}

Its unit is {{< katex >}}\mathrm{N A}^{-1}\mathrm{m}^{-1}{{< /katex >}}.
...
5. The length of the bar magnet is called geometrical length and the length between two magnetic poles in a bar magnet is called magnetic length. Magnetic length is always slightly smaller than geometrical length. The ratio of magnetic length and geometrical length is {{< katex >}}\frac{5}{6}{{< /katex >}}.

{{< katex display=true >}}\frac{\text{Magnetic length}}{\text{Geometrical length}} = \frac{5}{6} = 0.833{{< /katex >}}

**EXAMPLE 3.2**

Let the magnetic moment of a bar magnet be {{< katex >}}\vec{p}_m{{< /katex >}} whose magnetic length is {{< katex >}}d = 2l{{< /katex >}} and pole strength is {{< katex >}}q_{m}{{< /katex >}}. Compute the magnetic moment of the bar magnet when it is cut into two pieces
(a) along its length
...
When the bar magnet is cut along the axis into two pieces, new magnetic pole strength is {{< katex >}}q_{m}^{\prime} = \frac{q_{m}}{2}{{< /katex >}} but magnetic length does not change. So, the magnetic moment is

{{< katex display=true >}}p_{m}^{\prime} = q_{m}^{\prime}2l = \frac{q_{m}}{2} \cdot 2l = \frac{1}{2} (q_{m}2l) = \frac{1}{2} p_{m}{{< /katex >}}

In vector notation, {{< katex >}}\vec{p}_{m}^{\prime} = \frac{1}{2}\vec{p}_{m}{{< /katex >}}
...
Compute the magnetic length of a uniform bar magnet if the geometrical length of the magnet is {{< katex >}}12\mathrm{cm}{{< /katex >}}. Mark the positions of magnetic pole points.

**Solution**

Geometrical length of the bar magnet is {{< katex >}}12\mathrm{cm}{{< /katex >}}

{{< katex display=true >}}\text{Magnetic length} = \frac{5}{6} \times (\text{geometrical length}) = \frac{5}{6} \times 12 = 10\mathrm{cm}{{< /katex >}}

(i) Pole strength is a scalar quantity with dimension [MLTA]. Its SI unit is {{< katex >}}\mathrm{N T^{-1}}{{< /katex >}} (newton per tesla) or {{< katex >}}\mathrm{A m}{{< /katex >}} (ampere-metre).
...
The number of magnetic field lines crossing any area normally is defined as magnetic flux {{< katex >}}\Phi_{B}{{< /katex >}} through the area. Mathematically, the magnetic flux through a surface of area {{< katex >}}\bar{A}{{< /katex >}} in a uniform magnetic field {{< katex >}}\bar{B}{{< /katex >}} is defined as

{{< katex display=true >}}\Phi_{B} = \bar{B}\cdot \bar{A} = BA\cos \theta = B_{\perp}A \quad (3.6){{< /katex >}}

where {{< katex >}}\theta{{< /katex >}} is the angle between {{< katex >}}\bar{B}{{< /katex >}} and {{< katex >}}\bar{A}{{< /katex >}}.

**Special cases**

(a) When {{< katex >}}\bar{B}{{< /katex >}} is normal to the surface i.e., {{< katex >}}\theta = 0^{\circ}{{< /katex >}}, the magnetic flux is {{< katex >}}\Phi_{B} = BA{{< /katex >}} (maximum).

(b) When {{< katex >}}\bar{B}{{< /katex >}} is parallel to the surface i.e., {{< katex >}}\theta = 90^{\circ}{{< /katex >}}, the magnetic flux is {{< katex >}}\Phi_{B} = 0{{< /katex >}}.
...
Magnetic flux is a scalar quantity. The SI unit for magnetic flux is weber, which is denoted by symbol Wb. Dimensional formula for magnetic flux is {{< katex >}}[\mathrm{ML}^{2}\mathrm{T}^{-2}\mathrm{A}^{-1}]{{< /katex >}}. The CGS unit of magnetic flux is maxwell.

{{< katex display=true >}}1\text{ weber} = 10^{8}\text{ maxwell}{{< /katex >}}

The magnetic flux density is defined as the number of magnetic field lines crossing per unit area kept normal to the direction of lines of force. Its unit is {{< katex >}}\mathrm{Wb m}^{-2}{{< /katex >}} or tesla (T).
...
where {{< katex >}}q_{m_{A}}{{< /katex >}} and {{< katex >}}q_{m_{B}}{{< /katex >}} are pole strengths of two poles and {{< katex >}}r{{< /katex >}} is the distance between two magnetic poles.

{{< katex display=true >}}\bar{F} = k\frac{q_{m_{A}}q_{m_{B}}}{r^{2}}\hat{r} \quad (3.7){{< /katex >}}

In magnitude, {{< katex display=true >}}F = k\frac{q_{m_{A}}q_{m_{B}}}{r^{2}} \quad (3.8){{< /katex >}}

where {{< katex >}}k{{< /katex >}} is a proportionality constant whose value depends on the surrounding medium. In SI unit, the value of {{< katex >}}k{{< /katex >}} for free space is {{< katex >}}k = \frac{\mu_{0}}{4\pi} \approx 10^{-7}\mathrm{H m^{-1}}{{< /katex >}}, where {{< katex >}}\mu_{0}{{< /katex >}} is the absolute permeability of free space (air or vacuum) and H stands for henry.

**EXAMPLE 3.5**

The repulsive force between two magnetic poles in air is {{< katex >}}9 \times 10^{-3}\mathrm{N}{{< /katex >}}. If the two poles are equal in strength and are separated by a distance of {{< katex >}}10\mathrm{cm}{{< /katex >}}, calculate the pole strength of each pole.
...
Given: {{< katex >}}F = 9 \times 10^{-3}\mathrm{N}{{< /katex >}}, {{< katex >}}r = 10\mathrm{cm} = 10 \times 10^{-2}\mathrm{m}{{< /katex >}}

Since {{< katex >}}q_{m_{A}} = q_{m_{B}} = q_{m}{{< /katex >}}, we have
...
Consider a bar magnet NS. Let N be the north pole and S be the south pole of the bar magnet, each of pole strength {{< katex >}}q_{m}{{< /katex >}} and are separated by a distance of {{< katex >}}2l{{< /katex >}}. The magnetic field at a point C (lies along the axis of the magnet) at a distance {{< katex >}}r{{< /katex >}} from the geometrical centre O of the bar magnet can be computed by keeping unit north pole {{< katex >}}(q_{m_{C}} = 1{{< /katex >}} Am) at C.
...
where {{< katex >}}(r - l){{< /katex >}} is the distance between north pole of the bar magnet and unit north pole at C.
...
where {{< katex >}}(r + l){{< /katex >}} is the distance between south pole of the bar magnet and unit north pole at C.
...
Since the magnitude of magnetic dipole moment is {{< katex >}}|\vec{p}_{m}| = p_{m} = q_{m}\cdot 2l{{< /katex >}}, the magnetic field at a point C can be written as

{{< katex display=true >}}\vec{B}_{\mathrm{axial}} = \frac{\mu_{0}}{4\pi}\left(\frac{2r p_{m}}{(r^{2} - l^{2})^{2}}\right)\hat{i} \quad (3.12){{< /katex >}}

If the distance between two poles in a bar magnet is small (looks like short magnet) when compared to the distance between geometrical centre O of bar magnet and the location of point C {{< katex >}}(r \gg l){{< /katex >}}
...
where {{< katex >}}\vec{p}_{m} = p_{m}\hat{i}{{< /katex >}}.

### 3.2.2 Magnetic field at a point along the equatorial line due to a magnetic dipole (bar magnet)

Consider a bar magnet NS. Let N be the north pole and S be the south pole of the bar magnet, each with pole strength {{< katex >}}q_{m}{{< /katex >}} and separated by a distance of {{< katex >}}2l{{< /katex >}}. The magnetic field at a point C (lies along the equatorial line) at a distance {{< katex >}}r{{< /katex >}} from the geometrical centre O of the bar magnet can be computed by keeping unit north pole {{< katex >}}(q_{mC} = 1\mathrm{Am}){{< /katex >}} at C.

The magnetic field at C due to the north pole is

{{< katex display=true >}}\vec{B}_N = -B_N\cos \theta \hat{i} + B_N\sin \theta \hat{j} \quad (3.15){{< /katex >}}

where {{< katex >}}B_N = \frac{\mu_0}{4\pi}\frac{q_m}{r^{\prime 2}}{{< /katex >}}, and {{< katex >}}r^{\prime} = (r^2 + l^2)^{\frac{1}{2}}{{< /katex >}}

The magnetic field at C due to the south pole is

{{< katex display=true >}}\vec{B}_S = -B_S\cos \theta \hat{i} - B_S\sin \theta \hat{j} \quad (3.16){{< /katex >}}

where {{< katex >}}B_S = \frac{\mu_0}{4\pi}\frac{q_m}{r^{\prime 2}}{{< /katex >}}

From equations (3.15) and (3.16), the net magnetic field at point C due to the dipole is {{< katex >}}\vec{B} = \vec{B}_{N} + \vec{B}_{S}{{< /katex >}}
...
Since magnitude of magnetic dipole moment is {{< katex >}}|\vec{p}_m| = p_m = q_m \cdot 2l{{< /katex >}} and substituting in equation (3.19), the magnetic field at a point C is
...
Since {{< katex >}}\vec{p}_m\hat{i} = \vec{p}_m{{< /katex >}}, the magnetic field at equatorial point is given by

{{< katex display=true >}}\vec{B}_{equatorial} = -\frac{\mu_{0}}{4\pi}\frac{\vec{p}_m}{r^3} \quad (3.22){{< /katex >}}

Note that magnitude of {{< katex >}}B_{axial}{{< /katex >}} is twice that of magnitude of {{< katex >}}B_{equatorial}{{< /katex >}} and the direction of {{< katex >}}B_{axial}{{< /katex >}} and {{< katex >}}B_{equatorial}{{< /katex >}} are opposite.

**EXAMPLE 3.6**

A short bar magnet has a magnetic moment of {{< katex >}}0.5\mathrm{J T}^{-1}{{< /katex >}}. Calculate magnitude and direction of the magnetic field produced by the bar magnet which is kept at a distance of {{< katex >}}0.1\mathrm{m}{{< /katex >}} from the centre of the bar magnet along (a) axial line of the bar magnet and (b) normal bisector of the bar magnet.

**Solution**

Given magnetic moment {{< katex >}}= 0.5\mathrm{J T}^{-1}{{< /katex >}} and distance {{< katex >}}r = 0.1\mathrm{m}{{< /katex >}}
...
Hence, the magnitude of the magnetic field along axial is {{< katex >}}B_{axial} = 1\times 10^{-4}\mathrm{T}{{< /katex >}} and direction is towards South to North.
...
Hence, the magnitude of the magnetic field along axial is {{< katex >}}B_{equatorial} = 0.5\times 10^{-4}\mathrm{T}{{< /katex >}} and direction is towards North to South.

Note that magnitude of {{< katex >}}B_{axial}{{< /katex >}} is twice that of magnitude of {{< katex >}}B_{equatorial}{{< /katex >}} and the direction of {{< katex >}}B_{axial}{{< /katex >}} and {{< katex >}}B_{equatorial}{{< /katex >}} are opposite.

## 3.3 TORQUE ACTING ON A BAR MAGNET IN UNIFORM MAGNETIC FIELD

Consider a magnet of length {{< katex >}}2l{{< /katex >}} and pole strength {{< katex >}}q_{m}{{< /katex >}} kept in a uniform magnetic field {{< katex >}}\vec{B}{{< /katex >}}. Each pole experiences a force of magnitude {{< katex >}}q_{m}B{{< /katex >}} but acting in opposite directions. Therefore, the net force exerted on the magnet is zero and hence, there is no translatory motion. These two equal and opposite forces constitute a couple (about midpoint of bar magnet) tend to align the magnet in the direction of the magnetic field {{< katex >}}\vec{B}{{< /katex >}}.
...
By using right hand cork screw rule, we conclude that the total torque is pointing into the paper. Since the magnitudes {{< katex >}}|\overline{ON}| = |\overline{OS}| = l{{< /katex >}} and {{< katex >}}|q_m\vec{B}| = |-q_m\vec{B}|{{< /katex >}}, the magnitude of total torque about point O
...
When a bar magnet (magnetic dipole) of dipole moment {{< katex >}}\vec{p}_m{{< /katex >}} is held at an angle {{< katex >}}\theta{{< /katex >}} with the direction of a uniform magnetic field {{< katex >}}\vec{B}{{< /katex >}}, the magnitude of the torque acting on the dipole is

{{< katex display=true >}}|\vec{\tau}_B| = |\vec{p}_m||\vec{B}|\sin \theta{{< /katex >}}

If the dipole is rotated through a very small angular displacement {{< katex >}}d\theta{{< /katex >}} against the torque, then the work done by the external torque is

{{< katex display=true >}}dW = \tau_{ext} d\theta{{< /katex >}}

Since {{< katex >}}\vec{\tau}_{ext}{{< /katex >}} is equal and opposite to {{< katex >}}\vec{\tau}_B{{< /katex >}}, we have {{< katex >}}\tau_{ext} = p_m B \sin \theta{{< /katex >}}

Therefore,

{{< katex display=true >}}dW = p_m B \sin \theta d\theta{{< /katex >}}

The total work done to rotate the dipole from initial orientation {{< katex >}}\theta'{{< /katex >}} to final orientation {{< katex >}}\theta{{< /katex >}} is

{{< katex display=true >}}W = \int_{\theta'}^{\theta} p_m B \sin \theta d\theta = p_m B (\cos \theta' - \cos \theta){{< /katex >}}

This work done is stored as potential energy difference {{< katex >}}U(\theta) - U(\theta') = p_m B (\cos \theta' - \cos \theta){{< /katex >}}

If the initial angle is {{< katex >}}\theta' = 90^{\circ}{{< /katex >}} and is taken as reference point, then {{< katex >}}U(\theta') = 0{{< /katex >}}
...
The potential energy is maximum when the dipole is aligned anti-parallel {{< katex >}}(\theta = \pi){{< /katex >}} to the external magnetic field and minimum when the dipole is aligned parallel {{< katex >}}(\theta = 0){{< /katex >}} to the external magnetic field.
...
The magnetic field which is used to magnetize a sample or specimen is called the magnetising field. Magnetising field is a vector quantity and is denoted by {{< katex >}}\bar{H}{{< /katex >}} and its unit is {{< katex >}}\mathrm{A m^{-1}}{{< /katex >}}.
...
In free space, the permeability (or absolute permeability) is denoted by {{< katex >}}\mu_0{{< /katex >}} and for any other medium it is denoted by {{< katex >}}\mu{{< /katex >}}. The relative permeability {{< katex >}}\mu_r{{< /katex >}} is defined as the ratio between absolute permeability of the medium to the permeability of free space.

{{< katex display=true >}}\mu_r = \frac{\mu}{\mu_0} \quad (3.29){{< /katex >}}

Relative permeability is a dimensionless number and has no units. For free space (air or vacuum), the relative permeability is unity i.e., {{< katex >}}\mu_r = 1{{< /katex >}}.
...
The SI unit of intensity of magnetisation is ampere metre{{< katex >}}^{-1}{{< /katex >}}. For a bar magnet of pole strength {{< katex >}}q_{m}{{< /katex >}} length {{< katex >}}2l{{< /katex >}} and area of cross-section {{< katex >}}A{{< /katex >}}, the magnetic moment of the bar magnet is {{< katex >}}\bar{p}_m = q_m \bar{2l}{{< /katex >}} and volume of the bar magnet is {{< katex >}}V = A|\bar{2l}| = 2lA{{< /katex >}}. The intensity of magnetisation for a bar magnet is
...
When a substance like soft iron bar is placed in a uniform magnetising field {{< katex >}}\bar{H}{{< /katex >}}, the substance gets magnetised. The magnetic induction (total magnetic field) inside the specimen {{< katex >}}\bar{B}{{< /katex >}} is equal to the sum of the magnetic field {{< katex >}}\bar{B}_o{{< /katex >}} produced in vacuum due to the magnetising field and the magnetic field {{< katex >}}\bar{B}_m{{< /katex >}} due to the induced magnetism of the substance.
...
When a substance is kept in a magnetising field {{< katex >}}\bar{H}{{< /katex >}}, magnetic susceptibility gives information about how a material responds to the external (applied) magnetic field. In other words, the magnetic susceptibility measures how easily and how strongly a material can be magnetised. It is defined as the ratio of the intensity of magnetisation {{< katex >}}\bar{M}{{< /katex >}} induced in the material to the magnetising field {{< katex >}}\bar{H}{{< /katex >}}
...
| Material | Magnetic susceptibility ({{< katex >}}\chi_m{{< /katex >}}) |
|---|---|
| Aluminium | {{< katex >}}2.3 \times 10^{-5}{{< /katex >}} |
| Copper | {{< katex >}}-0.98 \times 10^{-5}{{< /katex >}} |
| Diamond | {{< katex >}}-2.2 \times 10^{-5}{{< /katex >}} |
| Gold | {{< katex >}}-3.6 \times 10^{-5}{{< /katex >}} |
| Mercury | {{< katex >}}-3.2 \times 10^{-5}{{< /katex >}} |
| Silver | {{< katex >}}-2.6 \times 10^{-5}{{< /katex >}} |
| Titanium | {{< katex >}}7.06 \times 10^{-5}{{< /katex >}} |
| Tungsten | {{< katex >}}6.8 \times 10^{-5}{{< /katex >}} |
| Carbon dioxide (1 atm) | {{< katex >}}-2.3 \times 10^{-9}{{< /katex >}} |
| Oxygen (1 atm) | {{< katex >}}2090 \times 10^{-9}{{< /katex >}} |

**EXAMPLE 3.8**

Compute the intensity of magnetisation of the bar magnet whose mass, magnetic moment and density are {{< katex >}}200\mathrm{g}{{< /katex >}}, {{< katex >}}2\mathrm{Am}^2{{< /katex >}} and {{< katex >}}8\mathrm{g cm}^{-3}{{< /katex >}}, respectively.
...
Magnitude of magnetic moment {{< katex >}}p_m = 2\mathrm{Am}^2{{< /katex >}}
...
Using the relation {{< katex >}}\vec{B} = \mu_0(\vec{H} + \vec{M}){{< /katex >}}, show that {{< katex >}}\chi_m = \mu_r - 1{{< /katex >}}.
...
Hence, {{< katex >}}\vec{B} = \mu_0(\chi_m + 1)\vec{H} \Rightarrow \vec{B} = \mu \vec{H}{{< /katex >}}

where {{< katex >}}\mu = \mu_0(\chi_m + 1) \Rightarrow \chi_m + 1 = \frac{\mu}{\mu_0} = \mu_r{{< /katex >}}

{{< katex display=true >}}\Rightarrow \chi_m = \mu_r - 1{{< /katex >}}

**EXAMPLE 3.10**

Two materials X and Y are magnetised whose values of intensity of magnetisation are {{< katex >}}500\mathrm{A m}^{-1}{{< /katex >}} and {{< katex >}}2000\mathrm{A m}^{-1}{{< /katex >}} respectively. If the magnetising field is {{< katex >}}1000\mathrm{A m}^{-1}{{< /katex >}}, then which one among these materials can be easily magnetized?.
...
**Meissner effect - superconductors behave like perfect diamagnetic materials below transition temperature {{< katex >}}T_c{{< /katex >}}**
...
This relation is called Curie's law. Here {{< katex >}}C{{< /katex >}} is called Curie constant and temperature {{< katex >}}T{{< /katex >}} is in kelvin. The graph drawn between magnetic susceptibility and temperature is a rectangular hyperbola.
...
As temperature increases, the ferromagnetism decreases due to the increased thermal agitation of the atomic dipoles. At a particular temperature, ferromagnetic material becomes paramagnetic. This temperature is known as Curie temperature {{< katex >}}T_c{{< /katex >}}. The susceptibility of the material above the Curie temperature is given by

{{< katex display=true >}}\chi_m = \frac{C}{T - T_c}{{< /katex >}}

This relation is called Curie-Weiss law. The constant {{< katex >}}C{{< /katex >}} is called Curie constant and temperature {{< katex >}}T{{< /katex >}} is in kelvin scale.

**Spin**

Like mass and charge for particles, spin is also another important attribute for an elementary particle. Spin is a quantum mechanical phenomenon which is responsible for magnetic properties of the material. Spin in quantum mechanics is entirely different from spin we encounter in classical mechanics. Spin in quantum mechanics does not mean rotation; it is intrinsic angular momentum which does not have classical analogue. For historical reason, the name spin is retained. Spin of a particle takes only positive values but the orientation of the spin vector takes plus or minus values in an external magnetic field. For an example, electron has spin {{< katex >}}s = \frac{1}{2}{{< /katex >}}. In the presence of magnetic field, the spin will orient either parallel or anti-parallel to the direction of magnetic field.

This implies that the magnetic spin {{< katex >}}m_s{{< /katex >}} takes two values for an electron, such as {{< katex >}}m_s = \frac{1}{2}{{< /katex >}} (spin up) and {{< katex >}}m_s = -\frac{1}{2}{{< /katex >}} (spin down). Spin for proton and neutron is {{< katex >}}s = \frac{1}{2}{{< /katex >}}. For photon, spin {{< katex >}}s = 1{{< /katex >}}.

## 3.6 HYSTERESIS

When a ferromagnetic material is kept in a magnetising field, the material gets magnetised by induction. An important characteristic of ferromagnetic material is that the variation of magnetic induction {{< katex >}}\vec{B}{{< /katex >}} with magnetising field {{< katex >}}\vec{H}{{< /katex >}} is not linear. It means that the ratio {{< katex >}}\frac{B}{H} = \mu{{< /katex >}} is not a constant. Let us study this behaviour in detail.

A ferromagnetic material (example, Iron) is magnetised slowly by a magnetising field {{< katex >}}\vec{H}{{< /katex >}}. The magnetic induction {{< katex >}}\vec{B}{{< /katex >}} of the material increases from point A with the magnitude of the magnetising field and then attains a saturation level. This response of the material is depicted by the path AC. Saturation magnetization is defined as the maximum point up to which the material can be magnetised by applying the magnetising field.

If the magnetising field is now reduced, the magnetic induction also decreases but does not retrace the original path CA. It takes different path CD. When the magnetising field is zero, the magnetic induction is not zero and it has positive value. This implies that some magnetism is left in the specimen even when {{< katex >}}H = 0{{< /katex >}}. The residual magnetism AD present in the specimen is called remanence or retentivity. Remanence is defined as the ability of the materials to retain the magnetism in them even after the magnetising field disappears.
...
Further increase of {{< katex >}}\bar{H}{{< /katex >}} in the reverse direction causes the magnetic induction to increase along EF until it reaches saturation at F in the reverse direction. If magnetising field is decreased and then increased with direction reversed, the magnetic induction traces the path FGKC. This closed curve ACDEFGKC is called hysteresis loop and it corresponds to one cycle of magnetisation.

In the entire cycle, the magnetic induction {{< katex >}}B{{< /katex >}} lags behind the magnetising field {{< katex >}}H{{< /katex >}}. This phenomenon of lagging of magnetic induction behind the magnetising field is called hysteresis. Hysteresis means 'lagging behind'.
...
The direction of circular magnetic field lines will be clockwise or anticlockwise depending on the direction of current in the conductor. If the strength (or magnitude) of the current is increased then the density of the magnetic field will also increase. The strength of the magnetic field {{< katex >}}(B){{< /katex >}} decreases as the distance {{< katex >}}(r){{< /katex >}} from the conductor increases.
...
Biot and Savart experimentally observed that the magnitude of magnetic field {{< katex >}}d\bar{B}{{< /katex >}} at a point P at a distance {{< katex >}}r{{< /katex >}} from the small elemental length taken on a conductor carrying current varies

(i) directly as the strength of the current {{< katex >}}I{{< /katex >}}
(ii) directly as the magnitude of the length element {{< katex >}}d\bar{l}{{< /katex >}}
(iii) directly as the sine of the angle {{< katex >}}\theta{{< /katex >}} between {{< katex >}}d\bar{l}{{< /katex >}} and {{< katex >}}\hat{r}{{< /katex >}}
(iv) inversely as the square of the distance {{< katex >}}r{{< /katex >}} between the point P and length element {{< katex >}}d\bar{l}{{< /katex >}}
...
where {{< katex >}}k = \frac{\mu}{4\pi}{{< /katex >}} in SI units.

In vector notation,

{{< katex display=true >}}d\bar{B} = \frac{\mu}{4\pi} \frac{I d\bar{l} \times \hat{r}}{r^2} \quad (3.34){{< /katex >}}

Here vector {{< katex >}}d\bar{B}{{< /katex >}} is perpendicular to both {{< katex >}}I d\bar{l}{{< /katex >}} (pointing the direction of current flow) and the unit vector {{< katex >}}\hat{r}{{< /katex >}} directed from {{< katex >}}d\bar{l}{{< /katex >}} toward point P.

The equation (3.34) is used to compute the magnetic field only due to a small elemental length {{< katex >}}dl{{< /katex >}} of the conductor. The net magnetic field at P due to the conductor is obtained from principle of superposition by considering the contribution from all current elements {{< katex >}}I d\bar{l}{{< /katex >}}. Hence integrating equation (3.34), we get

{{< katex display=true >}}\bar{B} = \int d\bar{B} = \frac{\mu}{4\pi} \int \frac{I d\bar{l} \times \hat{r}}{r^2} \quad (3.35){{< /katex >}}

1. If the point P lies on the conductor, then {{< katex >}}\theta = 0^{\circ}{{< /katex >}}. Therefore, {{< katex >}}|d\bar{B}|{{< /katex >}} is zero.

2. If the point lies perpendicular to the conductor, then {{< katex >}}\theta = 90^{\circ}{{< /katex >}}. Therefore, {{< katex >}}d\bar{B}{{< /katex >}} is maximum and is given by {{< katex >}}d\bar{B} = \frac{\mu_0}{4\pi}\frac{I dl}{r^2}\hat{n}{{< /katex >}} where {{< katex >}}\hat{n}{{< /katex >}} is the unit vector perpendicular to both {{< katex >}}I d\bar{l}{{< /katex >}} and {{< katex >}}\hat{r}{{< /katex >}}.

**Note** Electric current is not a vector quantity. It is a scalar quantity. But electric current in a conductor has direction of flow. Therefore, the electric current flowing in a small elemental conductor can be taken as vector quantity i.e. {{< katex >}}I d\bar{l}{{< /katex >}}
...
|---|---|---|
| 1 | Produced by a scalar source i.e., an electric charge {{< katex >}}q{{< /katex >}} | Produced by a vector source i.e., current element {{< katex >}}I d\bar{l}{{< /katex >}} |
| 2 | It is directed along the position vector joining the source and the point at which the field is calculated | It is directed perpendicular to the position vector {{< katex >}}r{{< /katex >}} and the current element {{< katex >}}I d\bar{l}{{< /katex >}} |
| 3 | Does not depend on angle | Depends on the angle between the position vector {{< katex >}}r{{< /katex >}} and the current element {{< katex >}}I d\bar{l}{{< /katex >}} |

The exponent of charge {{< katex >}}q{{< /katex >}} (source) and exponent of electric field {{< katex >}}E{{< /katex >}} is unity. Similarly, the exponent of current element {{< katex >}}I d\bar{l}{{< /katex >}} (source) and exponent of magnetic field {{< katex >}}B{{< /katex >}} is unity. In other words, electric field {{< katex >}}\bar{E}{{< /katex >}} is proportional only to charge (source) and not on higher powers of charge {{< katex >}}(q^{2},q^{3},{{< /katex >}} etc). Similarly, magnetic field {{< katex >}}\bar{B}{{< /katex >}} is proportional to current element {{< katex >}}I d\bar{l}{{< /katex >}} (source) and not on square or cube or higher powers of current element. The cause and effect have linear relationship.

### 3.8.2 Magnetic field due to long straight conductor carrying current

Let {{< katex >}}\mathrm{YY}^{\prime}{{< /katex >}} be an infinitely long straight conductor and {{< katex >}}I{{< /katex >}} be the steady current through the conductor. In order to calculate magnetic field at a point {{< katex >}}\mathrm{P}{{< /katex >}} which is at a distance {{< katex >}}a{{< /katex >}} from the wire, let us consider a small line element {{< katex >}}dl{{< /katex >}} (segment AB).

The magnetic field at a point {{< katex >}}\mathrm{P}{{< /katex >}} due to current element {{< katex >}}Idl{{< /katex >}} can be calculated from Biot-Savart's law, which is

{{< katex display=true >}}d\vec{B} = \frac{\mu_0}{4\pi}\frac{Idl\sin\theta}{r^2}\hat{n}{{< /katex >}}

where {{< katex >}}\hat{n}{{< /katex >}} is the unit vector which points into the page at {{< katex >}}\mathrm{P}{{< /katex >}}, {{< katex >}}\theta{{< /katex >}} is the angle between current element {{< katex >}}Idl{{< /katex >}} and line joining {{< katex >}}dl{{< /katex >}} and the point {{< katex >}}\mathrm{P}{{< /katex >}}. Let {{< katex >}}r{{< /katex >}} be the distance between line element at {{< katex >}}A{{< /katex >}} to the point {{< katex >}}\mathrm{P}{{< /katex >}}.

To apply trigonometry, draw a perpendicular line from {{< katex >}}A{{< /katex >}} to BP.

In triangle {{< katex >}}\Delta ABC{{< /katex >}}, {{< katex >}}\sin \theta = \frac{AC}{AB}{{< /katex >}}

{{< katex display=true >}}\Rightarrow AC = AB\sin \theta{{< /katex >}}

But {{< katex >}}AB = dl \Rightarrow AC = dl\sin \theta{{< /katex >}}

Let {{< katex >}}d\phi{{< /katex >}} be the angle subtended between AP and BP, i.e., {{< katex >}}\angle APB = \angle APC = d\phi{{< /katex >}}

In a triangle {{< katex >}}\Delta APC{{< /katex >}}, {{< katex >}}\sin (d\phi) = \frac{AC}{AP}{{< /katex >}}

Since {{< katex >}}d\phi{{< /katex >}} is very small, {{< katex >}}\sin (d\phi) \simeq d\phi{{< /katex >}}

But {{< katex >}}AP = r \Rightarrow AC = r d\phi{{< /katex >}}
...
Let {{< katex >}}\phi{{< /katex >}} be the angle between AP and OP

In a {{< katex >}}\Delta OPA{{< /katex >}}, {{< katex >}}\cos \phi = \frac{OP}{AP} = \frac{a}{r}{{< /katex >}}
...
The total magnetic field at {{< katex >}}\mathrm{P}{{< /katex >}} due to the conductor {{< katex >}}\mathrm{YY}^{\prime}{{< /katex >}} is
...
For an infinitely long straight conductor, {{< katex >}}\phi_1 = \phi_2 = \frac{\pi}{2}{{< /katex >}}

Therefore, {{< katex >}}\sin \phi_1 + \sin \phi_2 = 1 + 1 = 2{{< /katex >}}
...
Consider a current carrying circular loop of radius {{< katex >}}R{{< /katex >}} and let {{< katex >}}I{{< /katex >}} be the current flowing through the wire. The magnetic field at a point P on the axis of the circular coil at a distance {{< katex >}}z{{< /katex >}} from the centre of the coil O is computed by taking two diametrically opposite line elements of the coil each of length {{< katex >}}d\bar{l}{{< /katex >}} at C and D. Let {{< katex >}}\vec{r}{{< /katex >}} be the vector joining the current element {{< katex >}}(I d\bar{l}){{< /katex >}} at C and the point P.
...
The magnitude of {{< katex >}}d\vec{B}{{< /katex >}} is

{{< katex display=true >}}dB = \frac{\mu_0}{4\pi}\frac{I dl \sin\theta}{r^2} = \frac{\mu_0}{4\pi}\frac{I dl}{r^2}{{< /katex >}}

where {{< katex >}}\theta{{< /katex >}} is the angle between {{< katex >}}I d\vec{l}{{< /katex >}} and {{< katex >}}\vec{r}{{< /katex >}}. Here {{< katex >}}\theta = 90^{\circ}{{< /katex >}}.

The direction of {{< katex >}}d\vec{B}{{< /katex >}} is perpendicular to the current element {{< katex >}}I d\vec{l}{{< /katex >}} and CP. It is therefore along PR perpendicular to CP.
...
The magnetic field {{< katex >}}d\vec{B}{{< /katex >}} due to each current element is resolved into two components; {{< katex >}}dB\cos \phi{{< /katex >}} along y-direction and {{< katex >}}dB\sin \phi{{< /katex >}} along z-direction. The horizontal components cancel out while the vertical components {{< katex >}}(dB\sin \phi \hat{k}){{< /katex >}} alone contribute to the net magnetic field {{< katex >}}\vec{B}{{< /katex >}} at the point P.
...
If we integrate the line element from 0 to {{< katex >}}2\pi R{{< /katex >}}, we get the net magnetic field {{< katex >}}\bar{B}{{< /katex >}} at point P due to the current-carrying circular loop.

{{< katex display=true >}}\overline{B} = \frac{\mu_0 I}{2} \frac{R^2}{(R^2 + z^2)^{3/2}} \hat{k}{{< /katex >}}

If the circular coil contains {{< katex >}}N{{< /katex >}} turns, then the magnetic field is
...
The magnetic field due to current in the upper semicircle and lower semicircle of the circular coil are equal in magnitude but opposite in direction. Hence, the net magnetic field at the centre of the loop (at point O) is zero {{< katex >}}\bar{B} = \bar{0}{{< /katex >}}.
...
Let {{< katex >}}B{{< /katex >}} be the magnetic field produced by passing current through the coil of the tangent galvanometer and {{< katex >}}B_{H}{{< /katex >}} be the horizontal component of Earth's magnetic field. Under the action of two magnetic fields, the needle comes to rest making angle {{< katex >}}\theta{{< /katex >}} with {{< katex >}}B_{H}{{< /katex >}} such that
...
4. The compass box alone is rotated such that the aluminium pointer reads {{< katex >}}0^{\circ} - 0^{\circ}{{< /katex >}}
...
(1) the magnetic field {{< katex >}}(B){{< /katex >}} due to the electric current in the coil acting normal to the plane of the coil.
(2) the horizontal component of Earth's magnetic field {{< katex >}}(B_{H}){{< /katex >}}

Because of these crossed fields, the pivoted magnetic needle deflects through an angle {{< katex >}}\theta{{< /katex >}}. From tangent law (equation 3.39),

{{< katex display=true >}}B = B_{H} \tan \theta{{< /katex >}}

When an electric current is passed through a circular coil of radius {{< katex >}}R{{< /katex >}} having {{< katex >}}N{{< /katex >}} turns, the magnitude of magnetic field at the centre is (from equation (3.38))
...
A coil of a tangent galvanometer of diameter {{< katex >}}0.24\mathrm{m}{{< /katex >}} has 100 turns. If the horizontal component of Earth's magnetic field is {{< katex >}}25\times 10^{-6}{{< /katex >}} T then, calculate the current which gives a deflection of {{< katex >}}60^{\circ}{{< /katex >}}.

**Solution**

The diameter of the coil is {{< katex >}}0.24\mathrm{m}{{< /katex >}}. Therefore, radius of the coil is {{< katex >}}0.12\mathrm{m}{{< /katex >}}.

Number of turns is 100 turns.

Earth's magnetic field is {{< katex >}}25\times 10^{-6}\mathrm{T}{{< /katex >}}

Deflection is {{< katex >}}\theta = 60^{\circ} \Rightarrow \tan 60^{\circ} = \sqrt{3} = 1.732{{< /katex >}}
...
The magnetic field at a point on the axis of the current-carrying circular loop of radius {{< katex >}}R{{< /katex >}} at a distance {{< katex >}}z{{< /katex >}} from its centre is given by

{{< katex display=true >}}\overline{B} = \frac{\mu_0 I}{2} \frac{R^{2}}{(R^{2} + z^{2})^{3/2}} \hat{k} \quad \text{(From eqn. 3.37)}{{< /katex >}}

At larger distance {{< katex >}}z \gg R{{< /katex >}}, therefore {{< katex >}}R^{2} + z^{2} \approx z^{2}{{< /katex >}}, we have
...
Let {{< katex >}}A{{< /katex >}} be the area of the circular loop {{< katex >}}A = \pi R^{2}{{< /katex >}}. So rewriting the equation (3.42) in terms of area of the loop, we have
...
where {{< katex >}}p_m{{< /katex >}} is called magnetic dipole moment. In vector notation,

{{< katex display=true >}}\overline{p}_m = I \vec{A} \quad (3.44){{< /katex >}}

This implies that a current carrying circular loop behaves as a magnetic dipole of magnetic moment {{< katex >}}\overline{p}_m{{< /katex >}}. So, the magnetic dipole moment of any current loop is equal to the product of the current and area of the loop.
...
If {{< katex >}}T{{< /katex >}} is the time period of revolution of an electron, the current due to circular motion of the electron is

{{< katex display=true >}}I = \frac{-e}{T} \quad (3.46){{< /katex >}}

where {{< katex >}}-e{{< /katex >}} is the charge of an electron. If {{< katex >}}R{{< /katex >}} is the radius of the circular orbit and {{< katex >}}\nu{{< /katex >}} is the velocity of the electron in the circular orbit, then
...
where {{< katex >}}A = \pi R^2{{< /katex >}} is the area of the circular loop. By definition, angular momentum of the electron about O is
...
The ratio {{< katex >}}\frac{\mu_L}{L}{{< /katex >}} is a constant known as gyro-magnetic ratio {{< katex >}}\left(\frac{e}{2m}\right){{< /katex >}}. It must be noted that the gyro-magnetic ratio is a constant of proportionality which connects angular momentum of the electron and the magnetic moment of the electron.
...
where {{< katex >}}h{{< /katex >}} is the Planck's constant {{< katex >}}(h = 6.63 \times 10^{-34} \mathrm{J s}){{< /katex >}} and number {{< katex >}}n{{< /katex >}} is the orbit number, i.e., {{< katex >}}n = 1,2,3, \ldots{{< /katex >}} Hence,
...
The minimum value of magnetic moment can be obtained by substituting {{< katex >}}n = 1{{< /katex >}}

{{< katex display=true >}}\mu_L = 9.27\times 10^{-24}\mathrm{A m}^2 = 9.27\times 10^{-24}\mathrm{J T}^{-1} = (\mu_L)_{\min} = \mu_B{{< /katex >}}

where {{< katex >}}\mu_B = \frac{eh}{4\pi m} = 9.27\times 10^{-24}\mathrm{A m}^2{{< /katex >}} is called Bohr magneton which is used to measure atomic magnetic moments.
...
Ampère's law: The line integral of magnetic field over a closed loop is {{< katex >}}\mu_0{{< /katex >}} times net current enclosed by the loop.

{{< katex display=true >}}\oint_{C} \vec{B} \cdot \vec{dl} = \mu_0 I_{enclosed} \quad (3.51){{< /katex >}}

where {{< katex >}}I_{enclosed}{{< /katex >}} is the net current linked by the closed loop C. Note that the line integral does not depend on the shape of the path or the position of the conductor with the magnetic field.

### 3.9.2 Magnetic field due to the current carrying wire of infinite length using Ampère's law

Consider a straight conductor of infinite length carrying current {{< katex >}}I{{< /katex >}} and the direction of magnetic field lines is shown. Since the wire is geometrically cylindrical in shape and symmetrical about its axis, we construct an Amperian loop in the form of a circular shape at a distance {{< katex >}}r{{< /katex >}} from the centre of the conductor. From the Ampere's law, we get
...
where {{< katex >}}I{{< /katex >}} is the current enclosed by the Amperian loop. Due to the symmetry, the magnitude of the magnetic field is uniform over the Amperian loop. Hence

{{< katex display=true >}}B \oint_{c} dl = \mu_0 I{{< /katex >}}

For a circular loop, the circumference is {{< katex >}}2\pi r{{< /katex >}}, which implies,
...
where {{< katex >}}\hat{n}{{< /katex >}} is the unit vector along the tangent to the Amperian loop.
...
Given that {{< katex >}}I = 1{{< /katex >}} A and radius {{< katex >}}r = 1{{< /katex >}} m
...
But the Earth's magnetic field is {{< katex >}}B_{Earth} \sim 10^{-5}\mathrm{T}{{< /katex >}}

So, {{< katex >}}B_{\text{straight wire}}{{< /katex >}} is one hundred times smaller than {{< katex >}}B_{Earth}{{< /katex >}}.
...
Consider a solenoid of length {{< katex >}}L{{< /katex >}} having {{< katex >}}N{{< /katex >}} turns. The diameter of the solenoid is assumed to be much smaller when compared to its length and the coil is wound very closely.
...
Since the magnetic field outside the solenoid is zero, the integral {{< katex >}}\int_{c}^{d} \bar{B} \cdot d\bar{l} = 0{{< /katex >}}
...
where the length of the loop ab is {{< katex >}}h{{< /katex >}}. But the choice of length of the loop ab is arbitrary. We can take very large loop such that it is equal to the length of the solenoid {{< katex >}}L{{< /katex >}}. Therefore the integral is

{{< katex display=true >}}\int_{a}^{b} \bar{B} \cdot d\bar{l} = BL{{< /katex >}}

Let {{< katex >}}I{{< /katex >}} be the current passing through the solenoid of {{< katex >}}N{{< /katex >}} turns, then

{{< katex display=true >}}\int_{a}^{b} \bar{B} \cdot d\bar{l} = BL = \mu_0 NI \Rightarrow B = \mu_0 \frac{NI}{L}{{< /katex >}}

The number of turns per unit length is given by {{< katex >}}\frac{N}{L} = n{{< /katex >}}, Then

{{< katex display=true >}}B = \mu_0 \frac{nL I}{L} = \mu_0 n I \quad (3.52){{< /katex >}}

Since {{< katex >}}n{{< /katex >}} is a constant for a given solenoid and {{< katex >}}\mu_0{{< /katex >}} is also constant. For a fixed current {{< katex >}}I{{< /katex >}}, the magnetic field inside the solenoid is also a constant.
...
{{< katex >}}L \rightarrow 2L{{< /katex >}} (length becomes twice), {{< katex >}}N \rightarrow N{{< /katex >}} (number of turns remains constant)
...
(b) both the length of the solenoid and number of turns are doubled
{{< katex >}}L \rightarrow 2L{{< /katex >}} (length becomes twice), {{< katex >}}N \rightarrow 2N{{< /katex >}} (number of turns becomes twice)
...
{{< katex >}}L \rightarrow L{{< /katex >}} (length is fixed), {{< katex >}}N \rightarrow 2N{{< /katex >}} (number of turns becomes twice)
...
Let us calculate the magnetic field {{< katex >}}B_p{{< /katex >}} at point P. We construct an Amperian loop 1 of radius {{< katex >}}r_1{{< /katex >}} around the point P. For simplicity, we take circular loop so that the length of the loop is its circumference.
...
Since the loop 1 encloses no current, {{< katex >}}I_{enclosed} = 0{{< /katex >}}
...
Let us calculate the magnetic field {{< katex >}}B_Q{{< /katex >}} at point Q. We construct an Amperian loop 3 of radius {{< katex >}}r_3{{< /katex >}} around the point Q. The length of the loop is
...
Since in each turn of the toroid loop, current coming out of the plane of paper is cancelled by the current going into the plane of paper. Thus, {{< katex >}}I_{enclosed} = 0{{< /katex >}}
...
Let us calculate the magnetic field {{< katex >}}B_S{{< /katex >}} at point S by constructing an Amperian loop 2 of radius {{< katex >}}r_2{{< /katex >}} around the point S. The length of the loop is
...
Let {{< katex >}}I{{< /katex >}} be the current passing through the toroid and {{< katex >}}N{{< /katex >}} be the number of turns of the toroid, then
...
If the number of turns per unit length {{< katex >}}n = \frac{N}{2\pi r_2}{{< /katex >}}, then the magnetic field at point S is

{{< katex display=true >}}B_S = \mu_0 n I{{< /katex >}}

## 3.10 LORENTZ FORCE

When an electric charge {{< katex >}}q{{< /katex >}} is kept at rest in a magnetic field, no force acts on it. At the same time, if the charge moves in the magnetic field, it experiences a force. This force is different from Coulomb force, studied in unit 1. This force is known as magnetic force. It is given by the equation

{{< katex display=true >}}\vec{F} = q(\vec{v} \times \vec{B}) \quad (3.54){{< /katex >}}

In general, if the charge is moving in both the electric and magnetic fields, the total force experienced by the charge is given by {{< katex >}}\vec{F} = q(\vec{E} + \vec{v} \times \vec{B}){{< /katex >}}. It is known as Lorentz force.

### 3.10.1 Force on a moving charge in a magnetic field

When an electric charge {{< katex >}}q{{< /katex >}} is moving with velocity {{< katex >}}\vec{v}{{< /katex >}} in the magnetic field {{< katex >}}\vec{B}{{< /katex >}}, it experiences a force, called magnetic force {{< katex >}}\vec{F}_m{{< /katex >}}. After careful experiments, Lorentz deduced the force experienced by a moving charge in the magnetic field {{< katex >}}\vec{F}_m{{< /katex >}}

{{< katex display=true >}}\vec{F}_m = q(\vec{v} \times \vec{B}) \quad (3.55){{< /katex >}}

In magnitude, {{< katex display=true >}}F_m = q \nu B \sin \theta \quad (3.56){{< /katex >}}
...
3. {{< katex >}}\vec{F}_m{{< /katex >}} is directly proportional to sine of the angle between the velocity and magnetic field
4. {{< katex >}}\vec{F}_m{{< /katex >}} is directly proportional to the magnitude of the charge {{< katex >}}q{{< /katex >}}
...
6. The direction of {{< katex >}}\vec{F}_m{{< /katex >}} on negative charge is opposite to the direction of {{< katex >}}\vec{F}_m{{< /katex >}} on positive charge provided other factors are identical.
7. If velocity {{< katex >}}\vec{v}{{< /katex >}} of the charge {{< katex >}}q{{< /katex >}} is along magnetic field {{< katex >}}\vec{B}{{< /katex >}} then, {{< katex >}}\vec{F}_m{{< /katex >}} is zero
...
A particle of charge {{< katex >}}q{{< /katex >}} moves with velocity {{< katex >}}\vec{v}{{< /katex >}} along positive y-direction in a magnetic field {{< katex >}}\vec{B}{{< /katex >}}. Compute the Lorentz force experienced by the particle (a) when magnetic field is along positive y-direction (b) when magnetic field points in positive z-direction (c) when magnetic field is in zy-plane and making an angle {{< katex >}}\theta{{< /katex >}} with velocity of the particle. Mark the direction of magnetic force in each case.

**Solution**

Velocity of the particle is {{< katex >}}\vec{v} = \nu \hat{j}{{< /katex >}}

(a) Magnetic field is along positive {{< katex >}}y{{< /katex >}}-direction, this implies, {{< katex >}}\vec{B} = B\hat{j}{{< /katex >}}

From Lorentz force, {{< katex >}}\vec{F}_m = q(\nu \hat{j} \times B\hat{j}) = \vec{0}{{< /katex >}}

So, no force acts on the particle when it moves along the direction of magnetic field.

(b) Since the magnetic field points in positive {{< katex >}}z{{< /katex >}}-direction, this implies, {{< katex >}}\vec{B} = B\hat{k}{{< /katex >}}

From Lorentz force, {{< katex >}}\vec{F}_m = q(\nu \hat{j} \times B\hat{k}) = q\nu B \hat{i}{{< /katex >}}

Therefore, the magnitude of the Lorentz force is {{< katex >}}q\nu B{{< /katex >}} and direction is along positive {{< katex >}}x{{< /katex >}}-direction.

(c) Magnetic field is in zy-plane and making an angle {{< katex >}}\theta{{< /katex >}} with the velocity of the particle, which implies {{< katex >}}\vec{B} = B\cos \theta \hat{j} + B\sin \theta \hat{k}{{< /katex >}}
...
Compute the work done and power delivered by the Lorentz force on the particle of charge {{< katex >}}q{{< /katex >}} moving with velocity {{< katex >}}\vec{v}{{< /katex >}}. Calculate the angle between Lorentz force and velocity of the charged particle and also interpret the result.

**Solution**

For a charged particle moving on a magnetic field, {{< katex >}}\vec{F} = q(\vec{v} \times \vec{B}){{< /katex >}}
...
Since {{< katex >}}\vec{v} \times \vec{B}{{< /katex >}} is perpendicular to {{< katex >}}\vec{v}{{< /katex >}} and hence {{< katex >}}(\vec{v} \times \vec{B}) \cdot \vec{v} = 0{{< /katex >}}. This means that Lorentz force does no work on the particle. From work-kinetic energy theorem,

{{< katex display=true >}}\frac{dW}{dt} = P = 0{{< /katex >}}

### 3.10.2 Motion of a charged particle in a uniform magnetic field

Consider a charged particle of charge {{< katex >}}q{{< /katex >}} having mass {{< katex >}}m{{< /katex >}} entering into a region of uniform magnetic field {{< katex >}}\bar{B}{{< /katex >}} with velocity {{< katex >}}\bar{v}{{< /katex >}} such that velocity is perpendicular to the magnetic field. As soon as the particle enters into the field, Lorentz force acts on it in a direction perpendicular to both magnetic field {{< katex >}}\bar{B}{{< /katex >}} and velocity {{< katex >}}\bar{v}{{< /katex >}}.
...
where {{< katex >}}p = m \nu{{< /katex >}} is the magnitude of the linear momentum of the particle. Let {{< katex >}}T{{< /katex >}} be the time taken by the particle to finish one complete circular motion, then
...
Equation (3.59) is called the cyclotron period. The reciprocal of time period is the frequency {{< katex >}}f{{< /katex >}}, which is

{{< katex display=true >}}f = \frac{1}{T} = \frac{q B}{2\pi m} \quad (3.60){{< /katex >}}

In terms of angular frequency {{< katex >}}\omega{{< /katex >}},
...
Charge of an electron {{< katex >}}q = -1.60 \times 10^{-19}\mathrm{C} \Rightarrow |q| = 1.60 \times 10^{-19}\mathrm{C}{{< /katex >}}

Magnitude of magnetic field {{< katex >}}B = 0.500\mathrm{T}{{< /katex >}}

Mass of the electron, {{< katex >}}m = 9.11 \times 10^{-31}\mathrm{kg}{{< /katex >}}

Radius of the orbit, {{< katex >}}r = 2.50\mathrm{mm} = 2.50 \times 10^{-3}\mathrm{m}{{< /katex >}}
...
A proton moves in a uniform magnetic field of strength 0.500 T magnetic field is directed along the x-axis. At initial time, {{< katex >}}t = 0s{{< /katex >}} the proton has velocity {{< katex >}}\vec{v} = (1.95 \times 10^{5}\hat{i} + 2.00 \times 10^{5}\hat{k})\mathrm{ms}^{-1}{{< /katex >}}. Find
...
Magnetic field {{< katex >}}\vec{B} = 0.500\hat{i}\mathrm{T}{{< /katex >}}

Velocity of the particle {{< katex >}}\vec{v} = (1.95 \times 10^{5}\hat{i} + 2.00 \times 10^{5}\hat{k})\mathrm{ms}^{-1}{{< /katex >}}

Charge of the proton {{< katex >}}q = 1.60 \times 10^{-19}\mathrm{C}{{< /katex >}}

Mass of the proton {{< katex >}}m = 1.67 \times 10^{-27}\mathrm{kg}{{< /katex >}}
...
Pitch of the helix is the distance travelled along {{< katex >}}x{{< /katex >}}-axis in a time {{< katex >}}T{{< /katex >}}, which is {{< katex >}}P = \nu_x T{{< /katex >}}

But time, {{< katex >}}T = \frac{2\pi}{\omega} = \frac{2\pi m}{|q|B} = \frac{2 \times 3.14 \times 1.67 \times 10^{-27}}{1.60 \times 10^{-19} \times 0.500} = 13.1 \times 10^{-8}\mathrm{s}{{< /katex >}}
...
Two singly ionized isotopes of uranium {{< katex >}}\frac{235}{92}U{{< /katex >}} and {{< katex >}}\frac{238}{92}U{{< /katex >}} (isotopes have same atomic number but different mass number) are sent with velocity {{< katex >}}1.00 \times 10^{5}\mathrm{m s}^{-1}{{< /katex >}} into a magnetic field of strength {{< katex >}}0.500\mathrm{T}{{< /katex >}} normally. Compute the distance between the two isotopes after they complete a semi-circle. Also compute the time taken by each isotope to complete one semi-circular path. (Given: masses of the isotopes: {{< katex >}}m_{235} = 3.90 \times 10^{-25}\mathrm{kg}{{< /katex >}} and {{< katex >}}m_{238} = 3.95 \times 10^{-25}\mathrm{kg}{{< /katex >}})

**Solution**

Since isotopes are singly ionized, they have equal charge which is equal to the charge of an electron, {{< katex >}}q = -1.6 \times 10^{-19}\mathrm{C}{{< /katex >}}. Mass of uranium {{< katex >}}\frac{235}{92}U{{< /katex >}} and {{< katex >}}\frac{238}{92}U{{< /katex >}} are {{< katex >}}3.90 \times 10^{-25}\mathrm{kg}{{< /katex >}} and {{< katex >}}3.95 \times 10^{-25}\mathrm{kg}{{< /katex >}} respectively. Magnetic field applied, {{< katex >}}B = 0.500\mathrm{T}{{< /katex >}}. Velocity of the electron is {{< katex >}}1.00 \times 10^{5}\mathrm{ms}^{-1}{{< /katex >}}, then

(a) the radius of the path of {{< katex >}}\frac{235}{92}U{{< /katex >}} is {{< katex >}}r_{235}{{< /katex >}}
...
The diameter of the semi-circle due to {{< katex >}}\frac{235}{92}U{{< /katex >}} is {{< katex >}}d_{235} = 2r_{235} = 97.6\mathrm{cm}{{< /katex >}}

The radius of the path of {{< katex >}}\frac{238}{92}U{{< /katex >}} is {{< katex >}}r_{238}{{< /katex >}}
...
The diameter of the semi-circle due to {{< katex >}}\frac{238}{92}U{{< /katex >}} is {{< katex >}}d_{238} = 2r_{238} = 98.8\mathrm{cm}{{< /katex >}}

Therefore the separation distance between the isotopes is {{< katex >}}\Delta d = d_{238} - d_{235} = 1.2\mathrm{cm}{{< /katex >}}
...
Let us consider an experimental arrangement to illustrate velocity selector. In the region of space between the parallel plates of a capacitor which produce uniform electric field {{< katex >}}\vec{E}{{< /katex >}}, a uniform magnetic field {{< katex >}}\vec{B}{{< /katex >}} is maintained perpendicular to the direction of electric field.

Suppose a charged particle with charge {{< katex >}}q{{< /katex >}} enters the space from left side with a velocity {{< katex >}}\vec{v}{{< /katex >}}, the net force on the particle is
...
This means, for a given magnitude of {{< katex >}}\bar{E}{{< /katex >}}-field and {{< katex >}}\bar{B}{{< /katex >}}-field, the forces act only on the particle moving with particular speed {{< katex >}}\nu = \frac{E}{B}{{< /katex >}}. This speed is independent of mass and charge.
...
Let {{< katex >}}E{{< /katex >}} be the electric field of magnitude {{< katex >}}6.0 \times 10^{6} \mathrm{N C}^{-1}{{< /katex >}} and {{< katex >}}B{{< /katex >}} be the magnetic field magnitude 0.83 T. Suppose an electron is accelerated with a potential of {{< katex >}}200 \mathrm{V}{{< /katex >}}, will it show zero deflection? If not, at what potential will it show zero deflection.

**Solution:**

Electric field, {{< katex >}}E = 6.0 \times 10^{6} \mathrm{N C}^{-1}{{< /katex >}} and magnetic field, {{< katex >}}B = 0.83 \mathrm{T}{{< /katex >}}.

Then

{{< katex display=true >}}v = \frac{E}{B} = \frac{6.0 \times 10^{6}}{0.83} = 7.23 \times 10^{6}\mathrm{ms}^{-1}{{< /katex >}}

When an electron goes with this velocity, it shows null deflection. Since the accelerating potential is {{< katex >}}200 \mathrm{V}{{< /katex >}}, the electron acquires kinetic energy because of this accelerating potential. Hence,

{{< katex display=true >}}\frac{1}{2} mv^2 = eV{{< /katex >}}
{{< katex display=true >}}v = \sqrt{\frac{2eV}{m}}{{< /katex >}}

Since the mass of the electron, {{< katex >}}m = 9.1 \times 10^{-31} \mathrm{kg}{{< /katex >}} and charge of an electron, {{< katex >}}|q| = e = 1.6 \times 10^{-19} \mathrm{C}{{< /katex >}}. The velocity acquired by the electron due to accelerating potential of {{< katex >}}200 \mathrm{V}{{< /katex >}} is

{{< katex display=true >}}v_{200} = \sqrt{\frac{2(1.6 \times 10^{-19})(200)}{(9.1 \times 10^{-31})}} = 8.39 \times 10^{6}\mathrm{ms}^{-1}{{< /katex >}}

Since the speed {{< katex >}}v_{200} > \nu{{< /katex >}}, the electron is deflected towards direction of Lorentz force. So, in order to have null deflection, the potential, we have to supply is
...
Let us assume that the ion ejected from source S is positively charged. As soon as ion is ejected, it is accelerated towards a Dee (say, {{< katex >}}D_1{{< /katex >}}) which has negative potential at that time. Since the magnetic field is normal to the plane of the Dees, the ion moves in a circular path. After one semi-circular path inside {{< katex >}}D_1{{< /katex >}}, the ion reaches the gap between Dees. At this time, the polarities of the Dees are reversed so that the ion is now accelerated towards {{< katex >}}D_2{{< /katex >}} with a greater velocity. For this circular motion, the centripetal force on the charged particle {{< katex >}}q{{< /katex >}} is provided by Lorentz force.
...
The important condition in cyclotron operation is that when the frequency {{< katex >}}f{{< /katex >}} at which the positive ion circulates in the magnetic field must be equal to the constant frequency of the electrical oscillator {{< katex >}}f_{osc}{{< /katex >}}. This is called resonance condition.
...
Magnetic field {{< katex >}}B = 1{{< /katex >}} T

Mass of the proton, {{< katex >}}m_p = 1.67 \times 10^{-27}\mathrm{kg}{{< /katex >}}
...
When a current carrying conductor is placed in a magnetic field, the force experienced by the conductor is equal to the sum of Lorentz forces on the individual charge carriers in the conductor. Consider a small segment of conductor of length {{< katex >}}dl{{< /katex >}}, with cross-sectional area {{< katex >}}A{{< /katex >}} and current {{< katex >}}I{{< /katex >}}. The free electrons drift opposite to the direction of current. So the relation between current {{< katex >}}I{{< /katex >}} and magnitude of drift velocity {{< katex >}}v_d{{< /katex >}} is

{{< katex display=true >}}I = neAv_d \quad (3.65){{< /katex >}}

If the conductor is kept in a magnetic field {{< katex >}}\vec{B}{{< /katex >}}, then average force experienced by the charge (electron) in the conductor is

{{< katex display=true >}}\vec{f} = -e(\vec{v}_d \times \vec{B}){{< /katex >}}

If {{< katex >}}n{{< /katex >}} is the number of free electrons present in unit volume, then

{{< katex display=true >}}n = \frac{N}{V}{{< /katex >}}

where {{< katex >}}N{{< /katex >}} is the number of free electrons in the small element of volume {{< katex >}}V = A dl{{< /katex >}}

Hence Lorentz force on the elementary section of length {{< katex >}}dl{{< /katex >}} is the product of the number of the electrons {{< katex >}}(N = nA dl){{< /katex >}} and the force acting on each electron.

{{< katex display=true >}}d\vec{F} = -enA dl (\vec{v}_d \times \vec{B}){{< /katex >}}

The current element in the conductor is {{< katex >}}I d\vec{l} = -enA \vec{v}_d dl{{< /katex >}}. Therefore the force on the small elemental section of the current-carrying conductor is

{{< katex display=true >}}d\vec{F} = (I d\vec{l} \times \vec{B}) \quad (3.66){{< /katex >}}

Thus the force on a straight current carrying conductor of length {{< katex >}}l{{< /katex >}} placed in a uniform magnetic field is
...
(a) If the conductor is placed along the direction of the magnetic field, the angle then {{< katex >}}\theta = 0^{\circ}{{< /katex >}}. Hence, the force experienced by the conductor is zero.
(b) If the conductor is placed perpendicular to the magnetic field, then the angle {{< katex >}}\theta = 90^{\circ}{{< /katex >}}. Hence, the force experienced by the conductor is maximum, which is {{< katex >}}F_{\text{total}} = BIl{{< /katex >}}.
...
A metallic rod of linear density is 0.25 {{< katex >}}\mathrm{kg m^{-1}}{{< /katex >}} is lying horizontally on a smooth inclined plane which makes an angle of {{< katex >}}45^{\circ}{{< /katex >}} with the horizontal. The rod is not allowed to slide down by flowing a current through it when a magnetic field of strength 0.25 T is acting on it in the vertical direction. Calculate the electric current flowing in the rod to keep it stationary.

**Solution**

The linear density of the rod i.e., mass per unit length of the rod is {{< katex >}}0.25\mathrm{kg m^{-1}}{{< /katex >}}

{{< katex display=true >}}\Rightarrow \frac{m}{l} = 0.25\mathrm{kg m^{-1}}{{< /katex >}}

Let {{< katex >}}I{{< /katex >}} be the current flowing in the metallic rod. The direction of electric current is into the plane of the paper. The direction of magnetic force {{< katex >}}BIl{{< /katex >}} is given by Fleming's left hand rule.
...
Let two long straight parallel current carrying conductors separated by a distance {{< katex >}}r{{< /katex >}} be kept in air medium. Let {{< katex >}}I_1{{< /katex >}} and {{< katex >}}I_2{{< /katex >}} be the electric currents passing through the conductors A and B in same direction (i.e. along z-direction) respectively. The net magnetic field at a distance {{< katex >}}r{{< /katex >}} due to current {{< katex >}}I_1{{< /katex >}} in conductor A is

{{< katex display=true >}}\vec{B}_1 = \frac{\mu_0 I_1}{2\pi r} (-\hat{i}) = -\frac{\mu_0 I_1}{2\pi r}\hat{i}{{< /katex >}}

From thumb rule, the direction of magnetic field is perpendicular to the plane of the paper and inwards (arrow into the page {{< katex >}}\otimes{{< /katex >}}) i.e. along negative {{< katex >}}\hat{i}{{< /katex >}} direction.

Let us consider a small elemental length {{< katex >}}dl{{< /katex >}} in conductor B at which the magnetic field {{< katex >}}\vec{B}_1{{< /katex >}} is present. From equation 3.66, Lorentz force on the element {{< katex >}}dl{{< /katex >}} of conductor B is
...
Therefore the force on {{< katex >}}dl{{< /katex >}} of the wire B is directed towards the conductor A. So the element of length {{< katex >}}dl{{< /katex >}} in B is attracted towards the conductor A. Hence the force per unit length of the conductor B due to current in the conductor A is

{{< katex display=true >}}\frac{\vec{F}}{l} = -\frac{\mu_0 I_1 I_2}{2\pi r} \hat{j}{{< /katex >}}

Similarly, the net magnetic induction due to current {{< katex >}}I_2{{< /katex >}} (in conductor B) at a distance {{< katex >}}r{{< /katex >}} in the elemental length {{< katex >}}dl{{< /katex >}} of conductor A is

{{< katex display=true >}}\vec{B}_2 = \frac{\mu_0 I_2}{2\pi r} \hat{i}{{< /katex >}}

From the thumb rule, direction of magnetic field is perpendicular to the plane of the paper and outwards (arrow out of the page {{< katex >}}\odot{{< /katex >}}) i.e., along positive {{< katex >}}\hat{i}{{< /katex >}} direction. Hence, the magnetic force acting on element {{< katex >}}dl{{< /katex >}} of the conductor A is
...
Therefore the force on {{< katex >}}dl{{< /katex >}} of conductor A is directed towards the conductor B. So the length {{< katex >}}dl{{< /katex >}} is attracted towards the conductor B.
...
One ampere is defined as that constant current which when passed through each of the two infinitely long parallel straight conductors kept side by side parallelly at a distance of one metre apart in air or vacuum causes each conductor to experience a force of {{< katex >}}2 \times 10^{-7}{{< /katex >}} newton per metre length of conductor.
...
Consider a rectangular loop PQRS carrying current {{< katex >}}I{{< /katex >}} is placed in a uniform magnetic field {{< katex >}}\vec{B}{{< /katex >}}. Let {{< katex >}}a{{< /katex >}} and {{< katex >}}b{{< /katex >}} be the length and breadth of rectangular loop respectively. The unit vector {{< katex >}}\hat{n}{{< /katex >}} normal to the plane of the loop makes an angle {{< katex >}}\theta{{< /katex >}} with the magnetic field.

The magnitude of the magnetic force acting on the current-carrying arm PQ is {{< katex >}}F_{PQ} = I a B \sin \left(\frac{\pi}{2}\right) = I a B{{< /katex >}}. The direction of the force is found using right hand cork screw rule and its direction is upwards.

The magnitude of the force on the arm QR is {{< katex >}}F_{QR} = I b B \sin \left(\frac{\pi}{2} - \theta\right) = I b B \cos \theta{{< /katex >}} and its direction is as shown.

The magnitude of the force on the arm RS is {{< katex >}}F_{RS} = I a B \sin \left(\frac{\pi}{2}\right) = I a B{{< /katex >}} and its direction is downwards.

The magnitude of the force acting on the arm SP is {{< katex >}}F_{SP} = I b B \sin \left(\frac{\pi}{2} + \theta\right) = I b B \cos \theta{{< /katex >}} and its direction is also as shown.

Since the forces {{< katex >}}F_{QR}{{< /katex >}} and {{< katex >}}F_{SP}{{< /katex >}} are equal, opposite and collinear, they cancel each other. But the forces {{< katex >}}F_{PQ}{{< /katex >}} and {{< katex >}}F_{RS}{{< /katex >}}, which are equal in magnitude and opposite in direction, are not acting along same straight line. Therefore, {{< katex >}}F_{PQ}{{< /katex >}} and {{< katex >}}F_{RS}{{< /katex >}} constitute a couple which exerts a torque on the loop.

The magnitude of torque acting on the arm PQ about AB is {{< katex >}}\tau_{PQ} = \left(\frac{b}{2}\sin \theta\right) I a B{{< /katex >}} and it points in the direction of AB. The magnitude of the torque acting on the arm RS about AB is {{< katex >}}\tau_{RS} = \left(\frac{b}{2}\sin \theta\right) I a B{{< /katex >}} and points also in the same direction AB.
...
where {{< katex >}}A = ab{{< /katex >}} is the area of the rectangular coil.

In vector form, {{< katex >}}\vec{\tau} = (I\vec{A}) \times \vec{B}{{< /katex >}}
...
If there are {{< katex >}}N{{< /katex >}} turns in the rectangular loop, then the torque is given by {{< katex >}}\vec{\tau} = NIAB \sin \theta{{< /katex >}}

**Special cases:**

(a) When {{< katex >}}\theta = 90^{\circ}{{< /katex >}} or the plane of the loop is parallel to the magnetic field, the torque on the current loop is maximum.
{{< katex display=true >}}\tau_{\max} = IAB{{< /katex >}}

(b) When {{< katex >}}\theta = 0^{\circ} / 180^{\circ}{{< /katex >}} or the plane of the loop is perpendicular to the magnetic field, the torque on the current loop is zero.
...
Consider a single turn of the rectangular coil PQRS whose length is {{< katex >}}l{{< /katex >}} and breadth {{< katex >}}b{{< /katex >}}. {{< katex >}}PQ = RS = l{{< /katex >}} and {{< katex >}}QR = SP = b{{< /katex >}}. Let {{< katex >}}I{{< /katex >}} be the electric current flowing through the rectangular coil PQRS. The horse-shoe magnet has hemi-spherical magnetic poles which produces a radial magnetic field. Due to this radial field, the sides QR and SP are always parallel to the magnetic field {{< katex >}}B{{< /katex >}} and experience no force. The sides PQ and RS are always perpendicular to the magnetic field and experience equal forces in opposite directions. Due to this, torque is produced.

For single turn, the deflecting torque is

{{< katex display=true >}}\tau = bF = b(BIl) = (lb)B = ABI{{< /katex >}}

since area of the coil, {{< katex >}}A = lb{{< /katex >}}

For coil with {{< katex >}}N{{< /katex >}} turns, we get

{{< katex display=true >}}\tau = NABI \quad (3.69){{< /katex >}}

Due to this deflecting torque, the coil gets twisted and restoring torque (also known as restoring couple) is developed. Hence the moment of the restoring torque is proportional to the amount of twist {{< katex >}}\theta{{< /katex >}}. Thus

{{< katex display=true >}}\tau = K\theta \quad (3.70){{< /katex >}}

where {{< katex >}}K{{< /katex >}} is the restoring couple per unit twist.
...
where {{< katex >}}G = \frac{K}{NAB}{{< /katex >}} is called galvanometer constant or current reduction factor of the galvanometer.
...
(i) increasing the number of turns, {{< katex >}}N{{< /katex >}}
(ii) increasing the magnetic induction, {{< katex >}}B{{< /katex >}}
(iii) increasing the area of the coil, {{< katex >}}A{{< /katex >}}
(iv) decreasing the couple per unit twist of the suspension wire, {{< katex >}}K{{< /katex >}}
...
where {{< katex >}}R_g{{< /katex >}} is the resistance of galvanometer.

**EXAMPLE 3.25**

The coil of a moving coil galvanometer has 5 turns and each turn has an effective area of {{< katex >}}2 \times 10^{-2}\mathrm{m}^2{{< /katex >}}. It is suspended in a magnetic field whose strength is {{< katex >}}4 \times 10^{-2}\mathrm{Wb m}^{-2}{{< /katex >}}. If the torsional constant {{< katex >}}K{{< /katex >}} of the suspension fibre is {{< katex >}}4 \times 10^{-9}\mathrm{Nm deg}^{-1}{{< /katex >}}.

(a) Find its current sensitivity in division per micro-ampere.
(b) Calculate the voltage sensitivity of the galvanometer for it to have full scale deflection of 50 divisions for {{< katex >}}25\mathrm{mV}{{< /katex >}}.
(c) Compute the resistance of the galvanometer.

**Solution**

{{< katex >}}N = 5 \text{ turns}{{< /katex >}}
{{< katex >}}A = 2 \times 10^{-2}\mathrm{m}^2{{< /katex >}}
{{< katex >}}B = 4 \times 10^{-2}\mathrm{Wb m}^{-2}{{< /katex >}}
{{< katex >}}K = 4 \times 10^{-9}\mathrm{Nm deg}^{-1}{{< /katex >}}
...
{{< katex >}}1\mu \mathrm{A} = 1 \text{ microampere} = 10^{-6}\text{ ampere}{{< /katex >}}
...
The resistance of a moving coil galvanometer is made twice its original value in order to increase current sensitivity by {{< katex >}}50\%{{< /katex >}}. Find the percentage change in voltage sensitivity.

**Solution**

Voltage sensitivity is {{< katex >}}V_s = \frac{I_s}{R_g}{{< /katex >}}

When the resistance is doubled, then new resistance is {{< katex >}}R_g' = 2R_g{{< /katex >}}
...
Let {{< katex >}}I{{< /katex >}} be the current passing through the circuit. When current {{< katex >}}I{{< /katex >}} reaches the junction A, it divides into two components. Let {{< katex >}}I_g{{< /katex >}} be the current passing through the galvanometer of resistance {{< katex >}}R_g{{< /katex >}} through a path AGE and the remaining current {{< katex >}}(I - I_g){{< /katex >}} passes along the path ACDE through shunt resistance S. The value of shunt resistance is so adjusted that current {{< katex >}}I_g{{< /katex >}} produces full scale deflection in the galvanometer. The potential difference across galvanometer is same as the potential difference across shunt resistance.
...
So, the deflection produced in the galvanometer is a measure of the current {{< katex >}}I{{< /katex >}} passing through the circuit.

Shunt resistance is connected in parallel to galvanometer. Therefore, resistance of ammeter {{< katex >}}(R_a){{< /katex >}} can be determined by computing the effective resistance, which is

{{< katex display=true >}}\frac{1}{R_{eff}} = \frac{1}{R_g} + \frac{1}{S} \Rightarrow R_{eff} = \frac{R_g S}{R_g + S} = R_a{{< /katex >}}

Since, the shunt resistance is a very low resistance and the ratio {{< katex >}}\frac{S}{R_g}{{< /katex >}} is also small. This means, {{< katex >}}R_a{{< /katex >}} is also small, i.e., the resistance offered by the ammeter is small. So, when we connect ammeter in series, the ammeter will not change appreciably the current in the circuit. For an ideal ammeter, the resistance must be equal to zero. But in reality, the reading in ammeter is always less than the actual current in the circuit. Let {{< katex >}}I_{ideal}{{< /katex >}} be the current measured by ideal ammeter and {{< katex >}}I_{actual}{{< /katex >}} be the actual current in the circuit. Then, the percentage error in measuring a current through an ammeter is
...
3. In order to increase the range of an ammeter {{< katex >}}n{{< /katex >}} times, the value of shunt resistance to be connected in parallel is
...
A galvanometer is converted into a voltmeter by connecting high resistance {{< katex >}}R_h{{< /katex >}} in series with galvanometer. The scale is now calibrated in volt and the range of voltmeter depends on the values of the resistance {{< katex >}}R_h{{< /katex >}} connected in series i.e. the value of resistance is so adjusted so that current {{< katex >}}I_g{{< /katex >}} produces full scale deflection in the galvanometer.

Let {{< katex >}}R_g{{< /katex >}} be the resistance of galvanometer and {{< katex >}}I_g{{< /katex >}} be the current with which the galvanometer produces full scale deflection. Since the galvanometer is connected in series with high resistance, the current in the electrical circuit is same as the current passing through the galvanometer.
...
3. In order to increase the range of voltmeter {{< katex >}}n{{< /katex >}} times the value of resistance to be connected in series with galvanometer is
...
- The angle subtended by the Earth's total magnetic field {{< katex >}}\bar{B}{{< /katex >}} with the horizontal direction in the magnetic meridian is called dip or magnetic inclination at that point.
- The magnetic moment is defined as the product of its pole strength and magnetic length. It is a vector quantity, denoted by {{< katex >}}\bar{p}_m{{< /katex >}}.
- The region surrounding magnet where magnetic pole of strength unity experiences a force is known as magnetic field. It is a vector quantity and denoted by {{< katex >}}\bar{B}{{< /katex >}}. Its unit is {{< katex >}}\mathrm{N A^{-1} m^{-1}}{{< /katex >}}.
- The number of magnetic field lines crossing normally through a given area is called magnetic flux {{< katex >}}\Phi_B{{< /katex >}}. It is a scalar quantity. In SI unit, magnetic flux {{< katex >}}\Phi_B{{< /katex >}} is weber, symbol Wb.
...
- Tangent law is {{< katex >}}B = B_H \tan \theta{{< /katex >}}.
- The magnetic field which is used to magnetize a sample or specimen is called the magnetising field. It is a vector quantity and denoted by {{< katex >}}\bar{H}{{< /katex >}} and its unit is {{< katex >}}\mathrm{A m^{-1}}{{< /katex >}}.
...
- Magnetic susceptibility is defined as the ratio of the intensity of magnetisation {{< katex >}}\bar{M}{{< /katex >}} induced in the material due to the magnetising field {{< katex >}}\bar{H}{{< /katex >}}.
- Magnetic materials are classified into three categories: diamagnetic, paramagnetic and ferromagnetic materials.
- The lagging of magnetic induction {{< katex >}}\bar{B}{{< /katex >}} behind the cyclic variation in magnetising field {{< katex >}}\bar{H}{{< /katex >}} is defined as "Hysteresis", which means "lagging behind".
...
- Ampère's circuital law is {{< katex >}}\oint_C \vec{B} \cdot d\vec{l} = \mu_0 I_{enclosed}{{< /katex >}}.
- Magnetic field inside the solenoid is {{< katex >}}B = \mu_0 n I{{< /katex >}}, where {{< katex >}}n{{< /katex >}} is the number of turns per unit length.
- Magnetic field interior to the toroid is {{< katex >}}B = \mu_0 n I{{< /katex >}}, where {{< katex >}}n{{< /katex >}} is the number of turns per unit length.
- Lorentz force is {{< katex >}}\vec{F} = q(\vec{E} + \vec{v} \times \vec{B}){{< /katex >}}.
...
- One ampere is defined as that constant current when it is passed through each of the two infinitely long parallel straight conductors kept at a distance of one meter apart in vacuum causes each conductor to experience a force of {{< katex >}}2 \times 10^{-7}{{< /katex >}} newton per metre length of the conductor.
- When a current carrying coil is placed in a uniform magnetic field, the net force on it is always zero but net torque is not zero. The magnitude of net torque is {{< katex >}}\tau = NABI \sin \theta{{< /katex >}}.
- Moving coil galvanometer is an instrument used for the detection and measurement of small currents.
- In moving coil galvanometer, current passing through the galvanometer is directly proportional to the deflection. Mathematically, {{< katex >}}I = G\theta{{< /katex >}}, where {{< katex >}}G = \frac{K}{NAB}{{< /katex >}} is called galvanometer constant or current reduction factor of the galvanometer.
- Current sensitivity is defined as the deflection produced per unit current flowing through it, {{< katex >}}I_s = \frac{\theta}{I} = \frac{NAB}{K} \Rightarrow I_s = \frac{1}{G}{{< /katex >}}.
- Voltage sensitivity is defined as the deflection produced per unit voltage which is applied across it, {{< katex >}}V_s = \frac{\theta}{V} = \frac{1}{GR_g} = \frac{I_s}{R_g}{{< /katex >}}, where {{< katex >}}R_g{{< /katex >}} is the resistance of galvanometer.
...
- A galvanometer can be converted into suitable voltmeter of given range by connecting a suitable high resistance {{< katex >}}R_h{{< /katex >}} in series with the given galvanometer.
...
1. The magnetic field at the centre O of the following current loop is
   (a) {{< katex >}}\frac{\mu I}{4r}\otimes{{< /katex >}} (b) {{< katex >}}\frac{\mu I}{4r}\odot{{< /katex >}} (c) {{< katex >}}\frac{\mu I}{2r}\otimes{{< /katex >}} (d) {{< katex >}}\frac{\mu I}{2r}\odot{{< /katex >}}

2. An electron moves in a straight line inside a charged parallel plate capacitor of uniform charge density {{< katex >}}\sigma{{< /katex >}}. The time taken by the electron to cross the parallel plate capacitor undeflected when the plates of the capacitor are kept under constant magnetic field of induction {{< katex >}}(\bar{B}){{< /katex >}} is
   (a) {{< katex >}}\epsilon_0 \frac{e l B}{\sigma}{{< /katex >}} (b) {{< katex >}}\epsilon_0 \frac{l B}{\sigma l}{{< /katex >}} (c) {{< katex >}}\epsilon_0 \frac{l B}{e\sigma}{{< /katex >}} (d) {{< katex >}}\epsilon_0 \frac{l B}{\sigma}{{< /katex >}}

3. A particle having mass {{< katex >}}m{{< /katex >}} and charge {{< katex >}}q{{< /katex >}} accelerated through a potential difference {{< katex >}}V{{< /katex >}}. Find the force experienced when it is kept under perpendicular magnetic field {{< katex >}}\bar{B}{{< /katex >}}.
   (a) {{< katex >}}\sqrt{\frac{2q^3 BV}{m}}{{< /katex >}} (b) {{< katex >}}\sqrt{\frac{q^3 B^2 V}{2m}}{{< /katex >}} (c) {{< katex >}}\sqrt{\frac{2q^3 B^2 V}{m}}{{< /katex >}} (d) {{< katex >}}\sqrt{\frac{2q^3 BV}{m^3}}{{< /katex >}}

4. A circular coil of radius {{< katex >}}5\mathrm{cm}{{< /katex >}} and 50 turns carries a current of 3 ampere. The magnetic dipole moment of the coil is nearly
   (a) {{< katex >}}1.0\mathrm{A m}^2{{< /katex >}} (b) {{< katex >}}1.2\mathrm{A m}^2{{< /katex >}} (c) {{< katex >}}0.5\mathrm{A m}^2{{< /katex >}} (d) {{< katex >}}0.8\mathrm{A m}^2{{< /katex >}}

5. A thin insulated wire forms a plane spiral of {{< katex >}}N = 100{{< /katex >}} tight turns carrying a current {{< katex >}}I = 8\mathrm{mA}{{< /katex >}} (milli ampere). The radii of inside and outside turns are {{< katex >}}a = 50\mathrm{mm}{{< /katex >}} and {{< katex >}}b = 100\mathrm{mm}{{< /katex >}} respectively. The magnetic induction at the centre of the spiral is
   (a) {{< katex >}}5\mu \mathrm{T}{{< /katex >}} (b) {{< katex >}}7\mu \mathrm{T}{{< /katex >}} (c) {{< katex >}}8\mu \mathrm{T}{{< /katex >}} (d) {{< katex >}}10\mu \mathrm{T}{{< /katex >}}
...
7. Two identical coils, each with {{< katex >}}N{{< /katex >}} turns and radius {{< katex >}}R{{< /katex >}} are placed coaxially at a distance {{< katex >}}R{{< /katex >}} as shown in the figure. If {{< katex >}}I{{< /katex >}} is the current passing through the loops in the same direction, then the magnetic field at a point P at a distance of {{< katex >}}R/2{{< /katex >}} from the centre of each coil is
   (a) {{< katex >}}\frac{8N\mu_0 I}{\sqrt{5}R}{{< /katex >}} (b) {{< katex >}}\frac{8N\mu_0 I}{5^{3/2}R}{{< /katex >}} (c) {{< katex >}}\frac{8N\mu_0 I}{5R}{{< /katex >}} (d) {{< katex >}}\frac{4N\mu_0 I}{\sqrt{5}R}{{< /katex >}}

8. A wire of length {{< katex >}}l{{< /katex >}} carrying a current {{< katex >}}I{{< /katex >}} along the Y direction is kept in a magnetic field given by {{< katex >}}\bar{B} = \frac{\beta}{\sqrt{3}} (\hat{i} + \hat{j} + \hat{k})T{{< /katex >}}. The magnitude of Lorentz force acting on the wire is
   (a) {{< katex >}}\sqrt{\frac{2}{3}}\beta Il{{< /katex >}} (b) {{< katex >}}\sqrt{\frac{1}{3}}\beta Il{{< /katex >}} (c) {{< katex >}}\sqrt{2}\beta Il{{< /katex >}} (d) {{< katex >}}\sqrt{\frac{1}{2}}\beta Il{{< /katex >}}

9. A bar magnet of length {{< katex >}}l{{< /katex >}} and magnetic moment {{< katex >}}p_m{{< /katex >}} is bent in the form of an arc as shown in figure. The new magnetic dipole moment will be
   (a) {{< katex >}}p_m{{< /katex >}} (b) {{< katex >}}\frac{3}{\pi} p_m{{< /katex >}} (c) {{< katex >}}\frac{2}{\pi} p_m{{< /katex >}} (d) {{< katex >}}\frac{1}{2} p_m{{< /katex >}}
...
10. A non-conducting charged ring carrying a charge of {{< katex >}}q{{< /katex >}} mass {{< katex >}}m{{< /katex >}} and radius {{< katex >}}r{{< /katex >}} is rotated about its axis with constant angular speed {{< katex >}}\omega{{< /katex >}}. Find the ratio of its magnetic moment with angular momentum is
    (a) {{< katex >}}\frac{q}{m}{{< /katex >}} (b) {{< katex >}}\frac{2q}{m}{{< /katex >}} (c) {{< katex >}}\frac{q}{2m}{{< /katex >}} (d) {{< katex >}}\frac{q}{4m}{{< /katex >}}
...
11. The BH curve for a ferromagnetic material is shown in the figure. The material is placed inside a long solenoid which contains 1000 turns/cm. The current that should be passed in the solenoid to demagnetize the ferromagnet completely is
    (a) {{< katex >}}1.00\mathrm{mA}{{< /katex >}} (b) {{< katex >}}1.25\mathrm{mA}{{< /katex >}} (c) {{< katex >}}1.50\mathrm{mA}{{< /katex >}} (d) {{< katex >}}1.75\mathrm{mA}{{< /katex >}}

12. Two short bar magnets have magnetic moments {{< katex >}}1.20 \mathrm{Am}^2{{< /katex >}} and {{< katex >}}1.00 \mathrm{Am}^2{{< /katex >}} respectively. They are kept on a horizontal table parallel to each other with their north poles pointing towards south. They have a common magnetic equator and are separated by a distance of {{< katex >}}20.0 \mathrm{cm}{{< /katex >}}. The value of the resultant horizontal magnetic induction at the mid-point O of the line joining their centres is (Horizontal components of Earth's magnetic induction is {{< katex >}}3.6 \times 10^{-5} \mathrm{Wb m}^{-2}{{< /katex >}})
    (a) {{< katex >}}3.60 \times 10^{-5} \mathrm{Wb m}^{-2}{{< /katex >}} (b) {{< katex >}}3.5 \times 10^{-5} \mathrm{Wb m}^{-2}{{< /katex >}} (c) {{< katex >}}2.56 \times 10^{-4} \mathrm{Wb m}^{-2}{{< /katex >}} (d) {{< katex >}}2.2 \times 10^{-4} \mathrm{Wb m}^{-2}{{< /katex >}}
...
13. The vertical component of Earth's magnetic field at a place is equal to the horizontal component. What is the value of angle of dip at this place?
    (a) {{< katex >}}30^{\circ}{{< /katex >}} (b) {{< katex >}}45^{\circ}{{< /katex >}} (c) {{< katex >}}60^{\circ}{{< /katex >}} (d) {{< katex >}}90^{\circ}{{< /katex >}}

14. A flat dielectric disc of radius {{< katex >}}R{{< /katex >}} carries an excess charge on its surface. The surface charge density is {{< katex >}}\sigma{{< /katex >}}. The disc rotates about an axis perpendicular to its plane passing through the centre with angular velocity {{< katex >}}\omega{{< /katex >}}. Find the magnitude of the torque on the disc if it is placed in a uniform magnetic field whose strength is {{< katex >}}B{{< /katex >}} which is directed perpendicular to the axis of rotation
    (a) {{< katex >}}\frac{1}{4}\sigma \omega \pi BR{{< /katex >}} (b) {{< katex >}}\frac{1}{2}\sigma \omega \pi BR^2{{< /katex >}} (c) {{< katex >}}\frac{1}{4}\sigma \omega \pi BR^3{{< /katex >}} (d) {{< katex >}}\frac{1}{4}\sigma \omega \pi BR^4{{< /katex >}}

15. The potential energy of magnetic dipole whose dipole moment is {{< katex >}}\vec{p}_m = (-0.5\vec{i} + 0.4\vec{j})\mathrm{Am}^2{{< /katex >}} kept in uniform magnetic field {{< katex >}}\vec{B} = 0.2\vec{i}\mathrm{T}{{< /katex >}}
...
1. A bar magnet having a magnetic moment {{< katex >}}\vec{P}_m{{< /katex >}} is cut into four pieces i.e., first cut into two pieces along the axis of the magnet and each piece is further cut along the axis into two pieces. Compute the magnetic moment of each piece.
   **Answer** {{< katex >}}\vec{p}_m' = \frac{1}{4} \vec{p}_m{{< /katex >}}

2. A conductor of linear mass density {{< katex >}}0.2 \mathrm{~g m^{-1}}{{< /katex >}} suspended by two flexible wire as shown in figure. Suppose the tension in the supporting wires is zero when it is kept inside the magnetic field of {{< katex >}}1 \mathrm{~T}{{< /katex >}} whose direction is into the page. Compute the current inside the conductor and also the direction of the current. Assume {{< katex >}}g = 10 \mathrm{~m s^{-2}}{{< /katex >}}
   **Answer** 2 mA

3. A circular coil with cross-sectional area {{< katex >}}0.1 \mathrm{~cm}^2{{< /katex >}} is kept in a uniform magnetic field of strength {{< katex >}}0.2 \mathrm{~T}{{< /katex >}}. If the current passing in the coil is {{< katex >}}3 \mathrm{~A}{{< /katex >}} and plane of the loop is perpendicular to the direction of magnetic field. Calculate
   (a) total torque on the coil (b) total force on the coil (c) average force on each electron in the coil due to the magnetic field. (The free electron density for the material of the wire is {{< katex >}}10^{28}\mathrm{m}^{-3}{{< /katex >}}).
   **Answer** (a) zero (b) zero (c) {{< katex >}}0.6 \times 10^{-23}\mathrm{N}{{< /katex >}}

4. A bar magnet is placed in a uniform magnetic field whose strength is {{< katex >}}0.8\mathrm{T}{{< /katex >}}. If the bar magnet is oriented at an angle {{< katex >}}30^{\circ}{{< /katex >}} with the external field experiences a torque of {{< katex >}}0.2\mathrm{Nm}{{< /katex >}}. Calculate:
   ...
   **Answer** (i) {{< katex >}}0.5\mathrm{A m}^2{{< /katex >}} (ii) {{< katex >}}W = 0.8\mathrm{J}{{< /katex >}} and {{< katex >}}W_{\mathrm{mag}} = -0.8\mathrm{J}{{< /katex >}}

5. A non-conducting sphere has a mass of {{< katex >}}100\mathrm{g}{{< /katex >}} and radius {{< katex >}}20\mathrm{cm}{{< /katex >}}. A flat compact coil of wire with turns 5 is wrapped tightly around it with each turns concentric with the sphere. This sphere is placed on an inclined plane such that plane of coil is parallel to the inclined plane. A uniform magnetic field of {{< katex >}}0.5\mathrm{T}{{< /katex >}} exists in the region in vertically upward direction. Compute the current {{< katex >}}I{{< /katex >}} required to rest the sphere in equilibrium.
   **Answer** {{< katex >}}\frac{2}{\pi} A{{< /katex >}}

6. Calculate the magnetic field at the centre of a square loop which carries a current of {{< katex >}}1.5\mathrm{A}{{< /katex >}}, length of each side being {{< katex >}}50\mathrm{cm}{{< /katex >}}.
   **Answer** {{< katex >}}3.4 \times 10^{-6}\mathrm{T}{{< /katex >}}
...
- Note the kinetic energy of the particle after some time (say {{< katex >}}t = 20{{< /katex >}} s)
