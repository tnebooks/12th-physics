...
<center>Figure 7.1 (a) Ripples on water surface (b) Wavefront and ray </center>
...
<center>Figure 7.2 Wavefronts </center>
...
<center>Figure 7.3 Huygens' Principle </center>
...
<center>Figure 7.4 Laws of reflection </center>
...
<center>Figure 7.5 Law of refraction </center>
...
<center>Figure 7.6 Superposition principle </center>
...
<center>Figure 7.7 Path difference and phase difference </center>
...
(i) Wavefront division (ii) Intensity (or) Amplitude division (iii) Source and Images.
...
<center>Figure 7.8 Wavefront division </center>
...
<center>Figure 7.9 Intensity (or) amplitude division </center>
...
<center>Figure 7.10 Source and images as coherent sources </center>
...
<center>Figure 7.12 Young's double slit experimental setup </center>
...
<center>Figure 7.13 Young's double slit arrangement to find path difference </center>
...
<center>Figure 7.14 Formation of bright and dark fringes </center>
...
<center>Figure 7.15 Interference fringe pattern </center>
...
(i) The distance \(D\) between the screen and double slit should be as large as possible. (ii) The wavelength \(\lambda\) of light used must be as long as possible. (iii) The distance \(d\) between the two slits must be as small as possible.
...
An important example of interference effects in light is the beautiful colours seen in thin films of oil on water, soap bubbles etc. When a thin film is illuminated by white light, the interference of light waves reflected from the top and bottom surfaces of the film gives rise to coloured bands. The effect depends on the thickness of the film and the angle of incidence.
...
<center>Figure 7.16 Interference in thin films </center>
...
One of the rays obeys the laws of refraction (i.e. $\frac{\sin i}{\sin r} = \text{constant}$). This ray is called ordinary ray (O-ray). The second ray does not obey the laws of refraction (i.e. $\frac{\sin i}{\sin r}$ is not a constant). This ray is called extraordinary ray (E-ray). The O-ray travels with same velocity in all directions inside the crystal. But the E-ray travels with different velocities along different directions inside the crystal. The O-ray and E-ray are found to be plane polarised with their vibrations perpendicular to each other.

<center>Figure 7.33 Double refraction </center>

#### 7.5.6 Polarisation by scattering
...
A simple microscope is a single convex lens (or) a combination of convex lenses which produces magnified virtual image of an object. It is also called magnifying glass (or) simply a magnifier. It is used to see very small objects. Figure 7.34(a) shows the object within the focal length of a convex lens forming a virtual, erect and magnified image at the near point (point of distinct vision). Figure 7.34(b) shows the object within the focal length of a convex lens forming a virtual, erect and magnified image at infinity. The object is kept at the focus of the convex lens.

<center>Figure 7.34 Simple microscope </center>

The magnification of a simple microscope is given by,

(i) If the image is formed at the near point (25 cm for a normal eye), the magnification $m$ is,

\[m = 1 + \frac{D}{f} \quad (7.59)\]

where, $D$ is the distance of distinct vision ($D = 25 \text{cm}$) and $f$ is the focal length of the convex lens used.

(ii) If the image is formed at infinity, the magnification $m$ is,

\[m = \frac{D}{f} \quad (7.60)\]

## EXAMPLE 7.19

If the focal length of a simple microscope is 5 cm, what is its magnifying power when the image is formed at (a) the near point (b) infinity?

## Solution

$f = 5 \text{cm}$, $D = 25 \text{cm}$

(a) At near point, $m = 1 + \frac{D}{f} = 1 + \frac{25}{5} = 1 + 5 = 6$

(b) At infinity, $m = \frac{D}{f} = \frac{25}{5} = 5$

#### 7.6.2 Compound microscope

When very high magnification is desired, a compound microscope is used. It consists of two convex lenses – an objective lens $O$ of very short focal length and short aperture and an eyepiece $E$ of moderate focal length and short aperture. Both the lenses are placed coaxially. The objective is of very small focal length where as the eyepiece is of comparatively larger focal length. The distance between the two lenses is adjustable.

## Working

The object to be viewed is placed between $f$ and $2f$ of the objective. A real, inverted and magnified image is formed at the other focus of the objective as shown in Figure 7.35. This image acts as an object for the eyepiece which is adjusted to be within its focal length. The eyepiece then forms a virtual, erect and magnified image (of the image formed by the objective) at the near point (or) infinity. The final image is inverted with respect to the object. When the image is at the near point, the magnification $m$ of the compound microscope is,

\[m = \frac{L}{f_0} \left( 1 + \frac{D}{f_e} \right) \quad (7.61)\]

When the image is at infinity,

\[m = \frac{L}{f_0} \times \frac{D}{f_e} \quad (7.62)\]

where, $L$ is the tube length (the distance between the objective and the eyepiece), $f_0$ is the focal length of the objective, $f_e$ is the focal length of the eyepiece and $D$ is the distance of distinct vision.

<center>Figure 7.35 Compound microscope </center>

## EXAMPLE 7.20

What is the magnification of a compound microscope? The objective and eyepiece have focal lengths of 2 cm and 5 cm respectively. The object is placed at a distance of 2.5 cm from the objective and the final image is formed at the near point.

## Solution

$f_0 = 2 \text{cm}$, $f_e = 5 \text{cm}$, $u_0 = 2.5 \text{cm}$, $D = 25 \text{cm}$

Lens formula for objective, $\frac{1}{v_0} - \frac{1}{u_0} = \frac{1}{f_0}$

Substituting, $\frac{1}{v_0} - \frac{1}{(-2.5)} = \frac{1}{2}$

$\frac{1}{v_0} + \frac{1}{2.5} = \frac{1}{2}$

$\frac{1}{v_0} = \frac{1}{2} - \frac{1}{2.5} = \frac{2.5 - 2}{5} = \frac{0.5}{5} = \frac{1}{10}$

$v_0 = 10 \text{cm}$

Magnification, $m = \frac{v_0}{u_0} \left( 1 + \frac{D}{f_e} \right) = \frac{10}{2.5} \left( 1 + \frac{25}{5} \right)$

$m = 4 \times (1 + 5) = 24$

#### 7.6.3 Astronomical telescope

It is used to observe the distant astronomical objects like stars, planets etc. The telescope uses two lenses – an objective and an eyepiece. The objective has a large aperture and a large focal length. The eyepiece has a small aperture and a small focal length. Both the lenses are placed coaxially. The distance between the two lenses is adjustable.

## Working

A parallel beam of light from a distant object falls on the objective. The objective forms a real, inverted and diminished image $A'B'$ at its focal plane. This image acts as an object for the eyepiece. The eyepiece is adjusted so that the image $A'B'$ lies within its focal length. The eyepiece forms a virtual, erect and magnified image (of the image formed by the objective) at the near point (or) infinity. The final image is inverted with respect to the object. When the image is at infinity, the magnification $m$ of the astronomical telescope is,

\[m = -\frac{f_0}{f_e} \quad (7.63)\]

When the image is at the near point, the magnification $m$ is,

\[m = -\frac{f_0}{f_e} \left( 1 + \frac{f_e}{D} \right) \quad (7.64)\]

where, $f_0$ is the focal length of the objective, $f_e$ is the focal length of the eyepiece and $D$ is the distance of distinct vision.

<center>Figure 7.36 Astronomical telescope </center>

#### 7.6.4 Terrestrial telescope

The astronomical telescope produces inverted images. For viewing objects on the earth, an erect image is needed. For this purpose, a terrestrial telescope uses an additional convex lens of focal length $f$ called erecting lens. The erecting lens is placed between the objective and the eyepiece at a distance $2f$ from both the lenses. This lens erects the inverted image formed by the objective, without additional magnification.
...
A spectrometer is an optical instrument used to study the spectra of different sources of light. It is also used to determine the wavelength of light. It consists of three main parts:

1.  **Collimator**: It produces a parallel beam of light. It consists of a convex lens and an adjustable slit at its focus.
2.  **Prism table**: It holds the prism or grating. It can be rotated and its position can be read using a vernier scale.
3.  **Telescope**: It is used to observe the parallel beam after it emerges from the prism or grating. It can be rotated and its position can be read using a vernier scale.

The spectrometer is first adjusted for parallel rays. The prism is placed on the prism table. The angle of the prism $A$ is determined. The prism is then rotated to obtain the minimum deviation position. The angle of minimum deviation $D_m$ is measured. The refractive index $\mu$ of the prism material is given by,

\[\mu = \frac{\sin \left( \frac{A + D_m}{2} \right)}{\sin \left( \frac{A}{2} \right)} \quad (7.67)\]

## SUMMARY

- Light is a form of energy. It has dual nature – wave and particle.
- Huygens' principle explains the propagation of wavefronts. Each point on a wavefront acts as a source of secondary wavelets.
- Laws of reflection and refraction can be proved using Huygens' principle.
- Interference is the superposition of two light waves. Constructive interference occurs when the path difference is $n\lambda$ and destructive interference occurs when the path difference is $(2n-1)\frac{\lambda}{2}$.
- Young's double slit experiment demonstrates interference. Fringe width $\beta = \frac{\lambda D}{d}$.
- Diffraction is the bending of light around edges. In single slit diffraction, minima occur when $a \sin \theta = n\lambda$ and maxima occur when $a \sin \theta = (2n+1)\frac{\lambda}{2}$.
- A diffraction grating has many slits. Maxima occur when $(a+b) \sin \theta = m\lambda$.
- Polarisation proves the transverse nature of light. Malus' law states $I = I_0 \cos^2 \theta$. Brewster's law states $\tan i_p = n$.
- Optical instruments like microscope, telescope and spectrometer are used to see objects and analyse light.

## EVALUATION

### Multiple Choice Questions

1.  The corpuscular theory could not explain:
    (a) reflection (b) refraction (c) interference (d) rectilinear propagation
2.  Which theory could explain the photoelectric effect?
    (a) Wave theory (b) Corpuscular theory (c) Electromagnetic theory (d) Quantum theory
3.  According to Huygens' principle,
    (a) light is a wave (b) light is a particle (c) light has dual nature (d) light travels in straight line
4.  The wavefront from a point source at finite distance is:
    (a) plane (b) spherical (c) cylindrical (d) elliptical
5.  For constructive interference, the path difference should be:
    (a) $n\lambda$ (b) $(2n-1)\frac{\lambda}{2}$ (c) $\frac{\lambda}{2}$ (d) $\frac{3\lambda}{2}$
6.  In Young's double slit experiment, the fringe width is given by:
    (a) $\frac{\lambda d}{D}$ (b) $\frac{\lambda D}{d}$ (c) $\frac{dD}{\lambda}$ (d) $\frac{\lambda}{dD}$
7.  The condition for first minimum in single slit diffraction is:
    (a) $a \sin \theta = \lambda$ (b) $a \sin \theta = \frac{\lambda}{2}$ (c) $a \sin \theta = 2\lambda$ (d) $a \sin \theta = \frac{3\lambda}{2}$
8.  The phenomenon of polarisation proves that light is:
    (a) longitudinal wave (b) transverse wave (c) stationary wave (d) mechanical wave
9.  Brewster's law is given by:
    (a) $\sin i_p = n$ (b) $\cos i_p = n$ (c) $\tan i_p = n$ (d) $\cot i_p = n$
10. The resolving power of a telescope is:
    (a) $\frac{1.22\lambda}{a}$ (b) $\frac{a}{1.22\lambda}$ (c) $\frac{2\mu \sin \theta}{\lambda}$ (d) $\frac{\lambda}{2\mu \sin \theta}$
...
7.  State the condition for first minimum in single slit diffraction.
...
1.  Explain the wave theory of light.
2.  Prove the laws of reflection using Huygens' principle.
3.  Derive the expression for fringe width in Young's double slit experiment.
4.  Explain the formation of interference fringes in thin films.
5.  Obtain the condition for diffraction minima in single slit.
6.  Distinguish between interference and diffraction.
7.  Explain polarisation by selective absorption.
8.  Derive Malus' law.
9.  Describe the working of a compound microscope.
10. Explain the resolving power of a telescope.

### Long Answer Questions

1.  Describe the various theories of light.
2.  Explain Huygens' principle and prove the laws of refraction.
3.  Derive the conditions for constructive and destructive interference. Explain Young's double slit experiment.
4.  Explain the phenomenon of diffraction in single slit. Derive the condition for minima and maxima.
5.  What is a diffraction grating? Derive the grating equation.
6.  Explain polarisation by reflection and state Brewster's law.
7.  Describe the construction and working of a compound microscope. Derive an expression for its magnifying power.
8.  Describe the construction and working of an astronomical telescope.
9.  Explain Rayleigh's criterion for resolution. Derive the expression for resolving power of a telescope and a microscope.
10. Describe the spectrometer and explain how the refractive index of a prism is determined.

A plane wavefront undergoes diffraction in Fraunhofer diffraction. In single slit diffraction, condition for \(n^{\mathrm{th}}\) minimum is, \(a\sin \theta = n\lambda\) Condition for \(n^{\mathrm{th}}\) maximum is, \(a\sin \theta = (2n + 1)\frac{\lambda}{2}\) The Fresnel's distance is, \(z = \frac{a^{2}}{2\lambda}\) A grating is a plane sheet of transparent material on which opaque rulings are made. Grating element \(e = a + b\) . The condition for \(m^{\mathrm{th}}\) maximum in grating experiment is, \((a + b)\sin \theta = m\lambda\) The Rayleigh's criterion states that the two points on an image are said to be just resolved when the central maximum of one diffraction pattern coincides with the first minimum of the other and vice- versa. The resolving power of an optical instrument is its ability to distinguish two closely adjacent objects (or) two points on the same object. For a telescope, resolving power \(R = \frac{a}{1.22\lambda}\) For a microscope, resolving power \(R = \frac{2\mu\sin \beta}{1.22\lambda}\) The phenomenon of restricting the vibrations of light (electric or magnetic field vectors) to any one direction perpendicular to the direction of propagation of wave is called polarisation of light. The light with vibrations only in one direction is called plane polarised light. Malus' law is, \(I = I_{0}\cos^{2}\theta\) Brewster's law is, \(\tan i_{p} = n\) The phenomenon of double refraction is exhibited by optically active crystals like calcite. In double refraction the ordinary ray obeys laws of refraction and extraordinary ray does not. Nicol prism makes use of double refraction to produce and analyse plane polarised light. A simple microscope is a single magnifying lens. For near point focusing, \(m = 1 + \frac{D}{f}\) For normal focusing, \(m = \frac{D}{f}\) A compound microscope uses two convex lenses. For near point focusing, \(m = \left(\frac{L}{f_{o}}\right)\left[1 + \frac{D}{f_{e}}\right]\) For normal focusing, \(m = \left(\frac{L}{f_{o}}\right)\left(\frac{D}{f_{e}}\right)\) An astronomical telescope uses two convex lenses. Its magnification is, \(m = \frac{f_{o}}{f_{e}}\) A terrestrial telescope uses an erecting lens. A reflecting telescope uses a concave mirror objective. A spectrometer is used to analyse the spectra of light. The refractive index of a prism is, \(n = \frac{\sin\left(\frac{A + D}{2}\right)}{\sin\left(\frac{A}{2}\right)}\) The maximum focal length of a normal eye is \(2.5\mathrm{~cm}\) . The minimum focal length of a normal eye is \(2.27\mathrm{~cm}\) . The defects of vision are myopia (nearsightedness) corrected with a concave lens, hypermetropia (farsightedness) corrected with a convex lens and astigmatism corrected with cylindrical lenses.

### Evaluation

#### Multiple choice questions

1.  The wave nature of light is verified by
    (a) photoelectric effect (b) Compton effect (c) interference (d) atomic spectra
2.  According to Huygens' principle, each point on a wavefront acts as
    (a) a source of light (b) a source of secondary wavelets (c) a source of sound (d) a source of energy
3.  The wavefront from a source at infinity is
    (a) spherical (b) cylindrical (c) plane (d) circular
4.  The path difference for destructive interference is
    (a) \(n\lambda\) (b) \((2n - 1)\frac{\lambda}{2}\) (c) \(\frac{\lambda}{2}\) (d) \(\frac{3\lambda}{2}\)
5.  In Young's double slit experiment, the central fringe is
    (a) dark (b) bright (c) coloured (d) invisible
6.  The fringe width in Young's double slit experiment depends on
    (a) \(\frac{D}{d}\) (b) \(\frac{d}{D}\) (c) \(\frac{\lambda D}{d}\) (d) \(\frac{\lambda d}{D}\)
7.  The condition for first minimum in single slit diffraction is
    (a) \(a\sin \theta = \frac{\lambda}{2}\) (b) \(a\sin \theta = \lambda\) (c) \(a\sin \theta = 2\lambda\) (d) \(a\sin \theta = \frac{3\lambda}{2}\)
8.  The central maximum in single slit diffraction is
    (a) half the width of other maxima (b) equal to the width of other maxima (c) double the width of other maxima (d) three times the width of other maxima
9.  The grating element is
    (a) \(a - b\) (b) \(a + b\) (c) \(a/b\) (d) \(b/a\)
10. The condition for maximum in grating is
    (a) \((a + b)\sin \theta = m\lambda\) (b) \((a - b)\sin \theta = m\lambda\) (c) \(a\sin \theta = m\lambda\) (d) \(b\sin \theta = m\lambda\)
11. The resolving power of a telescope is
    (a) \(\frac{a}{1.22\lambda}\) (b) \(\frac{1.22\lambda}{a}\) (c) \(\frac{2\mu\sin \beta}{1.22\lambda}\) (d) \(\frac{1.22\lambda}{2\mu\sin \beta}\)
12. The resolving power of a microscope is
    (a) \(\frac{a}{1.22\lambda}\) (b) \(\frac{1.22\lambda}{a}\) (c) \(\frac{2\mu\sin \beta}{1.22\lambda}\) (d) \(\frac{1.22\lambda}{2\mu\sin \beta}\)
13. The phenomenon of polarisation proves that light is
    (a) longitudinal wave (b) transverse wave (c) mechanical wave (d) stationary wave
14. Malus' law is
    (a) \(I = I_{0}\cos \theta\) (b) \(I = I_{0}\cos^{2} \theta\) (c) \(I = I_{0}\sin \theta\) (d) \(I = I_{0}\sin^{2} \theta\)
15. Brewster's law is
    (a) \(\tan i_{p} = n\) (b) \(\sin i_{p} = n\) (c) \(\cos i_{p} = n\) (d) \(\cot i_{p} = n\)
16. The polarising angle for a medium of refractive index \(1.5\) is
    (a) \(30^{\circ}\) (b) \(45^{\circ}\) (c) \(56.3^{\circ}\) (d) \(60^{\circ}\)
17. In double refraction, the ordinary ray
    (a) obeys laws of refraction (b) does not obey laws of refraction (c) travels with different velocities (d) is plane polarised
18. The magnification of a simple microscope for normal focusing is
    (a) \(1 + \frac{D}{f}\) (b) \(\frac{D}{f}\) (c) \(\frac{f}{D}\) (d) \(1 - \frac{D}{f}\)
19. The magnification of a compound microscope for normal focusing is
    (a) \(\left(\frac{L}{f_{o}}\right)\left(1 + \frac{D}{f_{e}}\right)\) (b) \(\left(\frac{L}{f_{o}}\right)\left(\frac{D}{f_{e}}\right)\) (c) \(\left(\frac{f_{o}}{f_{e}}\right)\) (d) \(\left(\frac{f_{e}}{f_{o}}\right)\)
20. The magnification of an astronomical telescope is
    (a) \(\frac{f_{o}}{f_{e}}\) (b) \(\frac{f_{e}}{f_{o}}\) (c) \(\frac{L}{f_{o}}\) (d) \(\frac{L}{f_{e}}\)
...
12. What is the difference between ordinary ray and extraordinary ray?
13. What is the magnification of a simple microscope for near point focusing?
14. What is the magnification of a compound microscope for normal focusing?
15. Write the formula for the magnification of an astronomical telescope.
16. What is myopia?
17. What is hypermetropia?
18. What is astigmatism?
19. Write the formula for the refractive index of a prism.
20. What is the resolving power of an optical instrument?
...
9.  Describe the working of a compound microscope.
10. Explain the resolving power of a telescope.
11. Describe the working of an astronomical telescope.
12. Explain the construction and working of a spectrometer.
13. How will you determine the refractive index of a prism using a spectrometer?
14. Explain the defects of vision and their correction.
15. Explain polarisation by reflection and state Brewster's law.
...
1.  The wavelength of light from a sodium source in vacuum is \(5893\ \text{Å}\). What are its (a) wavelength, (b) speed and (c) frequency when this light travels in water which has a refractive index of \(1.33\)?
    **Ans:** (a) \(4431\ \text{Å}\), (b) \(2.256 \times 10^8\ \text{ms}^{-1}\), (c) \(5.091 \times 10^{14}\ \text{Hz}\)

2.  Two light sources with amplitudes \(5\) units and \(3\) units respectively interfere with each other. Calculate the ratio of maximum and minimum intensities.
    **Ans:** \(16:1\)

3.  Two light sources of equal amplitudes interfere with each other. Calculate the ratio of maximum and minimum intensities.
    **Ans:** \(4a^2:0\) (i.e., \(I_{\text{min}} = 0\))

4.  Two light sources have intensity of light as \(I_0\). What is the resultant intensity at a point where the two light waves have a phase difference of \(\pi/3\)?
    **Ans:** \(3I_0\)

5.  The wavelength of a light is \(450\ \text{nm}\). How much phase it will differ for a path of \(3\ \text{mm}\)?
    **Ans:** \(4.19 \times 10^4\ \text{rad}\)

6.  In Young's double slit experiment, the two slits are \(0.15\ \text{mm}\) apart. The light source has a wavelength of \(450\ \text{nm}\). The screen is \(2\ \text{m}\) away from the slits.
    (a) Find the distance of the second bright fringe and also third dark fringe from the central maximum.
    (b) Find the fringe width.
    (c) How will the fringe pattern change if the screen is moved away from the slits?
    (d) What will happen to the fringe width if the whole setup is immersed in water of refractive index \(4/3\)?
    **Ans:** (a) \(12\ \text{mm}\), \(15\ \text{mm}\) (b) \(6\ \text{mm}\) (c) increases (d) \(4.5\ \text{mm}\)

7.  Lights of two wavelengths \(560\ \text{nm}\) and \(420\ \text{nm}\) are used in Young's double slit experiment. Find the least distance from the central fringe where the bright fringes of the two wavelengths coincide. Given \(D = 1\ \text{m}\) and \(d = 3\ \text{mm}\).
    **Ans:** \(0.560\ \text{mm}\)

8.  Find the minimum thickness of a film of refractive index \(1.25\), which will strongly reflect the light of wavelength \(589\ \text{nm}\). Also find the minimum thickness of the film to be anti-reflecting.
    **Ans:** \(117.8\ \text{nm}\), \(235.6\ \text{nm}\)

9.  Light of wavelength \(500\ \text{nm}\) passes through a slit of \(0.2\ \text{mm}\) wide. The diffraction pattern is formed on a screen \(60\ \text{cm}\) away. Determine the,
    (a) angular spread of central maximum
    (b) the distance between the central maximum and the second minimum.
    **Ans:** (a) \(0.0025\ \text{rad}\) (b) \(1.5\ \text{mm}\)

10. A monochromatic light of wavelength \(5000\ \text{Å}\) passes through a single slit producing diffraction pattern for the central maximum as shown in the figure. Determine the width of the slit. (Figure shows first minimum at \(30^\circ\))
    **Ans:** \(10^{-6}\ \text{m}\)

11. Calculate the distance upto which ray optics is a good approximation for light of wavelength \(500\ \text{nm}\) falls on an aperture of width \(0.5\ \text{mm}\)
    **Ans:** \(0.25\ \text{m}\)

12. A diffraction grating consists of \(4000\) slits per centimetre. It is illuminated by a monochromatic light. The second order diffraction maximum is produced at an angle of \(30^\circ\). What is the wavelength of the light used?
    **Ans:** \(6250\ \text{Å}\)

13. A monochromatic light of wavelength of \(500\ \text{nm}\) strikes a grating and produces fourth order maximum at an angle of \(30^\circ\). Find the number of slits per centimetre.
    **Ans:** \(2500\ \text{cm}^{-1}\)

14. The optical telescope in the Vainu Bappu observatory at Kavalur has an objective lens of diameter \(2.3\ \text{m}\). What is its angular resolution if the wavelength of light used is \(589\ \text{nm}\)?
    **Ans:** \(3.124 \times 10^{-7}\ \text{rad}\)

15. Two polaroids are kept with their transmission axes inclined at \(30^\circ\). Unpolarised light of intensity \(I\) falls on the first polaroid. Find out the intensity of light emerging from the second polaroid.
    **Ans:** \(\frac{3}{8}I\)

16. Two polaroids are kept crossed (transmission axes at \(90^\circ\)) to each other.
...
17. Find the polarizing angles for (i) glass of refractive index \(1.5\) and (ii) water of refractive index \(1.33\).
    **Ans:** (i) \(56.3^\circ\) (ii) \(53.1^\circ\)

18. What is the angle at which a glass plate of refractive index \(1.65\) is to be kept with respect to the horizontal surface so that an unpolarised light travelling horizontal after reflection from the glass plate is found to be plane polarised?
    **Ans:** \(31.2^\circ\)

19. If the focal length of a simple microscope is \(5\ \text{cm}\), what is its magnifying power when the image is formed at (a) the near point (b) infinity?
    **Ans:** (a) \(6\) (b) \(5\)

20. What is the magnification of a compound microscope? The objective and eyepiece have focal lengths of \(2\ \text{cm}\) and \(5\ \text{cm}\) respectively. The object is placed at a distance of \(2.5\ \text{cm}\) from the objective and the final image is formed at the near point.
    **Ans:** \(24\)

21. A microscope has an objective and eyepiece of focal lengths \(5\ \text{cm}\) and \(50\ \text{cm}\) respectively with tube length \(30\ \text{cm}\). Find the magnification of the microscope in the (a) near point and (b) normal focusing.
    **Ans:** (a) \(9\) (b) \(3\)

22. A small telescope has an objective lens of focal length \(125\ \text{cm}\) and an eyepiece of focal length \(2\ \text{cm}\). (a) What is the magnification of the telescope? (b) What is the separation between the objective and the eyepiece? (c) What is the angular separation between two stars when viewed through this telescope if they subtend \(1'\) for bare eye?
    **Ans:** (a) \(62.5\) (b) \(1.27\ \text{m}\) (c) \(1^\circ 2' 30''\)

23. Calculate the power of the lens of the spectacles needed to rectify the defect of nearsightedness for a person who could see clearly up to a distance of \(1.8\ \text{m}\).
    **Ans:** \(-0.56\ \text{D}\)

24. A person has farsightedness with the far distance he could see clearly is \(75\ \text{cm}\). Calculate the power of the lens of the spectacles needed to rectify the defect.
    **Ans:** \(2.67\ \text{D}\)

### Activity

1.  Observe the beautiful colours in a soap bubble and a thin film of oil floating on the surface of water. Bring a polaroid near the soap bubble and observe the changes.
2.  Take a compact disc (CD) and observe the colours in it. Rotate the CD and watch the colours change. The CD acts as a diffraction grating.
3.  Take an old oil painting and observe it through a polaroid. Rotate the polaroid and observe the change in contrast.
4.  Visit a nearby optical shop. Observe the different types of spectacle lenses – concave, convex, bifocal and progressive lenses.

### ICT Corner

**Wave Optics**

**Step 1:** Use the link or scan the QR code to open the simulation.

**Step 2:** Select "Young's Double Slit Experiment" from the list of simulations.

**Step 3:** Adjust the slit width, slit separation, and wavelength of light using the sliders.

**Step 4:** Observe the interference pattern on the screen. Note the changes in fringe width and intensity.

**Step 5:** Select "Single Slit Diffraction" and observe the diffraction pattern.

**Step 6:** Select "Diffraction Grating" and observe the spectrum formed.

**Step 7:** Select "Polarisation" and observe the effect of rotating the analyser.

**URL:** https://phet.colorado.edu/en/simulations/wave-interference

**QR Code:** [Image placeholder]

A plane wavefront undergoes diffraction in Fraunhofer diffraction. The equation for \(\mathrm{n}^{\mathrm{th}}\) minimum in single slit diffraction is, \(a\sin \theta = n\lambda\) (\(n^{\mathrm{th}}\) minimum) The equation for \(\mathrm{n}^{\mathrm{th}}\) maximum in single slit diffraction is, \(a\sin \theta = (2n + 1)\frac{\lambda}{2}\) (\(n^{\mathrm{th}}\) maximum) Fresnel's distance is the distance upto which ray optics is obeyed and beyond which ray optics is not obeyed but, wave optics becomes significant. \(z = \frac{a^2}{2\lambda}\) Diffraction can also happen in grating which has multiple slits of thickness comparable to wavelength of light used. \((a + b)\sin \theta = m\lambda ;\sin \theta = Nm\lambda\) Wavelength of monochromatic light and also different colours of polychromatic light can be determined using diffraction grating and spectrometer. According to Rayleigh's criterion, for two point objects to be just resolved, the minimum distance between their diffraction images must be in such a way that the central maximum of one coincides with the first minimum of the other and vice versa. Angular resolution, \(\theta = \frac{1.22\lambda}{a}\) Spatial resolution, \(r_0 = \frac{1.22\lambda f}{a}\) Resolution is measured by the smallest distance which could be seen clearly without the blur due to diffraction. The phenomenon of restricting the vibrations of light (electric or magnetic field vector) to a particular direction perpendicular to the direction of propagation of wave is called polarization of light. If the vibrations of a wave are present in only one direction in a plane perpendicular to the direction of propagation of wave, the light is said to be polarised or plane polarised light. The plane containing the vibrations of the electric field vector is known as the plane of vibration. The plane perpendicular to the plane of vibration and containing the ray of light is known as the plane of polarisation. In plane polarised light the intensity varies from maximum to zero for every rotation of \(90^{\circ}\) of the analyser. In partially polarised light the intensity varies from maximum to minimum for every rotation of \(90^{\circ}\) of the analyser. The intensity of transmitted light through two cross polaroids is given by Malus' Law. \(I = I_0\cos^2\theta\) Nicol prism separates ordinary and extraordinary rays by double refraction. Light scattered by molecules at perpendicular direction to the incident light is found to be plane polarised.

A single convex lens can act as a simple microscope when object is within the focal length. In near point focusing, the image is formed at \(D = 25\mathrm{cm}\). The magnification in near point focusing is, \(m = 1 + \frac{D}{f}\) In normal focusing, the image is formed at infinity, the magnification in normal focusing is, \(m = \frac{D}{f}\) The resolving power of microscope is, \(R_{\mathrm{M}} = \frac{1}{d_{\mathrm{min}}} = \frac{2(NA)}{1.22\lambda}\) The resolving power of telescope is, \(R_{\mathrm{T}} = \frac{1}{r_0} = \frac{a}{1.22\lambda f}\) Magnification in near point focusing in compound microscope is, \(m = m_{o}m_{e} = \left(\frac{L}{f_{o}}\right)\left[1 + \frac{D}{f_{e}}\right]\) Magnification in normal focusing in compound microscope is, \(m = m_{o}m_{e} = \left(\frac{L}{f_{o}}\right)\left(\frac{D}{f_{e}}\right)\) Magnification in astronomical telescope is, \(m = \frac{f_{o}}{f_{e}}\) and the tube length is, \(L = f_{o} + f_{e}\) The correction lens for nearsightedness/myopic eye should be a concave lens with focal length, \(f = - x\). Where \(x\) is the maximum distance upto which an object can be seen. The correction lens for farsightedness/hypermetropic eye should be a convex lens with focal length, \(f = \frac{y\times 25\mathrm{cm}}{y - 25\mathrm{cm}}\). Where, the \(25\mathrm{cm}\) is the near distance and \(y\) is the minimum distance upto which an object can be seen. The farsightedness arising due to aging is called presbyopia. Astigmatism is the defect arising due to different curvatures along different planes in the eye lens.
...
2.  Two point white dots are 1 mm apart on a black paper. They are viewed by eye of pupil diameter \(3\mathrm{mm}\) approximately. The maximum distance at which these dots can be resolved by the eye is, [take wavelength of light, \(\lambda = 500\mathrm{nm}\)]
...
7.  Discuss the diffraction at single slit and obtain the condition for \(\mathrm{n}^{\mathrm{th}}\) minimum.
...
2.  In Young's double slit experiment, 62 fringes are seen on a screen for sodium light of wavelength 5893 Å. If violet light of wavelength 4359 Å is used in place of sodium light, what is the number of fringes seen?
    [Ans: 84]
...
4.  A beam of light of wavelength 600 nm from a distant source falls on a single slit \(1\mathrm{mm}\) wide and the resulting diffraction pattern is observed on a screen \(2\mathrm{m}\) away. What is the distance between the first dark fringes on either side of the central bright fringe?
    [Ans: \(2.4\mathrm{mm}\)]

5.  Light of wavelength of \(5000\mathrm{\AA}\) produces diffraction pattern of the single slit of width \(2.5\mu \mathrm{m}\). What is the maximum order of diffraction possible?
    [Ans: 5]

6.  \(I_{0}\) is the intensity of light existing between two cross Polaroids kept with their axes perpendicular to each other. A third polaroid is introduced between them. What must be the angle between the axes of first and the newly introduced polaroid to get the maximum light from the whole arrangement?
    [Ans: \(45^{\circ}\)]
...
1.  Frances A. Jenkins and Harvey E. White, Fundamentals of Optics, 4<sup>th</sup> Edition, McGraw Hill Book Company, (2011).
2.  David Halliday, Robert Resnick and Jearl Walker, Fundamentals of Physics, 6<sup>th</sup> Edition, John Wiley & Sons Inc., (2004).
3.  H.C. Verma, Concepts of Physics [Part-1], 1<sup>st</sup> Edition, Bharathi Bhawan Publishers & Distributors Pvt. Ltd., (2008).
4.  Roger A. Freedman, Hugh D. Young, Sears and Zemansky's University Physics, 12<sup>th</sup> Edition, Pearson, (2011).
