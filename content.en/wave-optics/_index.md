...
Focal length _f_ of the correcting lens is,
...
The focal length calculated using above formula will be positive as _y_ is always
...
greater than 25 cm. The positive sign of the focal length suggests that the correcting lens should be a convex lens. In principle, the convex lens slightly converges the rays coming from an object beyond _y_ and makes them fall at the retina.

**7.6.6.3 Astigmatism** Astigmatism is the defect arising due to
...
**_Solution_** The minimum distance the person could see clearly is, _y_ = 75 cm.
...
„ Light has wave as well as particle nature. „ A _wavefront_ is the locus of points which

Huygen’s principle states the method of p „ Light propagating as a wavefront. Point

source at infinity produces plane wavefro „ Laws of reflection and refraction are prov „ The phenomenon of addition or superpo

increase in intensity at some points and d called _interference_ of light.

„ If _I_1 and _I_2 are the intensities of interferin
...
„ If interfering lights have equal intensities
...
_I I_max = 4 0 when, _f p p_\= ±0 2 4, , ...,

_I_min = 0 when, _f p p p_\=± ± ±, , ...,3 5 „ Two light sources are said to be coheren

phase or constant phase difference, same same waveform and preferably same amp

„ Coherent sources are obtained by wavefro virtual images of light source.

„ Young’s double slit uses wavefront divisio

„ In Young’s double slit experiment, the po

„ In Young’s double slit experiment, the po

„ In Young’s double slit experiment, the equ

„ Interference with polychromatic (white) li „ Thin films appear coloured due to interfe

„ In thins films the equations for constructi

rays are, 2 2 1 2

_m ld n_\= −( ) ; 2_µd_ = _nλ_ respec

„ Transmitted light are, 2_µd_ = _nλ;_ 2 2_md n_\= (

„ _Diffraction is bending of waves around sh_ region.

„ A spherical wave front undergoes diffract

**SUMMARY**  

are in the same state or phase of vibration. ropagation of wavefront. source produces spherical wavefront and nt. ed by Huygens’ principle. sition of two light waves which produces ecrease in intensity at some other points is

g light, then

_I_2

of I0 with phase difference ϕ, then

t if they produce waves which have same frequency or wavelength monochromatic), litude. nt division, intensity division and real and

n to obtain coherent sources.

sition of _n_th bright fringe is, _y n D d_

_y n D dn_\= =

_l l_( )or

sition of _n_th dark fringe is, _y n D d_
...
ation for bandwidth is, _b l_ \=

_D d_

ght produces coloured interference fringes. rence of white light.

ve and destructive interference for reflected
...
arp edges into the geometrically shadowed

ion in Fresnel diffraction.
  

„ A plane wavefront undergoes diffraction „ The equation for nth minimum in single sl

„ The equation for nth maximum in sing maximum)

„ Fresnel’s distance is the distance upto wh

ray optics is not obeyed but, wave optics

„ Diffraction can also happen in grating whi to wavelength of light used. (_a_ \+ _b_) sin_θ_ =1

_N m_sin_q l_\=

„ Wavelength of monochromatic light and a can be determined. Using diffraction grat

„ According to _Rayleigh’s criterion_, for tw minimum distance between their diffrac central maximum of one coincides with versa

„ Angular resolution, _q l_ \=

1 22. _a_

„ Special resolution, _r f a_0

1 22 =

. _l_

„ Resolution is measured by the smallest di „ the blur due to diffraction. „ The phenomenon of restricting the vibr

vector) to a particular direction perpen wave is called _polarization_ of light.

„ If the vibrations of a wave are present in o to the direction of propagation of wave is

„ The plane containing the vibrations of th _of vibration_.

„ The plane perpendicular to the plane of known as the _plane of polarisation_.

„ In _plane polarised_ light the intensity varie of 90° of the analyser.

„ In _partially polarised_ light the intensity va rotation of 90° of the analyser.

„ The intensity of transmitted light through _I_ = _I_0 cos2 _θ_

„ Nicol prism separates ordinary and extra „ Light scattered by molecules at perpendic

to be plane polarised.  

in Fraunhofer diffraction. it diffraction is, a sin θ = nλ (nth minimum)

le slit diffraction is, a _n_sin ( )_q l_ \= +2 1

2 (_n_th

ich ray optics is obeyed and beyond which

becomes significant. z _a_ \=

2

2_l_ ch has multiple slits of thickness comparable _m λ; N m_( ) sin_q l_\=or lso different colours of polychromatic light ing and spectrometer. o point objects to be just resolved, the

tion images must be in such a way that the the first minimum of the other and vice

stance which could be seen clearly without

ations of light (electric or magnetic field dicular to the direction of propagation of

nly one direction in a plane perpendicular said to be _polarised_ or _plane polarised light_. e electric field vector is known as the plane

vibration and containing the ray of light is

s from maximum to zero for every rotation

ries from maximum to minimum for every

two cross polaroids is given by Malus’ Law.

ordinary rays by double refraction. ular direction to the incident light is found
