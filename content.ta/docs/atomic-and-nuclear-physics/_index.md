...
**குறிப்பு:** ஒரேயொரு தேக்கரண்டி அளவு அணுக்கருவின் பருப்பொருளின் நிறையானது கிட்டத்தட்ட டிரில்லியன் டன்களுக்குச் சமமாகும்.
...
$$\frac{K.E_{\alpha}}{K.E_{Th}} = \frac{\frac{1}{2} m_{\alpha} v_{\alpha}^2}{\frac{1}{2} m_{Th} v_{Th}^2} = \frac{m_{\alpha}}{m_{Th}} \times \left( \frac{v_{\alpha}}{v_{Th}} \right)^2$$
மேலேயுள்ள சமன்பாட்டில் $v_{\alpha}$ ஐப் பிரதியிட,
$$\frac{K.E_{\alpha}}{K.E_{Th}} = \frac{m_{\alpha}}{m_{Th}} \times \left( \frac{m_{Th}}{m_{\alpha}} \right)^2 = \frac{m_{Th}}{m_{\alpha}} = \frac{228.02871}{4.002603} = 57$$
...
$$57 K.E_{Th} + K.E_{Th} = 5.41 \text{ MeV}$$
$$K.E_{Th} = \frac{5.41}{58} \text{ MeV} = 0.093 \text{ MeV}$$
$$K.E_{\alpha} = 57 KE_{Th} = 57 \times 0.093 = 5.301 \text{ MeV}$$
...
எடுத்துக்காட்டு: சோடியம் ($_{11}^{22}\text{Na}$) சிதைவின் மூலம் நியானாக  $$(_{10}^{22}\text{Ne})$$, மாறுகிறது.
