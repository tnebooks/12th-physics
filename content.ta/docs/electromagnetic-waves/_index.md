...
$$
\oint_l \vec{E} \cdot d\vec{l} = -\frac{d\Phi_B}{dt} = -\frac{d}{dt} \int_S \vec{B} \cdot d\vec{A} \quad \ldots (5.1)
$$
...
$$
\oint_l \vec{B} \cdot d\vec{l} = \mu_o \varepsilon_o \frac{d\Phi_E}{dt}
$$
...
கம்பியின் வழியே பாயும் நேரத்தைப் பொறுத்து மாறும் மின்னோட்டத்தை கடத்து மின்னோட்டம் \( i_C \) என்க. இந்த கடத்து மின்னோட்டத்தால் மின்தேக்கி மின்னேற்றம் செய்யப்படுகிறது. மின்னோட்டம் தாங்கிய கம்பியைச் சுற்றி உருவாகும் காந்தப்புலத்தைக் கணக்கிட ஆம்பியரின் சுற்று விதியைப் பயன்படுத்தலாம்.
...
$$
\Phi_E = \int_S \vec{E} \cdot d\vec{A} = EA = \frac{q}{\varepsilon_0}
$$
...
$$
\oint_l \vec{B} \cdot d\vec{l} = \mu_0 i = \mu_0 (i_c + i_d)
$$

$$
\oint_l \vec{B} \cdot d\vec{l} = \mu_0 i_c + \mu_0 \varepsilon_0 \frac{d\Phi_E}{dt} \qquad (5.6)
$$
...
$$
i_d = \varepsilon_0 \frac{d\Phi_E}{dt} = \varepsilon_0 \frac{d(EA)}{dt}
$$

\( \therefore i_d = \varepsilon_0 A \frac{d}{dt} \left( \frac{V}{d} \right) = \frac{\varepsilon_0 A}{d} \frac{dV}{dt} \)

\( = \frac{8.85 \times 10^{-12} \times 20 \times 10^{-4}}{1 \times 10^{-3}} \times 325 \times 100\pi \cos(100\pi \times 1) \)

\( = 1.81 \times 10^{-6} [\cos(100\pi)] = 1.81 \ \mu A \)

\( \because \cos 100\pi = 1 \)
...
$$
\int_S \vec{E} \cdot d\vec{A} = \frac{Q}{\varepsilon_0} \quad \text{(மின்னியலின் காஸ் விதி)} \qquad (5.7)
$$
...
$$
\int_S \vec{B} \cdot d\vec{A} = 0 \quad \text{(காந்தவியலின் காஸ் விதி)} \qquad (5.8)
$$
...
$$
\oint_l \vec{E} \cdot d\vec{l} = -\frac{d\Phi_B}{dt} \quad \text{(பாரடேயின் விதி)} \qquad (5.9)
$$
...
$$
\oint_l \vec{B} \cdot d\vec{l} = \mu_0 i_c + \mu_0 \varepsilon_0 \frac{d}{dt} \int_S \vec{E} \cdot d\vec{A} \quad \text{(ஆம்பியர் – மேக்ஸ்வெல் விதி)} \qquad (5.10)
$$
...
மின்காந்த அலைகள்
    ...
    ├── உமிழ்பு நிறமாலை
    │   ├── தொடர் உமிழ்பு நிறமாலை
    │   ├── வரி உமிழ்பு நிறமாலை
    │   └── பட்டை உமிழ்பு நிறமாலை
    ├── உட்கவர் நிறமாலை
...
12. பின்வருவனவற்றுள் எது மின்காந்த அலையை உருவாக்க பயன்படுகிறது?
(a) முடுக்குவிக்கப்பட்ட மின்துகள்
(b) சீரான திசைவேகத்தில் இயங்கும் மின்துகள்
(c) ஓய்வு நிலையிலுள்ள மின்துகள்
(d) மின்னூட்டமற்ற ஒரு துகள்

13. ஒரு சமதள மின்காந்த அலையின் மின்புலம் \( E = E_0 \sin [10^{-6}x - \omega t] \) எனில் \( \omega \) வின் மதிப்பு என்ன?
(a) \( 0.3 \times 10^{-14} \ \mathrm{rad \ s^{-1}} \)
(b) \( 3 \times 10^{-14} \ \mathrm{rad \ s^{-1}} \)
(c) \( 0.3 \times 10^{14} \ \mathrm{rad \ s^{-1}} \)
(d) \( 3 \times 10^{14} \ \mathrm{rad \ s^{-1}} \)
...
6. ஃபிரன்ஹோஃபர் வரிகள் என்றால் என்ன? சூரியனிலுள்ள தனிமங்களைக் கண்டறிவதில் அவை எவ்வாறு உதவுகின்றன?
...
2. சிறு குறிப்பு வரைக: (அ) மைக்ரோ அலை (ஆ) X-கதிர் (இ) ரேடியோ அலைகள் (ஈ) கண்ணுறு நிறமாலை
...
8. வெளியீட்டு நிறமாலையின் வகைகளை விளக்கவும்.

9. உட்கவர் நிறமாலையின் வகைகளை விளக்கவும்.

## IV கணக்குகள்

1. இலேசாகப் பிரித்து வைக்கப்பட்டுள்ள இணைத்தட்டு மின்தேக்கி ஒன்றைக் கருதுக. தகடுகளின் ஆரம் R எனவும் இரண்டு தகடுகளையும் இணைக்கும் கடத்தியின் வழியே பாயும் மின்னோட்டம் 5A எனவும் கொண்டு, தகடுகளின் வழியே ஓரலகு நேரத்தில் மாற்றமடையும் மின்புலப்பாயத்தை நேரடியாகக் கணக்கிட்டு, அதன்மூலம் இணைத்தட்டு மின்தேக்கியின் தகடுகளுக்கு நடுவே உள்ள சிறிய இடைவெளியில் தகடுகளின் வழியே பாயும் இடப்பெயர்ச்சி மின்னோட்டத்தைக் கணக்கிடுக.

**விடை:** \( i_d = 5 \ \mathrm{A} \)

2. பரப்பி ஒன்றின் LC சுற்றில் உள்ள மின்தூண்டியின் மதிப்பு \( 1 \ \mu\mathrm{H} \) மற்றும் மின்தேக்கியின் மதிப்பு \( 1 \ \mu\mathrm{F} \) என்க. இப்பரப்பியில் தோற்றுவிக்கப்படும் மின்காந்த அலையின் அலைநீளம் என்ன?

**விடை:** \( 18.84 \times 10^2 \ \mathrm{m} \)

3. \( 10^{-6} \ \mathrm{s} \) நேர அளவு கொண்ட ஒளித்துடிப்பு ஒன்று தொடக்கத்தில் ஓய்வு நிலையில் உள்ள சிறிய பொருளினால் முழுவதும் உட்கவரப்படுகிறது. ஒளித்துடிப்பின் திறன் \( 60 \times 10^{-3} \ \mathrm{W} \) எனில், அப்பொருளின் இறுதி உந்தத்தைக் கணக்கிடுக.

**விடை:** \( 20 \times 10^{-17} \ \mathrm{kg \ m \ s^{-1}} \)

4. x அச்சுத் திசையில் பரவும் மின்காந்த அலை ஒன்றைக் கருதுக. y அச்சுத் திசையில் செயல்படும் காந்தப்புலத்தின் அலைவுகளின் அதிர்வெண் \( 10^{10} \ \mathrm{Hz} \) மற்றும் அதன் வீச்சு \( 10^{-5} \ \mathrm{T} \) எனில், மின்காந்த அலையின் அலைநீளத்தைக் கணக்கிடுக. மேலும் இந்நிகழ்வில் தோன்றும் மின்புலத்தின் சமன்பாட்டினையும் எழுதுக.

**விடை:** \( \lambda = 3 \times 10^{-2} \ \mathrm{m} \) மற்றும்

\( \vec{E}(x,t) = 3 \times 10^3 \sin(2.09 \times 10^2 x - 6.28 \times 10^{10} t)(-\hat{k}) \ \mathrm{NC^{-1}} \)

5. ஊடகம் ஒன்றின் ஒப்புமை உட்புகுதிறன் மற்றும் ஒப்புமை விருதிறன்கள் முறையே 1.0 மற்றும் 2.25 எனில், அவ்வூடகத்தின் வழியே பரவும் மின்காந்த அலையின் வேகத்தைக் காண்க.

**விடை:** \( v = 2 \times 10^8 \ \mathrm{m \ s^{-1}} \)
...
**நோக்கம்:** மைக்ரோவே அலை சமையல்கள் மூலம் உணவு எவ்வாறு சமைக்கப்படுகிறது என்பதை மாணவர்கள் புரிந்துகொள்வார்கள்.

**தலைப்பு:** மைக்ரோ அலை சமையல்கள்

**படிகள்**

• "phet.colorado.edu/en/simulation/microwaves" என்ற வலைப்பக்கத்திற்கு செல்லுங்கள்.

• 'one molecule' என்ற தாவலைச் சொடுக்கவும். வலைப் பக்கத்தில் இருக்கும் ஆப் பொத்தானைச் சொடுக்கி சமையலைச் செயல்படுத்துங்கள்.

• 'one molecule' என்ற தாவலைச் சொடுக்கி மைக்ரோவே அலைகளின் விளைவு உணவிலிருக்கும் நீர் மீது எவ்வாறு செயல்படுகிறது என்பதை கவனியுங்கள்.

• மைக்ரோவே அலைகள், உணவிலுள்ள நீர் மூலக்கூறுகளை சுழலச் செய்து வெப்ப ஆற்றலை உருவாக்கி உணவை சமைப்பதை கவனியுங்கள்.

• மைக்ரோவே அலைகளின் வீச்சு மற்றும் அதிர்வெண்ணை மாற்றம் செய்யும் போது நீர் மூலக்கூறுகளின் சுழற்சி வேகம் மாறுகிறதா? எவ்வாறு மாறுகிறது?

நீர் மூலக்கூறுகளின் சுழற்சி வேகத்திற்கும் சமைக்கும் நேரத்திற்கான தொடர்பை விவாதியுங்கள்.

**குறிப்பு:** உங்கள் உலாவியில் flash player இல்லையென்றால் அதனை நிறுவவும். நீங்கள் 'phet' பயன்பாட்டை இணையநிலையில் பயன்படுத்த இந்த உரலியைச் சொடுக்குங்கள். https://phet.colorado.edu/en/offline-access.

**உரலி:** https://phet.colorado.edu/en/simulation/microwaves
