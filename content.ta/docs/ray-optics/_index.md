...
\[ v = \frac{3 \times 10^8}{1.33} = 2.26 \times 10^8 \ \mathrm{m \ s^{-1}} \]
...
\[ \sin(90^\circ - r) = \frac{n_2}{n_1} \quad \text{அல்லது} \quad \cos r = \frac{n_2}{n_1} \qquad (6.40) \]

\[ \sin r = \sqrt{1 - \cos^2 r} = \sqrt{1 - \frac{n_2^2}{n_1^2}} = \frac{\sqrt{n_1^2 - n_2^2}}{n_1} \qquad (6.41) \]
...
\[ \frac{1}{v} - \frac{1}{u} = (n - 1) \left( \frac{1}{R_1} - \frac{1}{R_2} \right), \quad \text{இங்கு } n = \frac{n_2}{n_1} \qquad (6.60) \]
...
\[ \frac{1}{f} = (n - 1) \left( \frac{1}{R_1} - \frac{1}{R_2} \right) \qquad (6.61) \]
