...
![**படம் 6.1 ஒளியின் எதிரொளிப்பு**](image.png)
...
![**படம் 6.2 (அ) ஒழுங்கான மற்றும் (ஆ) ஒழுங்கற்ற எதிரெளிப்புகள்**](image-1.png)
...
![**படம் 6.3 ஒளிஎதிர�ொளிப்பினால் ஏற்படும் திசைமாற்றக் கோணம்**](image-2.png)
...
![**படம் 6.4 (அ) புள்ளிப் பொருள் ஒன்றினால் (ஆ) பெரிதாக்கப்பட்ட பொருள் ஒன்றினால் தோன்றும் பிம்பம்**](image-4.png)
...
![**படம் 6.5 சாய்த்து வைக்கப்பட்டுள்ள சமதள ஆடிகளினால் தோன்றும் பிம்பங்கள்**](image-5.png)

**அட்டவணை 6.1 சாய்த்து வைக்கப்பட்டுள்ள சமதள ஆடிகளினால் தோன்றும் பிம்பங்கள்**

| \(\frac{360}{\theta} \) | பொருள் வைக்கப்பட்டுள்ள நிலை | பிம்பங்களின் எண்ணிக்கை |
|---|---|---|
| இரட்டைப்படை |  சமச்சீர் நிலை | \( n = \frac{360}{\theta} - 1 \) |
|  | சமச்சீரற்ற நிலை | \( n = \frac{360}{\theta} - 1 \) |
| ஒற்றைப்படை |ஒற்றைப்படை சமச்சீர் நிலை | \( n = \frac{360}{\theta} - 1 \) |
|  | சமச்சீரற்ற நிலை | \( n = \frac{360}{\theta} - 1 \) |
...
![**படம் 6.6 கோளக ஆடிகள்**](image-7.png)
...
![**படம் 6.7 குழி மற்றும் குவி ஆடிகள் சார்ந்த துறை சொற்களின் விளக்கப்படம்**](image-8.png)
...
![**படம் 6.8 அண்மை அச்சுக்கதிர்கள் மற்றும் ஓரக்கதிர்கள்**](image-9.png)
...
![**படம் 6.9 வளைவு ஆரத்திற்கும் R, குவியத்தூரத்திற்கும் f இடையேயுள்ள தொடர்பு**](image-10.png)
...
![**படம் 6.10 பிம்பங்களின் தடமறிதல்**](image-11.png)
...
![**படம் 6.11 கார்ட்டீசியன் குறியீட்டு மரபு**](image-12.png)
...
![**படம் 6.12 ஆடிச் சமன்பாடு**](image-13.png)
...
\[ \frac{-h'}{h} = \frac{-v}{-u} = \frac{v}{u} \]

\[ \therefore m = \frac{h'}{h} = -\frac{v}{u} \qquad (6.10) \]
...
>**குறிப்பு:**
> மாணவர்கள் 9-ஆம் வகுப்பில் பயின்ற, குழி மற்றும் குவி ஆடிகளைக் கொண்டு பிம்பங்களை வரையும் முறையை மீள்பார்வை செய்து கொள்ள வேண்டும். அதாவது, பொருளை வெவ்வேறு நிலைகளில் வைத்து, பிம்பத்தின் நிலை, பிம்பத்தின் தன்மை எவ்வாறு உள்ளது என்பனவற்றைப் புரிந்து கொள்ள வேண்டும் (9-ஆம் வகுப்பு அறிவியல் பாடப்புத்தகம்).
...
\[ u_B = \frac{f}{3} - (-2f) = \frac{f}{3} + 2f = \frac{7f}{3} \]
...
\[ \frac{1}{v_B} = \frac{1}{f} - \frac{1}{u_B} = \frac{1}{f} - \frac{1}{7f/3} = \frac{1}{f} - \frac{3}{7f} = \frac{4}{7f} \]

\[ v_B = \frac{7f}{4} \]

\[ l' = \frac{7f}{4} - 2f = \frac{7f - 8f}{4} = -\frac{f}{4} \]
...
![**படம் 6.13 ஒளியின் வேகம் கண்டறியும் ஃபிஸீயு முறை**](image-15.png)
...
>**குறிப்பு:**
>பற்சக்கரத்தின் வேகத்தைச் சுழியிலிருந்து ω வரை அதிகரிக்கும்போது ஒளி மறைந்து விடுகிறது. பற்சக்கரத்தின் வேகத்தை மேலும் அதிகரித்துக் கொண்டே சென்று 2ω மதிப்பை அடையும்போது எதிர�ொளிக்கப்பட்ட ஒளி அடுத்த வெட்டு வழியாகச் சென்று உற்றுப்பார்ப்பவரை அடைகிறது. எனவே, ω வின் ஒற்றைப்படை மதிப்புகளுக்கெல்லாம் ஒளி மறைவதும், (பற்களினால் தடுக்கப்பட்டும்), இரட்டைப் படை மதிப்புகளுக்கெல்லாம் ஒளி தெரிவதும் (வெட்டு வழியாக அனுமதிக்கப்பட்டும்) மாறி மாறி நடைபெறும்.
...
$$\text{ஊடகத்தின் ஒளிவிலகல் எண் } n = \frac{\text{வெற்றிடத்தில் ஒளியின் வேகம் } (c)}{\text{ஊடகத்தில் ஒளியின் வேகம் } (v)}$$
...
ஒளிவிலகல் எண்ணுக்கு அலகு இல்லை. வெற்றிடம்தான் மிகக்குறைந்த ஒளிவிலகல் எண்ணைப் பெற்றுள்ளது. அதன் மதிப்பு $1$ ஆகும். மற்ற அனைத்து ஊடகங்களின் ஒளிவிலகல் எண்ணும் $1$ஐவிட அதிக மதிப்பையே பெற்றிருக்கும். ஒளிவிலகல் எண்ணை ஊடகத்தின் ஒளி அடர்த்தி (Optical density) என்றும் அழைக்கலாம்.
...
$$v = \frac{d}{t};$$
 சமன்பாட்டை  t க்கு மாற்றியமைக்கும் போது,  t = $$\frac{d}{v}$$

![**படம் 6.14 ஒளிப்பாதை**](image-16.png)
இதே நேர இடைவெளியில், வெற்றிடத்தில் ஒளி பெருந்தொலைவு $d'$ சென்றிருக்கும். ஏனெனில், ஒளி வெற்றிடத்தின் வழியே பெரும வேகத்தில் $c$ செல்லும். இது படம் 6.14இல் காட்டப்பட்டுள்ளது. எனவே,

$$c = \frac{d'}{t}; \text{ சமன்பாட்டை } t \text{ க்கு மாற்றி அமைக்கும்}$$
...
![படம் 6.15 ஒளிவிலகல்](image-17.png)
>**குறிப்பு:**  படுகதிர் செங்குத்தாக தளத்தில் விழும்போது அதன் படுகோணம் சுழியாகும்
...
![**படம் 6.16 ஒளிக்கதிர் அடர்குறை ஊடகத்திலிருந்து அடர்மிகு ஊடகத்திற்குள் செல்லும் போது ஏற்படும் திசைமாற்றக் கோணம்**](image-18.png)
...
![**படம் 6.17 ஒளிக்கதிர் அடர்மிகு ஊடகத்திலிருந்து அடர்குறை ஊடகத்திற்குள் செல்லும் போது ஏற்படும் திசைமாற்றக் கோணம்**](image-19.png)
...
![**படம் 6.18 ஒரே நேர எதிர�ொளிப்பு (அல்லது) ஒரே நேர ஒளிவிலகல்**](image-20.png)
...
![**படம் 6.19 (அ) ஒளிஎதிர�ொளிப்பு மற்றும் (ஆ) ஒளிவிலகளுக்கான ஒளியின் மீளும் கொள்கை**](image-23.png)
...
![**படம் 6.20 தோற்ற ஆழம்**](image-24.png)
...
**தீர்வு**
மேலே இருந்து பார்க்கும்போது (காற்று ஊடகம்), நாணயம் அடிப்பரப்பிலேயே தொடர்ந்து தெரியும். மேலும், ஒவ்வோர் ஊடகமும் வெளியில் உள்ள காற்று ஊடகத்தைப்பொறுத்துச் சுருங்கித் தெரியும். இதுகீழே உள்ள படத்தில் சுட்டிக்காட்டப்பட்டுள்ளது.

ஒவ்வோர் ஊடகத்திற்குமான தோற்ற ஆழச் சமன்பாடுகள்,

$$d'_1 = \frac{d_1}{n_1}; \quad d'_2 = \frac{d_2}{n_2}; \quad d'_3 = \frac{d_3}{n_3}$$

$$d' = d'_1 + d'_2 + d'_3 = \frac{d_1}{n_1} + \frac{d_2}{n_2} + \frac{d_3}{n_3}$$
...
![**படம் 6.21 மாறுநிலைக்கோணம் மற்றும் முழு அக எதிர�ொளிப்பு**](image-26.png)
...
| கிரவுண் கண்ணாடி | 1.540 | \( 40.5^\circ \) |
| ஃபிளிண்ட் கண்ணாடி | 1.890 | \( 31.9^\circ \) |
...
![**படம் 6.22 வைரத்தினுள் ஏற்படும் முழு அக எதிரொளிப்பு**](image-27.png)
...
![**படம் 6.26 (அ) ஸ்னெல் சாளரம் மற்றும் (ஆ) நீர்வாழ் விலங்குகளின் பார்வைக் கோணம்**](image-31.png)
...
![**படம் 6.27 ஸ்னெல் சாளரத்தின் ஆரம்**](image-32.png)
...
![**படம் 6.28 ஒளி இழை**](image-33.png)
...
![**படம் 6.29 (அ) ஏற்புக் கோணம் மற்றும் (ஆ) ஏற்புக் கூம்பு**](image-34.png)

படம் 6.29 (அ) வில் காட்டியுள்ளவாறு A புள்ளியில்
ஏற்படும் ஒளிவிலகலுக்கான ஸ்னெல் விதியின்
பெருக்கல் வடிவம் (6.19) பின்வருமாறு.
...
\[ \sin(90^\circ - r) = \frac{n_2}{n_1} \quad \text{அல்லது} \]

$$\cos r_a = \frac{n_2}{n_1} \qquad (6.40)$$

$$\sin r_a = \sqrt{1 - \cos^2 r_a}$$

$\cos r_a$ வின் மதிப்பை பிரதியிட

$$\sin r_a = \sqrt{1 - \left(\frac{n_2}{n_1}\right)^2} = \sqrt{\frac{n_1^2 - n_2^2}{n_1^2}} \qquad (6.41)$$

இதனைச் சமன்பாடு 6.37 இல் பிரதியிட

$$n_3 \sin i_a = n_1 \sqrt{\frac{n_1^2 - n_2^2}{n_1^2}} = \sqrt{n_1^2 - n_2^2} \qquad (6.42)$$

மேலும் இதனைச் சுருக்கும்போது,

$$\sin i_a = \frac{\sqrt{n_1^2 - n_2^2}}{n_3} \text{ (or) } \sin i_a = \sqrt{\frac{n_1^2 - n_2^2}{n_3^2}} \qquad (6.43)$$

$$i_a = \sin^{-1} \left( \sqrt{\frac{n_1^2 - n_2^2}{n_3^2}} \right) \qquad (6.44)$$

வெளிப்புற ஊடகம் காற்று எனக் கருதினால் \( n_3 = 1 \). எனவே ஏற்புக் கோணம் \( (i_a) \) பின்வருமாறு மாற்றமடையும்.

\[ i_a = \sin^{-1} \left( \sqrt{n_1^2 - n_2^2} \right) \qquad (6.45) \]
...
\[ i_a = \sin^{-1} \left( \sqrt{n_1^2 - n_2^2} \right) = \sin^{-1} \left( \sqrt{(1.68)^2 - (1.44)^2} \right) \]

\[ = \sin^{-1} \left( \sqrt{2.8224 - 2.0736} \right) = \sin^{-1} \left( \sqrt{0.7488} \right) = \sin^{-1} (0.865) \approx 60^\circ \]

வெளிப்பூச்சு ஏதும் இல்லாத நிலையில், \( n_2 = 1 \) (காற்று)

\[ i_a = \sin^{-1} \left( \sqrt{n_1^2 - 1} \right) = \sin^{-1} \left( \sqrt{(1.68)^2 - 1} \right) = \sin^{-1} \left( \sqrt{2.8224 - 1} \right) \]

\[ = \sin^{-1} (\sqrt{1.8224}) = \sin^{-1} (1.35) \]
...
![**படம் 6.30 கண்ணாடிப்பட்டகத்தில் ஏற்படும் ஒளிவிலகல்**](image-36.png)
...
\[ \sin r = \frac{\sin i}{n} = \frac{\sin 60^\circ}{1.5} = \frac{\sqrt{3}/2}{1.5} = \frac{0.8660}{1.5} = 0.5773 \]

\[ r = \sin^{-1} (0.5773) \approx 35.26^\circ \]

பக்கவாட்டு இடப்பெயர்ச்சி,

\[ L = t \left( \frac{\sin(i - r)}{\cos r} \right) \]

\[ L = 0.25 \left( \frac{\sin(60^\circ - 35.26^\circ)}{\cos 35.26^\circ} \right) = 0.25 \left( \frac{\sin 24.74^\circ}{\cos 35.26^\circ} \right) \]

\[ = 0.25 \left( \frac{0.4184}{0.8166} \right) = 0.25 \times 0.5124 = 0.1281 \ \mathrm{m} = 12.81 \ \mathrm{cm} \]
...
![**படம் 6.31 ஒற்றைக் கோளகப் பரப்பில் ஏற்படும் ஒளிவிலகல்**](image-37.png)
...
>**குறிப்பு**
>
>மேலே கொடுக்கப்பட்டுள்ள வருவித்தலில் ஒளிவிலகலுக்குப் பிறகு கதிர்கள் ஒரு புள்ளியில் குவியும் நிகழ்வு எடுத்துக் கொள்ளப்பட்டுள்ளது. ஆனால், பொதுவாக, ஒளிவிலகலுக்குப் பிறகு கதிர்கள் குவியலாம் அல்லது விரிவடையலாம். $n_1$ ஐப் பொறுத்து $n_2$, வளைவு ஆரம் $R$ மற்றும் பொருளின் தொலைவு $u$ ஆகியவற்றின் மதிப்புகளைப் பொறுத்து இது அமையும். இந்த இரு நேர்வுகளும் எடுத்துக்காட்டு 6.12இல் கொடுக்கப்பட்டுள்ளன.
...
\[ u = -10 \ \mathrm{cm}, \quad R = 15 \ \mathrm{cm} \]

\[ \frac{2}{v} - \frac{1}{(-10)} = \frac{2 - 1}{15}; \quad \frac{2}{v} = \frac{1}{15} - \frac{1}{10} = \frac{2 - 3}{30} = -\frac{1}{30} \]
...
\[ u = -30 \ \mathrm{cm}, \quad R = 15 \ \mathrm{cm} \]

\[ \frac{2}{v} - \frac{1}{(-30)} = \frac{2 - 1}{15}; \quad \frac{2}{v} + \frac{1}{30} = \frac{1}{15} \]

\[ \frac{2}{v} = \frac{1}{15} - \frac{1}{30} = \frac{2 - 1}{30} = \frac{1}{30} \]
...
![**படம் 6.32 முதன்மைக் குவியம்**](image-40.png)
...
![**படம் 6.33 இரண்டாம் குவியம்**](image-41.png)
...
![**படம் 6.34 மெல்லிய லென்ஸ்களினால் ஏற்படும் ஒளிவிலகல்**](image-42.png)

ஒற்றை கோளகப்பரப்பினால் ஏற்படும் ஒளிவிலகலுக்கான பொதுவான சமன்பாடு (6.56) இன் படி

$$\frac{n_2}{v} - \frac{n_1}{u} = \frac{(n_2 - n_1)}{R}$$

ஒளிவிலகு பரப்பு ①இல், ஒளிக்கதிர் $n_1$ இலிருந்து $n_2$க்கு செல்கிறது

$$\frac{n_2}{v'} - \frac{n_1}{u} = \frac{(n_2 - n_1)}{R_1} \quad (6.58)$$

ஒளிவிலகு பரப்பு ②இல் ஒளிக்கதிர் $n_2$ ஊடகத்தில் இருந்து $n_1$ ஊடகத்திற்குச் செல்கிறது.

$$\frac{n_1}{v} - \frac{n_2}{v'} = \frac{(n_1 - n_2)}{R_2} \quad (6.59)$$

சமன்பாடுகள் (6.58) மற்றும் (6.59) இரண்டையும் கூட்டும்போது
...
$$\frac{1}{v} - \frac{1}{u} = \left( \frac{n_2}{n_1} - 1 \right) \left( \frac{1}{R_1} - \frac{1}{R_2} \right) \quad (6.60)$$

பொருள் ஈரில்லாத தொலைவில் இருந்தால், பிம்பம் லென்ஸின் குவியத்தில் அமையும். அதாவது $u = \infty$, $v = f$ எனில் சமன்பாடு பின்வருமாறு மாற்றமடையும்.

$$\frac{1}{f} - \frac{1}{\infty} = \left( \frac{n_2}{n_1} - 1 \right) \left( \frac{1}{R_1} - \frac{1}{R_2} \right)$$

$$\frac{1}{f} = \left( \frac{n_2}{n_1} - 1 \right) \left( \frac{1}{R_1} - \frac{1}{R_2} \right) \quad (6.61)$$

லென்ஸ் காற்று ஊடகத்தில் வைக்கப்பட்டால், $n_2 = n$ மற்றும் $n_1 = 1$. எனவே, சமன்பாடு (6.61) பின்வருமாறு மாற்றமடையும்.

$$\frac{1}{f} = (n - 1) \left( \frac{1}{R_1} - \frac{1}{R_2} \right) \quad (6.62)$$

மேற்கண்ட சமன்பாட்டிற்கு **லென்ஸ் உருவாக்குபவரின் சமன்பாடு** என்றுபெயர். ஏனெனில், இச்சமன்பாட்டினை அடிப்படையாகக் கொண்டு நாம் விரும்பும் குவியத்தூரத்திற்கு

எவ்வளவு வளைவு ஆரம் கொண்ட கோளகப்பரப்பு தேவை என்பதையும், எந்தக் குறிப்பிட்ட ஒளிவிலகல் எண்கொண்ட பொருளைப் பயன்படுத்தவேண்டும் என்பதையும் இச்சமன்பாட்டிலிருந்து லென்ஸ் உருவாக்குபவர் அறிந்துகொள்கிறார். இச்சமன்பாடு அனைத்து லென்ஸ்களுக்கும் பொருந்தும். சமன்பாடுகள் (6.60) மற்றும் (6.61) இரண்டையும் ஒப்பிட்டுப் பின்வரும் சமன்பாட்டினை எழுதலாம்.

$$\frac{1}{v} - \frac{1}{u} = \frac{1}{f} \quad (6.63)$$

இச்சமன்பாட்டிற்கு **லென்ஸ் சமன்பாடு** என்று பெயர். இது பொருளின் தூரம், பிம்பத்தின்தூரம் மற்றும் குவியத்தூரம் மூன்றையும் தொடர்புபடுத்துகிறது. இச்சமன்பாடு அனைத்து லென்ஸ்களுக்கும் பொருந்தும்.

### 6.6.4 மெல்லிய லென்ஸின் பக்கவாட்டு உருப்பெருக்கம் (Lateral magnification in thin lens)

$h_1$ உயரம் கொண்ட $OO'$ என்ற பொருள் படம் 6.35-இல் காட்டியுள்ளவாறு முதன்மை அச்சுக்குச் செங்குத்தாக வைக்கப்பட்டுள்ளது எனக்கருதுக. லென்ஸ் முனை வழியே செல்லும் OP கதிர் எவ்வித விலகலும் அடையாமல் நேர்க்கோட்டுப்பாதையில் செல்கிறது. முதன்மை அச்சுக்கு இணையாகவரும் கதிர், இரண்டாவது குவியம் வழியாகச் செல்கிறது. இவ்விரண்டு கதிர்களும் சந்திக்கும் புள்ளியில் $h_2$ உயரமுள்ள தலைகீழான மெய்பிம்பம் $II'$ கிடைக்கிறது.

![**படம் 6.35 மெல்லிய லென்ஸ்சின் பக்கவாட்டு உருப்பெருக்கம்**](image-43.png)
...
$$m = \frac{II'}{OO'} \quad (6.64)$$

ஒத்த முக்கோணங்கள் $\Delta POO'$ மற்றும் $\Delta PII'$, யிலிருந்து


$$\frac{II'}{OO'} = \frac{PI}{PO} \quad (6.65)$$

குறியீட்டு மரபினைப் பயன்படுத்தும்போது,

$$\frac{-h'}{h} = \frac{v}{-u}$$

இதனைச் சமன்பாடு (6.64) இல் பிரதியிட்டால் உருப்பெருக்கம்,

$$m = \frac{-h'}{h} = \frac{v}{-u}$$

சமன்பாட்டினை மாற்றியமைத்த பின்னர்,

$$m = \frac{h'}{h} = \frac{v}{u} \quad (6.66)$$
...
$$m = \frac{h'}{h} = \frac{f}{f+u} \text{ (அல்லது) } m = \frac{h'}{h} = \frac{f-v}{f} \quad (6.67)$$
...
இருபுறகுவிலென்ஸைப் பொருத்தவரை முதல் பரப்பின் வளைவு ஆரம் நேர்குறியாகவும், இரண்டாம் பரப்பின் வளைவு ஆரம் எதிர்குறியாகவும் இருக்கும். இது படத்தில் காட்டப்பட்டுள்ளது.
![](image-44.png)
...
\[ = 0.5 \left( \frac{3 + 4}{60} \right) = \frac{1}{2} \times \frac{7}{60} = \frac{7}{120} \]
...
\[ = 0.5 \left( \frac{4 + 3}{60} \right) = \frac{1}{2} \times \frac{7}{60} = \frac{7}{120} \]
இதன் குவியத்தூரம்,
\[ f = \frac{120}{7} \approx 17.14 \ \mathrm{cm} \]
...
லென்ஸின் திறன் என்பது, ஒளிக்கதிர்களை வளைக்கும் திறனைக் குறிப்பதாகும். அதாவது லென்ஸின் மீது விழும் ஒளிக்கதிர்களை எந்த அளவிற்கு அந்த லென்ஸ் வளைக்கிறது என்பதையே லென்ஸின் திறன் அழைக்கிறது. லென்ஸின் திறன் அதன் குவியத்தூரத்திற்கு எதிர்த்தகவு ஆகும். அதாவது அதிகத் திறன் கொண்ட லென்ஸ் குறைந்த குவியத்தூரத்தைப் பெற்றிருக்கும். படம் 6.36 இல் (அ) லென்ஸை விட (ஆ) லென்ஸின் வளைக்கும் திறன் அதிகம். (ஆ) லென்ஸின் வளைக்கும் திறன் அதிகம் என்பதால் அதன் குவியத்தூரம் குறைவாகும். இதுபோன்றே (அ) லென்ஸின் வளைக்கும் திறன் குறைவு என்பதால் அதன் குவியத்தூரம் அதிகமாகும். 

![**படம் 6.36 லென்ஸின் திறன்**](image-47.png)
வேறுவகையில் கூறுவோமாயின் ஒரு லென்ஸின் திறன், அந்த லென்ஸின் மீது விழும் ஒளிக்கதிர்களை எந்த அளவிற்குக் குவியச் செய்கிறது அல்லது விரிவடைய வைக்கிறது என்பதை அளக்கிறது என்றும் கூறலாம். ஒரு லென்ஸின் குவியத்தூரத்தின் தலைகீழே, அந்த லென்ஸின் திறன் என வரையறுக்கப்படுகிறது.
...
![**படம் 6.37 ஒன்றை ஒன்று தொட்டுக்கொண்டுள்ள இரண்டு லென்ஸ்கள்**](image-48.png)
...
\[ \frac{1}{f} = \frac{1}{-70} + \frac{1}{150} = -\frac{1}{70} + \frac{1}{150} = \frac{-150 + 70}{70 \times 150} = \frac{-80}{10500} \]

\[ f = -\frac{10500}{80} = -131.25 \ \mathrm{cm} \]
...
\[ \frac{1}{v_1} - \frac{1}{-15} = \frac{1}{10}; \quad \frac{1}{v_1} + \frac{1}{15} = \frac{1}{10} \]
...
\[ \frac{h_1'}{0.5} = \frac{30}{-15} = -2 \]

\[ h_1' = -2 \times 0.5 = -1 \ \mathrm{cm} \]
...
\[ \frac{1}{v_2} - \frac{1}{-10} = \frac{1}{5}; \quad \frac{1}{v_2} + \frac{1}{10} = \frac{1}{5} \]
...
\[ \frac{h''}{-1} = \frac{10}{-10} = -1 \]

\[ h'' = -1 \times -1 = 1 \ \mathrm{cm} = 10 \ \mathrm{mm} \]
...
![**படம் 6.41 வெள்ளி பூசப்பட்ட லென்ஸ்**](image-52.png)

வெள்ளி பூசப்பட்ட லென்ஸின் திறன்

\[ P = P_l + P_m + P_l \]

\[ P = 2P_l + P_m \qquad (6.78) \]
...
\[ \frac{1}{f_l} = (1.5 - 1) \left( \frac{1}{30} - \frac{1}{-30} \right) = 0.5 \left( \frac{1}{30} + \frac{1}{30} \right) = \frac{1}{2} \times \frac{2}{30} = \frac{1}{30} \]
...
\[ \frac{1}{-f} = \frac{2}{f_l} + \frac{1}{-f_m} = \frac{2}{30} + \frac{1}{-(-15)} = \frac{2}{30} + \frac{1}{15} = \frac{1}{15} + \frac{1}{15} = \frac{2}{15} \]

\[ f = -\frac{15}{2} = -7.5 \ \mathrm{cm} = -0.075 \ \mathrm{m} \]
...
\[ = \frac{2}{0.3} + \frac{2}{0.3} = \frac{4}{0.3} \approx 13.33 \ \mathrm{D} \]
...
\[ u = -2 \times 7.5 = -15 \ \mathrm{cm} = -0.15 \ \mathrm{m} \]
...
![**படம் 6.39 முப்பட்டகம்**](image-54.png)
...
![**படம் 6.40 முப்பட்டகத்தின் வழியே ஒளிவிலகல்**](image-55.png)
...
இங்கு, $A = 60^\circ; \quad i_1 = 0^\circ; \quad i_2 = 90^\circ$
...
முப்பட்டகம் ஏற்படுத்திய திசைமாற்றக் கோணம்,
$d = 30^\circ$

(ஆ) முப்பட்டகத்தின் உட்புறம், இரண்டாவது முகத்தின் மீது ஒளிக்கதிர் மாறுநிலைக் கோணத்தில் விழுகிறது. எனவே, இக்கதிர் ஒளிவிலகல் அடைந்து இரண்டாவது முகத்தின் தளத்தின் மீதே செல்லும். அதாவது, இரண்டாவது முகத்தைத் தழுவிச்செல்லும் $i_c = 90^\circ - 30^\circ = 60^\circ$.

மாறுநிலைக் கோணத்திற்கான சமன்பாட்டின்படி,

$$\sin i_c = \frac{1}{n}$$

$$n = \frac{1}{\sin i_c}; \quad n = \frac{1}{\sin 60^\circ} = \frac{1}{\sqrt{3} / 2} = \frac{2}{\sqrt{3}} = 1.15$$

முப்பட்டகப்பொருளின் ஒளிவிலகல் எண், $n = 1.15$
...
![**படம் 6.41 (i) மற்றும் (d) க்கு இடையேயான வரைபடம்**](image-57.png)
...
![**படம் 6.42 சிறும திசைமாற்றக் கோணம்**](image-58.png)
...
\[ n = \frac{\sin\left( \frac{A + D}{2} \right)}{\sin\left( \frac{A}{2} \right)} = \frac{\sin\left( \frac{60^\circ + 37^\circ}{2} \right)}{\sin\left( \frac{60^\circ}{2} \right)} = \frac{\sin(48.5^\circ)}{\sin(30^\circ)} \]

\[ = \frac{0.7488}{0.5} = 1.4976 \approx 1.5 \]
...
![**படம் 6.43 வெள்ளை ஒளி அதன் வண்ணங்களாக நிறப்பிரிகை அடைதல்**](image-59.png)

நிறமாலையில் கிடைக்கும் வண்ணங்கள் ஒளிமூலத்தின் தன்மையைப் பொருத்ததாகும்.

ஒவ்வொரு வண்ணமும் வரையறுக்கப்பட்ட அலைநீளத்தைப் பெற்றிருக்கும். சிவப்பு ஒளி நீண்ட அலைநீள எல்லையையும் (700 nm) ஊதா ஒளி குறுகிய அலைநீள எல்லையையும் (400 nm) பெற்றுள்ளன. இதன்காரணமாகக் கண்ணாடி முப்பட்டகத்தின் வழியே செல்லும் ஊதா ஒளிக்கற்றையின் திசைவேகம், சிவப்பு ஒளிக்கற்றையின் திசைவேகத்தைவிடக் குறைவாக இருக்கும்.
...
வெள்ளை ஒளிக்கற்றை ஒன்றைக் கருதுக. இவ்வொளிக்கற்றை முப்பட்டகத்தின் வழியாகச் செல்லும்போது, வெள்ளை ஒளியிலுள்ள வண்ணங்கள் நிறப்பிரிகை அடையும். இது படம் 6.44 இல் காட்டப்பட்டுள்ளது.
![**படம் 6.44 வெவ்வேறு வண்ணங்களின் திசைமாற்றக் கோணங்கள்**](image-61.png)
முப்பட்டகக்கோணம் $10^\circ$ என்ற சிறிய அளவில் உள்ள முப்பட்டகங்களுக்கு சிறுகோண முப்பட்டகங்கள் என்று பெயர். இவ்வகையான முப்பட்டகங்களின் வழியே ஒளிக்கதிர் செல்லும்போது ஏற்படும் திசைமாற்றக் கோணமும் சிறியதாகும். $A$ என்பது முப்பட்டகக்கோணமெனவும், $\delta$ என்பது திசைமாற்றக் கோணமெனவும் கொண்டால், முப்பட்டகச்சமன்பாடு (6.89) பின்வரும் வடிவைப்பெறும்.

> **உங்களுக்குத் தெரியுமா?**
> நிறப்பிரிகைக்கான சிறந்த ஓர் எடுத்துக்காட்டு, ‘வானவில்லாகும்’. மழைக்காலங்களில் நீர்த்துளிகளினால் சூரியஒளி நிறப்பிரிகை அடைவதால் வானவில் ஏற்படுகிறது. மழைபெய்யும்போதுதோ அல்லது மழைபெய்து ஓய்ந்தவுடனோ அல்லது பனிமூடமாகச் சூரியன் உள்ளநிலையில் நின்று ஒன்றைப் பார்க்கும்போதோ, வானவில்லை நாம் பார்க்கமுடியும். காற்றில் மிதந்து கொண்டிருக்கும் நீர்த்துளிகளின் மீது விழும் சூரிய ஒளி, நிறப்பிரிகை அடைந்து அதன் கூறுகளாகப் பிரிகை அடையும். எனவே, காற்றில் மிதந்துகொண்டிருக்கும் நீர்த்துளிகள், கண்ணாடியால் முப்பட்டகம் போன்று செயல்படுகின்றன. நீர்த்துளியினுள் நுழைந்த ஒளிக்கதிர் அதிலிருந்து வெளியேறுவதற்கு முன்பு, ஒரு முழு அக எதிரொளிப்பு அடைவதால் முதன்மை வானவில் உருவாகும். இது படத்தில் காட்டப்பட்டுள்ளது. முதன்மை வானவில்லில் ஊதாவிலிருந்து சிவப்பும் வரை உள்ள வண்ணங்களைப் பார்ப்பதற்கான பார்வைக் கோணம் $40^\circ$ முதல் $42^\circ$ வரையிலிருக்கும். முதன்மை வானவில்லின் வெளிப்புறமாகத் துணை வானவில் தோன்றுகின்றது. நீர்த்துளியினுள் நுழைந்த சூரியஒளி அதிலிருந்து வெளியேறுவதற்கு முன்னர், இரண்டு முழு அக எதிரொளிப்புகளை அடைவதால் துணை வானவில் தோன்றும். சிவப்பு வண்ணத்திலிருந்து ஊதா வண்ணம்வரை பார்ப்பதற்கான பார்வைக் கோணம், $52^\circ$ முதல் $54^\circ$ வரையிலிருக்கும்.
>![](image-62.png)


$$n = \frac{\sin\left(\dfrac{A+\delta}{2}\right)}{\sin\left(\dfrac{A}{2}\right)} \quad (6.90)$$
...
$$\therefore n = \frac{\left(\dfrac{A+\delta}{2}\right)}{\left(\dfrac{A}{2}\right)} = \frac{A+\delta}{A} = 1 + \frac{\delta}{A}$$

மேலும் சுருக்கும்போது, $\dfrac{\delta}{A} = n - 1$

$$\delta = (n-1)A \quad (6.91)$$
...
ஊதா மற்றும் சிவப்பு வண்ணங்களுக்கான சிறும திசை மாற்றக் கோணங்கள் முறையே $\delta_V, \delta_R$ என்க. மேலும், $n_V$ மற்றும் $n_R$ என்பவை மேற்கண்ட வண்ணங்களுக்கான ஒளிவிலகல் எண்களாகும்

$$\text{ஊதா வண்ணத்திற்கு, } \delta_V = (n_V - 1)A \quad (6.92)$$

$$\text{சிவப்பு வண்ணத்திற்கு, } \delta_R = (n_R - 1)A \quad (6.93)$$

ஊதா வண்ணத்தின் சிறும திசைமாற்றக் கோணம் $\delta_V$, சிவப்பு வண்ணத்தின் சிறும திசைமாற்றக் கோணத்தைவிட $\delta_R$ அதிகமாக உள்ளதால், ஊதா வண்ணத்தின் ஒளிவிலகல் எண் ($n_V$), சிவப்பு வண்ணத்தின் ஒளிவிலகல் எண்ணைவிட ($n_R$) அதிகமாக இருக்கும்.

$\delta_V$ யிலிருந்து $\delta_R$ ஐ கழிக்கும் போது, பின்வரும் சமன்பாடு கிடைக்கும்.

$$\delta_V - \delta_R = (n_V - n_R)A \quad (6.94)$$

மேற்கண்ட சமன்பாட்டில் உள்ள $(\delta_V - \delta_R)$ பதம், நிறமாலையில் உள்ள இரண்டு எல்லை வண்ணங்களுக்கு இடையேயான (ஊதா மற்றும் சிவப்பு) கோணப்பிரிகையைக் கொடுக்கிறது. இக்கோணப்பிரிகைக்குக் **கோண நிறப்பிரிகை** என்று பெயர்.

சராசரி கதிர் ஒன்றின் திசைமாற்றக் கோணத்தை $\delta$ என்றும், இதற்கான ஒளிவிலகல் எண்ணை $n$ எனவும் கொண்டால்,

$$\delta = (n-1)A \quad (6.95)$$

நிறங்களைப் பிரிக்கும் முப்பட்டகப்பொருளின் திறனுக்கு முப்பட்டகத்தின் நிறப்பிரிகைத்றின் $\omega$ என்றுபெயர். இரண்டு எல்லை வண்ணங்களுக்கான கோண நிறப்பிரிகைக்கும் மைய வண்ணமொன்றின் திசைமாற்றக் கோணத்திற்கும் உள்ள தகவு நிறப்பிரிகைத்றின் அல்லது பிரிதிறன் என வரையறுக்கப்படுகிறது.

முப்பட்டகத்தின் நிறப்பிரிகைத்றின் $\omega$,

$$\omega = \frac{\text{கோண நிறப்பிரிகை}}{\text{மைய திசைமாற்றக் கோணம்}} = \frac{\delta_V - \delta_R}{\delta} \quad (6.96)$$

$(\delta_V - \delta_R)$ மற்றும் $(\delta)$, வின் மதிப்புகளைப் பிரதியிடும்போது

$$\omega = \frac{(n_V - n_R)}{(n-1)} \quad (6.97)$$

நிறப்பிரிகைத்றின், பரிமாணமற்ற ஓர் எண்ணாகும். இதற்கு அலகு இல்லை. இது எப்போதும் நேர்குறி மதிப்பையே பெற்றிருக்கும். பிரிதிறன் முப்பட்டகப்பொருளின் தன்மையை மட்டும் சார்ந்திருக்கும். முப்பட்டகக் கோணத்தைப் பொருத்தல்ல.
...
### 6.7.6 சூரிய ஒளிச் சிதறல்

புவியின் வளிமண்டலத்தில் உள்ள வளிமண்டலத்துகள்கள், புவியின் வளிமண்டலத்திற்குள் நுழையும் சூரிய ஒளியின் திசையை மாற்றும். இந்நிகழ்ச்சிக்கு ஒளிச்சிதறல் என்றுபெயர். ஒளியின் அலைநீளத்தை ($\lambda$) விட, மிகவும் குறைவான அளவுடைய ($a$) அணுக்கள் மற்றும் மூலக்கூறுகளினால் ஏற்படும் ஒளிச்சிதறலுக்கு, **இராலே ஒளிச்சிதறல் (Rayleigh’s Scattering)** என்று பெயர். அதாவது, இராலே ஒளிச்சிதறல் ஏற்பட நிபந்தனை ($a \ll \lambda$) ஆகும்.

இராலே ஒளிச்சிதறலில் சிதறலடைந்த ஒளியின் செறிவு, அலைநீளத்தின் நான்குமடி மதிப்புக்கு எதிர்விகிதத்தில் இருக்கும்.

$$I \propto \frac{1}{\lambda^4} \quad (6.98)$$

சமன்பாடு (6.98) இன் படி பகல்நேரத்தில், குறைந்த அலைநீளமுடைய நீலவண்ணம் வளிமண்டலத் துகள்களினால், வளிமண்டலம் முழுவதும் சிதறடிக்கப்படுகின்றது. மேலும், நமது கண்களின் உணர்வு நுட்பம் ஊதா வண்ணத்தைவிட, நீலவண்ணத்திற்கு அதிகம். இத்தகைய காரணங்களினால்தான் வானம் நீலநிறமாகக் காட்சியளிக்கிறது. இது படம் 6.45 (ஆ) வில் காட்டப்பட்டுள்ளது. சூரிய உதயம் மற்றும் மறையும் நேரங்களில் சூரியஒளி வளிமண்டலம் வழியாக மிக நீண்ட தொலைவு செல்லவேண்டியுள்ளது. எனவே, குறைந்த அலைநீளம் கொண்ட நீல ஒளி சிதறலடைந்துவிடும். ஆனால் அதிக அலைநீளம் கொண்ட சிவப்பு ஒளி குறைவாகச் சிதறலடைந்து நமது கண்களை அடையும். இதன் காரணமாகத்தான் சூரியன் உதிக்கும்போதும், மறையும்போதும் வானம் சிவப்பு நிறமாகக் காட்சி அளிக்கின்றது. இது படம் 6.45 (அ) இல் காட்டப்பட்டுள்ளது.
![**படம் 6.45 ஒளிச்சிதறலின் பல்வேறு வடிவங்கள்**](image-63.png)


வளிமண்டலத்திலுள்ள தூசு, மற்றும் நீர்த்துளிகளின் அளவு ($a$), ஒளியின் அலைநீளத்தைவிட ($\lambda$) மிக அதிகமாக உள்ளபோது, அதாவது ($a \gg \lambda$), இத்தகைய பெரிய துகள்களினால் ஒளி சிதறலடையும்போது, சிதறலடைந்த ஒளியின் செறிவு அனைத்து அலைநீளங்களுக்கும் சமமாக இருக்கும். மிக அதிகளவு தூசு மற்றும் நீர்த்துளிகளைப் பெற்றுள்ள மேகங்களில் இத்தகைய ஒளிச்சிதறல் ஏற்படும். எனவே, மேகங்களில் அலைநீளத்தைப்பொறுத்து, ஒளிச்சிதறல் ஏற்படாமல் அனைத்து வண்ணங்களும் சமஅளவில் சிதறலடைகின்றன. இதன்காரணமாகத்தான் மேகம் வெண்மைநிறமாகக் காட்சியளிக்கிறது. இதுபடம் 6.45 (இ) இல் காட்டப்பட்டுள்ளது. ஆனால், மழைமேகங்கள் கருமையாக இருப்பதற்குக் காரணம், அதிலுள்ள நீர்த்துளிகள் ஒன்றிணைந்து மழை மேகத்தினை ஒளிபுகாப்பொருளாக மாற்றிவிடுவதேயாகும்.
...
* ஒளிஎதிரொளிப்பு விதி: $i = r$
* ஆடி ஒன்றின் முதன்மை அச்சுக்கு நெருக்கமாகச் செல்லும் கதிர்களுக்கு அண்மை அச்சுக் கதிர்கள் என்று பெயர். இவை முதன்மை அச்சோடு மிகச்சிறிய கோணங்களை ஏற்படுத்தும்.
* கோளக ஆடிகளின் குவியத்தூரம் மற்றும் வளைவு ஆரங்களுக்கு இடையே உள்ள தொடர்பு $2f = R$ (அல்லது) $f = \dfrac{R}{2}$
* கோளக ஆடிகளினால் தோற்றுவிக்கப்படும் பிம்பங்களைத் தடம்காண கார்ட்டீசியன் குறியீட்டு மரபு பயன்படுத்தப்படுகிறது.
* ஆடிச் சமன்பாடு, $\dfrac{1}{v} + \dfrac{1}{u} = \dfrac{1}{f}$
* கோளக ஆடியின் உருப்பெருக்கச் சமன்பாடு, $m = \dfrac{h'}{h} = -\dfrac{v}{u}, \; m = \dfrac{h'}{h} = \dfrac{f-v}{f} = \dfrac{f}{f-u}$
* ஒளியியல் அடர்த்தி அதிகமுள்ள பொருள்களின் வழியே ஒளி குறைந்த திசை வேகத்தில் செல்கிறது.
* வெற்றிடத்தில் செல்லும் ஒளியின் வேகத்திற்கும், ஊடகத்தில் செல்லும் ஒளியின் வேகத்திற்கும் உள்ள விகிதமே ஒளிவிலகல் எண் ஆகும். $n = \dfrac{c}{v}$
* ஒளியியல் அடர்த்தி மிக்க ஊடகம் ஒன்றில், ஒளி ஒரு குறிப்பிட்ட தொலைவைக் கடக்க எவ்வளவு நேரத்தை எடுத்துக்கொள்கிறதோ, அதே நேர இடைவெளியில் வெற்றிடத்தின் வழியே ஒளி கடந்து செல்லும் தொலைவு ஒளிப்பாதை (Optical Path) எனப்படும்.
$$d' = nd$$
* ஒளிவிலகல் விதியை, ஸ்நெல் விதி என்றும் அழைக்கலாம். இதன் விகித வடிவம், $\dfrac{\sin i}{\sin r} = \dfrac{n_2}{n_1}$
* ஸ்நெல் விதியின் பெருக்கல் வடிவம், $n_1 \sin i = n_2 \sin r$
* முதல் ஊடகத்தைப்பொறுத்து இரண்டாவது ஊடகத்தின் ஒப்புமை ஒளிவிலகல் எண், $n_{21} = \dfrac{n_2}{n_1}$
* தோற்ற ஆழம் எப்போதும் உண்மை ஆழத்தைவிடக் குறைவாகவே காணப்படும். தோற்ற ஆழத்திற்கான சமன்பாடு, $d' = \dfrac{d}{n}$
* அடர்மிகு ஊடகத்திலிருந்து, அடர்குறை ஊடகத்திற்கு ஒளிவரும்போது, அதன் படுகோணம் $i$, மாறுநிலைக் கோணத்திற்கு $i_c$, சமமாக இருந்தால், அந்த ஒளிக்கதிரின் விலகுகோணம் $90^\circ$ ஆக இருக்கும். $i > i_c$ எனில் முழு அக எதிரொளிப்பு ஏற்படும்.
* மாறுநிலை கோணத்திற்கான சமன்பாடு, $\sin i_c = \dfrac{1}{n}$ (அல்லது) $i_c = \sin^{-1}\left(\dfrac{1}{n}\right)$
* மாறுநிலைக் கோணத்திற்குச் சமமான ஒரு கோணத்தில் வெளிப்புறத்திலிருந்து வரும் ஒளியைத் தண்ணீருக்குள் இருந்து பார்க்கும் போது ஒரு குறிப்பிட்ட ஆரமுடைய ஒளியூட்டப்பட்ட வட்டப்பரப்பு காணப்படும். இதற்கு ஸ்நெல் சாளரம் (Snell's window) என்று பெயர். ஒளியூட்டப்பட்ட வட்டப்பரப்பின் ஆரம் $R = d\left[\dfrac{1}{\sqrt{n^2-1}}\right]$ (அல்லது) $R = \dfrac{d}{\sqrt{n^2-1}}$
* மாறுநிலைப் படுகோணத்தை (Critical angle of incidence) அடிப்படையாகக் கொண்டு ஒளி இழைகளின் வழியே செய்திகள் அனுப்பப்படுகின்றன. ஒளி இழைகளின் ஏற்புக் கோணம் $i_a = \sin^{-1}\left(\sqrt{\dfrac{n_1^2-n_2^2}{n_3^2}}\right)$. இங்கு $n_1, n_2, n_3$ முறையே உள்ளகம், உறைபூச்சு மற்றும் வெளிப்புற ஊடகம் ஆகியவற்றின் ஒளிவிலகல் எண்களாகும்.
* கண்ணாடிப்பட்டகத்தின் வழியே ஒளிக்கதிர் செல்லும் போது ஒளிக்கதிர் பக்கவாட்டு இடப்பெயர்ச்சி அடைகிறது.
* பக்கவாட்டு இடப்பெயர்ச்சிக்கான சமன்பாடு, $L = t\left[\dfrac{\sin(i-r)}{\cos(r)}\right]$
* ஒற்றை கோளகப் பரப்பிற்கான சமன்பாடு, $\dfrac{n}{v} - \dfrac{1}{u} = \dfrac{(n-1)}{R}$
* மெல்லிய லென்ஸ் ஒன்றின் குவியத்தூரம், குவிக்கும் லென்ஸ்களுக்கு நேர்குறியாகவும் விரிக்கும் லென்ஸ்களுக்கு எதிர்குறியாகவும் காணப்படும். இது குவிக்கும் புள்ளியின் அமைவிடத்தைப் பொருத்தல்ல.
* லென்ஸ் உருவாக்குபவரின் சமன்பாடு, $\dfrac{1}{f} = (n-1)\left(\dfrac{1}{R_1} - \dfrac{1}{R_2}\right)$
* லென்ஸ் சமன்பாடு, $\dfrac{1}{v} - \dfrac{1}{u} = \dfrac{1}{f}$
* லென்ஸின் உருப்பெருக்கச் சமன்பாடு, $m = \dfrac{h'}{h} = \dfrac{v}{u}, \; m = \dfrac{h'}{h} = \dfrac{f}{f+u}$ (அல்லது) $m = \dfrac{h'}{h} = \dfrac{f-v}{f}$
* லென்ஸ் ஒன்றின் மீது விழும் ஒளியை குவிக்கும் அல்லது விரிக்கும் லென்ஸின் திறமையை, லென்ஸின் திறனைக் கொண்டு (Power of a lens) அளவிடலாம்
* லென்ஸின் திறன் அதன் குவியத்தூரத்திற்கு எதிர்த்தகவாகும். $P = \dfrac{1}{f}$
* லென்ஸ் ஒன்றின் குவியத்தூரத்தை மீட்டரில் அளவீடு செய்யும்போது, அதன் திறனின் அலகு டயாப்டர் (D) ஆகும்
* ஒன்றை ஒன்று தொட்டுக் கொண்டிருக்கும் லென்ஸ் கூட்டமைப்பின் தொகுபயன் குவியத்தூரம், $\dfrac{1}{f} = \dfrac{1}{f_1} + \dfrac{1}{f_2}$
* முப்பட்டகம் தன்மீது விழும் ஒளியை திசைமாற்றம் அடையச் செய்கிறது.
* முப்பட்டகத்தின் திசைமாற்றக் கோணம், முப்பட்டகக்கோணம், படுகோணம் மற்றும் முப்பட்டகம் பொருளின் ஒளிவிலகல் எண் போன்றவற்றைச் சார்ந்துள்ளது. இதற்கான தொடர்பு, $d = i_1 + i_2 - A$
* சிறும திசைமாற்ற நிலையில் $i_1 = i_2, \; r_1 = r_2$, முப்பட்டகத்தின் மீது விழும் ஒளிக்கதிர், அதன் அடிப்பரப்பிற்கு இணையாகச் செல்லும்.
* முப்பட்டகத்தின் ஒளிவிலகல் எண், முப்பட்டகக் கோணம் மற்றும் சிறும திசை மாற்றக் கோணத்தைச் சார்ந்துள்ளது. அதற்கான தொடர்பு,
$$n = \frac{\sin\left(\dfrac{A+D}{2}\right)}{\sin\left(\dfrac{A}{2}\right)}$$
* ஊடகம் ஒன்றின் வழியே ஒளி செல்லும் போது ஒவ்வொரு வண்ணமும் வெவ்வேறு வேகங்களில் செல்லும். இவ்வேக வேறுபாடு நிறப்பிரிகையைத் தோற்றுவிக்கும். ஊடகம் ஒன்றினுள் ஊதா நிறத்தை விட சிவப்பு நிறம் அதிவேகத்தில் செல்லும். அனைத்து நிறங்களும் வெற்றிடத்தினுள் ஒரே வேகத்தில் செல்லும்.
* சிறு கோணமுப்பட்டகம் ஒன்றின் திசைமாற்றக் கோணம், $\delta = (n-1)A$
* நிறமாலையில் உள்ள இரண்டு எல்லை வண்ணங்களுக்கு இடையேயான (ஊதா மற்றும் சிவப்பு) திசைமாற்றக் கோணங்களின் வேறுபாடு கோண நிறப்பிரிகையைக் கொடுக்கிறது.
கோண நிறப்பிரிகை: $\delta_V - \delta_R = (n_V - n_R)A$.
* வெள்ளை ஒளியிலிருந்து நிறங்களைப் பிரிகை அடையச் செய்யும் ஊடகம் ஒன்றின் திறமையை, நிறப்பிரிகைதிறன் (Dispersive Power) அளவிடுகிறது.
$$\omega = \frac{(n_V - n_R)}{(n-1)}$$
* நீர்த்துளி ஒன்றினால் ஒளி நிறப்பிரிகை அடையும்போது வானவில் தோன்றுகிறது.
* ஒளியின் அலைநீளத்தை விட குறைந்த அளவு கொண்ட துகள்களால் ஏற்படும் ஒளிச்சிதறலுக்கு இராலே ஒளிச்சிதறல் என்று பெயர். இராலே ஒளிச்சிதறலில் தோன்றும் ஒளியின் செறிவு, $I \propto \dfrac{1}{\lambda^4}$
* ஒளியின் அலைநீளத்தைவிட அதிக அளவுகொண்ட மிதக்கும் தூசித்துகள்களினால் ஏற்படும் ஒளிச்சிதறல், இராலே ஒளிச்சிதறலில் இருந்து வேறுபட்டதாகும். இவ்வகையான ஒளிச்சிதறல் படும் ஒளியின் அலை நீளத்தைச் சார்ந்ததல்ல, சிதறலடைந்த ஒளியின் செறிவு அனைத்து அலைநீளங்களுக்கும் சமமாக இருக்கும்.